...
Делтоидът се разцепва по хода на влакната между средния и задния сноп, като разцепването е ограничено до около 5 cm дистално от акромиона, за да бъде защитен nervus axillaris (обикалящ хирургичната шийка на humerus). Задният делтоид се
