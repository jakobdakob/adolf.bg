...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Разцепете brachialis по средата: латералните две трети са musculocutaneus, медиалната третина, radialis. Срединното разцепване запазва поне частична инервация на всяка половина и е безопасната техника за антеролатералния достъп до диафизата на humerus.</p>
</aside>
