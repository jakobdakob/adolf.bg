...
<aside class="callout callout-pearl">
  ...
  <p>Тестът със стоене на пръсти (тест за гъвкавост) е разграничителят до леглото: при гъвкав pes planus петата преминава във варус и медиалният свод се формира при стоене на пръсти, докато ригидното стъпало остава в валгус и сводът не се появява. Асимптоматичният гъвкав pes planus при дете не изисква лечение и не изисква ортеза.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Рентгенографиите при натоварване показват увеличен ъгъл на Meary (talus-първа метатарзална, нормално 0°), плантарна флексия на talus, валгус на calcaneus и абдукция на предното стъпало. Намален калканеален наклон и намалено покритие тип talo-navicular допълват рентгеновия облик на плоското стъпало.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Тарзалната коалиция се изявява в юношеска възраст с перонеално спастично плоско стъпало, когато хрущялната връзка осифицира. С-знакът насочва към тало-калканеална коалиция, „муцуната на мравояд“ — към калканео-навикуларна, а дорзалният таларен клюн е реактивен на тало-навикуларната става. КТ е златен стандарт при тало-калканеална коалиция; косите проекции са най-добри при калканео-навикуларна.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Конгениталният вертикален talus дава ригидното rocker-bottom стъпало при раждане, двустранно в 50% и синдромно в около половината. Диагностичният разграничител от oblique talus е стресовата странична проекция в принудителна плантарна флексия: при CVT навикуларната кост остава луксирана от talus, при oblique talus се редуцира. Серията гипсове по Dobbs (обратна на Ponseti) в плантарна флексия и инверзия до голяма степен замени обширната открита реконструкция.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Дисфункцията на задния тибиален мускул е недостатъчност на динамичния инвертор: очаквайте медиална глезенна болка, знака „прекалено много пръсти“ от засегнатата страна, невъзможност за едноопорен пятен подем (най-надеждният функционален тест) и повдигане на първия лъч при стоене на пръсти. Засяга предимно жени на 40-65 години със затлъстяване, диабет, хипертония или възпалителен артрит.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Стадирането по Johnson-Strom-Myerson съответства на хирургична ескалация: I тендосиновит без деформация — консервативно или тендосиновектомия; II гъвкава деформация — трансфер на FDL плюс медиална дислокационна остеотомия на calcaneus плюс удължаване на страничната колона плюс Cotton плюс ахилолиза при нужда; III фиксирана деформация — тройна артродеза; IV глезенен валгус или артроза — добавете тотална артропластика на глезена или артродеза на глезена към реконструкцията на петата.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Прагове по Beighton: 4 или повече от 9 при възрастен и 6 или повече при дете преди пубертета отговарят на критерия за генерализирана ставна хипермобилност. Деветте маньоври са дорзифлексия на пета MCP >90° (всяка страна), палец до предмишницата (всяка страна), хиперекстензия на лакътя >10° (всяка страна), хиперекстензия на коляното >10° (всяка страна) и длани плоско на пода при изпънати колене.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Васкуларният Ehlers-Danlos (тип IV, COL3A1, колаген тип III) е катастрофалният подтип: спонтанна руптура на артерия, перфорация на черво и руптура на матката по време на бременност. Третирайте всяка нова коремна или гръдна болка като съдово събитие до доказване на противното и координирайте всяка планова ортопедична операция със съдов и акушерски екип.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Синдромът на Marfan се причинява от мутации в FBN1, засягащи фибрилин-1; оперативната червена флага е дилатацията на аортния корен с риск от дисекция по време на операция. Ортопедичните стигми са сколиоза, protrusio acetabuli, pes planus с валгус на петата, арахнодактилия и ставна хипермобилност, но кардиологичният екип трябва да допусне планова операция преди ортопедията.</p>
</aside>
...
Описателният анализ на плоското стъпало датира от Хофа (1905), който разграничава гъвкавото от твърдото плоско стъпало и предлага мекотъканни укрепващи процедури, предхождащи модерните реконструкции с трансфер на сухожилия. Средновековният Guy de Chauliac (1363) вече разпознава деформацията плоско стъпало в *Chirurgia magna*.

- **Хофа** (1905): *Lehrbuch der orthopädischen Chirurgie* — Plattfuß. · [Факсимиле](https://archive.org/details/lehrbuchderortho00hoff)
- **Chauliac** (1363): *Chirurgia magna* — средновековна патология на стъпалото. · [Факсимиле](https://archive.org/details/chirurgiamagnagu00guyd)
