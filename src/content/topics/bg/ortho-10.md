...
talus на страничната проекция. Стресовите проекции — принудителна плантарна флексия на стъпалото в страничната проекция — разграничават конгенитален вертикален talus от
