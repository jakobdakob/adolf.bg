...
Няколко фактора от средата и акушерски фактора са свързани с повишен риск: тютюнопушене по време на бременност (особено в съчетание с положителна фамилна анамнеза), олигохидрамниоза и вътреутробно компресиране, амниоцентеза и вътреутробно ограничение. Свързаните заболявания са важни: клубното стъпало е компонент при приблизително 10-15% от случаите на миеломенингоцеле, при артрогрипоза мултиплекс конгенита (при която е характерно тежко и резистентно на лечение), при дистална артрогрипоза, синдром на Larsen, дисплазия на Streeter (синдром на амниотичните ленти) и при различни хромозомни разстройства. Системният преглед на новороденото с клубно стъпало трябва да включва внимателен преглед на гръбначния стълб, неврологичен преглед и оценка на всичките четири крайника и лицето за свързани аномалии.

<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Клубното стъпало е компонент на миеломенингоцеле, артрогрипоза мултиплекс конгенита (тежко и резистентно), дистална артрогрипоза, синдром на Larsen, дисплазия на Streeter (синдром на амниотичните ленти) и различни хромозомни разстройства. Всяко новородено с клубно стъпало изисква преглед на гръбначния стълб, неврологичен преглед и оценка на четирите крайника и лицето, преди да бъде определено като идиопатично.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Редът на корекция по Ponseti следва анатомията: първо cavus (супинация на предното стъпало), след това аддукция, варус и супинация едновременно чрез отвеждане на предното стъпало под главата на talus, и накрая еквинусът чрез перкутанна ахилотомия. Calcaneus се ротира навън под talus при отвеждане на стъпалото, коригирайки едновременно варуса на петата и аддуктуса на предното стъпало.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Спазването на ортезирането е единственият най-важен определящ фактор за дългосрочния успех след корекция по Ponseti. Прекратяването преди 4-годишна възраст дава 80-100% рецидив; последователното носене до 4-годишна възраст задържа рецидивите до 10-20%. Ортезата се носи 23 часа дневно първите 3 месеца, после нощем и по време на дремки за 3-4 години.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Трансферът на сухожилието на musculus tibialis anterior към латералния (трети) клиновиден е стандартната процедура за динамичната супинационна деформация след 2-3-годишна възраст. Трябва да се отложи до осификация на латералния клиновиден, типично на 3 години или повече, иначе няма костен анкер за трансфера.</p>
</aside>

## Повторно гипсуване и повторна ахилотомия

Лек до умерен рецидив, особено при по-малкото дете, нерядко реагира на повторно гипсуване по Ponseti и при необходимост, повторна ахилотомия. Принципите на оригиналния метод на Ponseti се прилагат с внимателна последователна корекция на компонентите.

## Постеромедиално освобождаване

## Традиционната обширна постеромедиална хирургична операция на освобождаване

(ПМО), доминиращото лечение на клубното стъпало преди глобалното приемане на метода на Ponseti, включва обширно освобождаване на задната капсула на глезена и субталарната става, удължаване на Ахилесовото сухожилие и задния тибиален мускул, освобождаване на пружинния лигамент и капсулотомии на тало-навикуларната и субталарната стави. Процедурата постига драматична корекция, но за сметка на ригидно, болезнено стъпало с висока честота на късни усложнения, включително свръхкорекция, вторичен артрит и хронична ригидност. Процедурата е сега запазена за тежкото ригидно клубно стъпало, неуспяло при лечение по Ponseti, с резултати значително по-добри при използване като спасяваща мярка след Ponseti, отколкото като първично лечение.

<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Първичното постеромедиално освобождаване постига драматична интраоперативна корекция, но оставя ригидно, болезнено стъпало с висока честота на свръхкорекция, вторичен артрит и хронична ригидност. Запазете го като спасяваща мярка след неуспех на Ponseti; резултатите са значително по-добри, когато следва Ponseti, отколкото когато го замества.</p>
</aside>

## Костни процедури

При по-голямото дете или юноша с остатъчна или рецидивираща деформация костните процедури допълват или заместват мекотъканните освобождавания. Опциите включват скъсяване на латералната колона (остеотомия по Lichtblau или Evans), удължаване на медиалната колона, дорзифлексионна остеотомия на първата метатарзална кост при остатъчен cavus, остеотомия на calcaneus (по Dwyer при варус, латерален затварящ клин при валгус) и надглезенна остеотомия на тибията при остатъчна вътрешна тибиална торзия. При тежко деформирано стъпало при юноша тройната артродеза остава спасяващата процедура на избор.
...
Постуралният еквиноварус е позиционна деформация на стъпалото на новороденото, наподобяваща клубно стъпало, но напълно пасивно коригируема до неутрална позиция. Разграничаването е чрез пасивна манипулация: постуралните деформации се коригират напълно, докато истинското клубно стъпало се съпротивлява на пълна корекция. Постуралният еквиноварус типично отзвучава спонтанно за седмици с простото разтягане и бандажиране.

<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Постуралният еквиноварус се коригира напълно пасивно до неутрална позиция и отзвучава с разтягане; истинското CTEV се съпротивлява на пълна пасивна корекция. Разграничението се прави при първия преглед с пасивна манипулация, не само с оглед, за да не се претретира доброкачествена позиционна деформация или да не се пропусне истинско клубно стъпало.</p>
</aside>


## Skewfoot

Skewfoot (Z-стъпало) е сложна деформация, съчетаваща метатарзус адуктус, валгус на петата и абдукция на средното стъпало, давайки Z-образно стъпало при оценка с натоварване. Деформацията е ригидна и не реагира на лечението по Ponseti; изисква индивидуализирано хирургично лечение с комбинации от скъсяване на медиалната колона, удължаване на латералната колона и метатарзални остеотомии.

## Метатарзус адуктус

Метатарзус адуктусът е изолирана деформация на предното стъпало, при която метатарзалните кости са в аддукция, но петата е нормална. Деформацията се класифицира по редуцируемост: гъвкава (пасивно коригируема отвъд бисектора на петата), частично редуцируема (коригируема до бисектора на петата, но не отвъд него) или ригидна (некоригируема до бисектора на петата). Гъвкавият метатарзус адуктус отзвучава спонтанно в повечето случаи; частично редуцируемият може да се повлияе от разтягане; ригидният метатарзус адуктус може да изисква серийно гипсуване при кърмачето.
...
Модерното лечение на вродения клубфут почива на две класически опори: подкожната ахилотенотомия на Stromeyer (1831) и Dieffenbach (1845) — първата ортопедична операция при закрити условия — и манипулативната серийно-гипсова традиция, обобщена от Хофа (1905) и доведена до сегашната си изтънченост от Ponseti (1963). Тенотомията на Stromeyer е научена от William Little, чийто собствен клубфут е успешно тенотомизиран през 1836 г. — основополагащото събитие на англоезичната ортопедична традиция.

- **Dieffenbach** (1845–48): *Die operative Chirurgie*, том 2 — подкожна ахилотенотомия. · [Факсимиле](https://archive.org/details/dieoperativechir02dief)
- **Хофа** (1905): *Lehrbuch der orthopädischen Chirurgie* — Klumpfußredression. · [Факсимиле](https://archive.org/details/lehrbuchderortho00hoff)
