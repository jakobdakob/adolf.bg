...
<aside class="callout callout-pearl">
  ...
  <p>Всяко дете с радиален надлъжен дефицит изисква кардиална ехография, бъбречна ехография, пълна кръвна картина с внимание към тромбоцитите, хромозомен анализ и изследване за анемия на Fanconi (анализ на хромозомна нестабилност). Ортопедичната находка е сентинелен признак на VACTERL, Holt-Oram (TBX5), анемия на Fanconi и TAR. Пропуснатата анемия на Fanconi, лечима с ранна стволовоклетъчна трансплантация, е непростимата грешка.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Граничните пръсти със значима разлика в дължините (палец-показалец, безименен-малък) се разделят преди 6 месеца за предотвратяване на деформация на растежа; неграничните разделяния се отлагат до 12-24 месеца. Никога не се оперира едновременно от двете страни на един пръст, деваскуларизацията е предвидимото усложнение.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Водоразделът между Blauth IIIA и IIIB е стабилността на CMC-ставата. IIIA (стабилна CMC) подлежи на реконструкция: опоненспластика, задълбочаване на webspace, реконструкция на улнарна колатерална връзка. IIIB (нестабилна CMC), IV (флотиращ палец) и V (отсъстващ палец) изискват поликизация на показалеца, никаква мекотъканна реконструкция не може да компенсира липсваща базална става.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Синдромът на констрикционните ленти е спорадичен и не е свързан с хромозомни или системни аномалии, така че семейството може да бъде успокоено относно риска от рецидив и липсата на подлежащо генетично заболяване. Акросиндактилията (дистална фузия с проксимални фенестрации) е диагностичният признак на пръстите, който я отличава от проксимално сляпата синдактилия при нарушенията на диференциацията.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Класическото преподаване изискваше ранно хирургично освобождаване на педиатричния trigger thumb, но честотата на спонтанно разрешаване от 30-60% подкрепя наблюдението през първите 1-2 години. Оперира се само когато IP-ставата остава заключена след прозореца на наблюдение.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Изолираната аномалия на ръката е диагноза на изключване. Всяка голяма аномалия на горния крайник изисква поне кардиална оценка и пълна кръвна картина, с изследване за хромозомна нестабилност при всеки радиален дефицит. Лечението на ръката без скрининг за синдром пропуска анемия на Fanconi и кардиалните дефекти при Holt-Oram.</p>
</aside>
...
Ренесансовата и ранно-модерната хирургия документират вродените аномалии на ръката далеч преди да съществува модерният генетичен речник. *Œuvres complètes* на Paré (изд. Malgaigne 1840) съдържа класическите описания на полидактилия и синдактилия с тогавашните етиологични хипотези (майчина импресия, божествена намеса, механична компресия in utero). *Lehrbuch* на Хофа (1905) обобщава реконструктивната оперативна традиция от края на XIX век.

- **Paré** (изд. Malgaigne 1840): *Œuvres complètes*, том 2 — Ренесансови описания на вродени аномалии. · [Факсимиле](https://archive.org/details/oeuvrescomplte02par)
