...
<aside class="callout callout-pearl">
  ...
  <p>Ахондроплазията е автозомно доминантна с конститутивно активиране на FGFR3 (G1138A, глицин към аргинин в кодон 380). Около 80% са нови мутации, свързани с напреднала бащина възраст. Същата биология на придобита функция обяснява ризомеличния нисък ръст и обосновката за изпитваните в момента FGFR3-модулиращи терапии.</p>
</aside>

## Клинични прояви

Класическата картина включва: ризомеличен нисък ръст (горните ръце и бедрата са непропорционално по-къси от предмишниците и подбедриците); макроцефалия с фронтално изпъкване и хлътнал носов корен; тризъбени ръце (с раздалечаване на третия и четвъртия пръст); торако-лумбална кифоза в кърмаческа възраст, която се подобрява с натоварване и в повечето случаи изчезва; лумбална хиперлордоза в детска и зряла възраст; стеноза на гръбначния канал (основният дългосрочен клиничен проблем, прогресивното стесняване на канала поражда неврологична симптоматика при възрастните); стеноза на foramen magnum (с потенциално животозастрашаваща компресия на цервико-медуларното ниво в кърмаческа възраст, проявяваща се с централна апнея, слабост или внезапна смърт); хипоплазия на средната лицева третина с евентуални дихателни проблеми; отити и слухово увреждане; genu varum (при около 30%); и контрактури на лакътя.
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Всяко кърмаче с ахондроплазия се нуждае от оценка на foramen magnum с неврологичен преглед, полисомнография и МРТ, симптоматичната цервико-медуларна компресия може да се изяви като централна апнея или внезапна смърт. Проблемът при възрастните е прогресивната лумбална стеноза на гръбначния канал, изявяваща се в третата до петата декада с неврогенна клаудикация.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Псевдоахондроплазията (мутация в COMP) имитира ахондроплазията по habitus, но е с нормални лицеви черти и носи атлантоаксиална нестабилност. Комбинацията от непропорционален нисък ръст с нормални лицеви черти трябва да породи образна диагностика на шийния гръбнак и съветване срещу контактни спортове.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Множествената епифизарна дисплазия се изявява с двустранно, симетрично, многоставно епифизарно фрагментиране, много различно от типично едностранната, едноставна болест на Legg-Calvé-Perthes. Синхронните двустранни промени на бедрените глави плюс засягане на коляното плюс фамилна анамнеза трябва да пренасочат диагнозата от Perthes към МЕД или СЕД.</p>
</aside>
...
Прешленните находки включват сплескани, нередовни тела на прешлените с предно „клюнене“, атлантоаксиална нестабилност от хипоплазия на зъбчатия израстък (критичен ортопедичен проблем, изискващ внимателна оценка на шийния гръбнак и обсъждане на профилактична шийна фузия при пациенти с механични или неврологични признаци) и прогресивна сколиоза. Епифизарните находки наподобяват тези при МЕД, като засягането на тазобедрените и коленните стави води до ранна артроза.
...
Тип II (летален): Автозомно доминантни нови мутации (рядко автозомно рецесивни), произвеждащи тежки качествени аномалии на колагена. Множество вътреутробни фрактури, тежка деформация при раждане, перинатална смърт от дихателна недостатъчност в повечето случаи.
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Телескопичните интрамедуларни пирони (Bailey-Dubow, Fassier-Duval) плюс бифосфонатите (памидронат, золедронат) определят съвременното лечение на ОИ. Телескопичният прът се удължава с растящата кост, предотвратява нови фрактури и коригира деформацията чрез многократни остеотомии и интрамедуларно преориентиране в една операция.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Остеопетрозата парадоксално съчетава плътна кост с висок риск от фрактури, а плътната кост е хирургична капана: бургии се чупят, захватът на инструментариума отслабва, васкуларизацията е лоша и псевдоартрозата е честа. Очаквайте трудностите, използвайте остри специализирани инструменти и обяснете на пациента повишения риск от псевдоартроза.</p>
</aside>

## Мукополизахаридози

Мукополизахаридозите (МПС) са група лизозомни болести на натрупването, причинени от дефицит на ензими, участващи в разграждането на гликозаминогликаните. Натрупването на частично разградени гликозаминогликани в лизозоми в целия организъм предизвиква многоорганно заболяване с характерни скелетни прояви. Основните типове включват:
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Атлантоаксиалната нестабилност от хипоплазия на зъбчатия израстък е катастрофалният риск при синдром на Morquio (МПС IV) и СЕД. Рутинният шиен скрининг (флексия-екстензия рентгенографии, МРТ) и профилактичната шийна фузия при първия механичен или неврологичен признак са задължителни; първата проява може да е внезапна тетраплегия след незначителна травма или анестезиологично позициониране.</p>
</aside>
...
Скелетните дисплазии са класифицирани преди молекулярната генетика от Хофа (1905), който разграничава „Knochenwachstumsstörungen" по клиничен фенотип, и от Лексер (1904), който описва хистопатологичния субстрат. Пред-Rubin (1964) и пред-McKusick линията почива на тези клинични описания.
