...
<aside class="callout callout-pearl">
  ...
  <p>Триъгълникът на Fairbank, инферомедиален триъгълен фрагмент, отделящ се по наклонена линия през метафизата на бедрената шийка, е рентгенографският подпис на развитийната coxa vara. Прогресивната му миграция с растежа е това, което превръща лекия варус в псевдоартроза през бедрената шийка при липса на лечение.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Ъгълът на Hilgenreiner-епифизата ръководи хирургичното решение при развитийната coxa vara: нормално <25°, наблюдение 25-45°, операция при ≥45°. Ъгълът е най-силният единичен предиктор за прогресия и най-надеждният задействащ показател за валгусна субтрохантерна остеотомия.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Оперирайте развитийната coxa vara на 3-6 години, с лека свръхкорекция на шийно-диафизарния ъгъл до 140-150° валгус. Следоперативният растеж разрежда корекцията, така че неутралът на операционната маса се превръща в рецидивиращ варус при проследяването; целете отвъд нормата.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>След валгусна остеотомия централната проксимална бедрена физа нерядко се затваря преждевременно, докато трохантерната апофиза продължава да расте, трохантерът се издига, раменото на абдукторите се скъсява, и походката на Тренделенбург се връща. Планирайте повдигането на трохантера в юношеска възраст като част от дългосрочната стратегия, не като спасителна мярка.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Полиостотичната фиброзна дисплазия на проксималния фемур произвежда „пастирска гега“ варус деформация. Интертрохантерната или субтрохантерна валгусна остеотомия с интрамедуларна фиксация е стандарт; разтоварващият прът противостои на високия риск от рефрактура на диспластичната кост.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Принципът на Pauwels е концептуалното ядро на хирургията на coxa vara: вертикалната физа изпитва срязване, което инхибира заздравяването; по-хоризонталната физа след валгусна остеотомия изпитва компресия, която го стимулира. Y-остеотомията завърта проксималния фрагмент, превръщайки срязването в компресия през физеалния дефект.</p>
</aside> Интертрохантерната Y-остеотомия по Pauwels — при която Y-образен клин от кост се отстранява под физата и проксималният фрагмент се завърта, за да ориентира физата по-хоризонтално — е историческото хирургично решение на coxa vara и остава концептуалната основа за съвременните техники на валгусна остеотомия.
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Не всяка скъсена бедрена шийка с варусна ос е развитийна coxa vara. ВДТС, последствия от Perthes, SCFE, постинфекциозен артрит на Tom Smith и скелетните дисплазии я имитират. Триъгълникът на Fairbank, възрастта при изявата и внимателната анамнеза за неонатален сепсис или травма са това, което отличава развитийното от придобитото заболяване, преди подлагане на грешния пациент на Y-остеотомия по Pauwels.</p>
</aside>
...
*Lehrbuch* на Хофа (1905) съдържа класическото ортопедично описание на coxa vara — вродена и развитийна — с коригиращите остеотомии, предхождащи модерната Pauwels интертрохантерна валгизираща остеотомия.

- **Хофа** (1905): *Lehrbuch der orthopädischen Chirurgie* — Coxa vara. · [Факсимиле](https://archive.org/details/lehrbuchderortho00hoff)
- **Langenbeck-Archiv** — оригинални публикации за coxa vara остеотомии. · [Факсимиле (серия)](https://archive.org/details/archivfrklinisc11unkngoog)
