...
<aside class="callout callout-pearl">
  ...
  <p>Всяка SCFE извън типичния възрастов диапазон (под 10 или над 16 години) изисква ендокринологична оценка, хипотиреоидизмът, дефицитът на растежен хормон, панхипопитуитаризмът, хипогонадизмът и бъбречната остеодистрофия отслабват физиса. Двустранна SCFE при бъбречна остеодистрофия е учебникарската комбинация; пропускането на ендокринопатията означава, че и контралатералната тазобедрена става ще се хлъзне.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Класификацията на Loder е прогностичната ос при SCFE: стабилна (може да натоварва дори с патерици) носи ~5% риск от АВН, нестабилна (не може да натоварва дори с патерици) носи ~50%, десетократен скок. Способността за натоварване при постъпване е по-предсказваща за АВН от ъгъла на хлъзване на образната диагностика.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Отразената медиална болка в коляното чрез nervus obturatorius прикрива SCFE зад оплакване от коляното. Ортопедичното правило, при всеки юноша с болка в коляното изследвай тазобедрената става, при всеки юноша с болка в тазобедрената става изследвай коляното, е единственият най-важен навик за предотвратяване на пропуснатата SCFE. Намалената вътрешна ротация и знакът на Drehmann (задължителна екстерна ротация при флексия на тазобедрената става) затвърдяват диагнозата.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Изобразявайте двете тазобедрени стави в ПЗ плюс „жаба“ или истинска странична проекция. Задното хлъзване на епифизата нерядко се скрива при изследване само в ПЗ, а повечето пропуснати SCFE се пропускат, защото страничната проекция никога не е получена. Линията на Klein, която не пресича латералната епифиза, е кардиналният ПЗ признак; метафизарният белег на Steel добавя потвърждение.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Фиксирането in situ с единичен перкутанен канюлиран винт перпендикулярно на физиса е стандартното лечение при стабилна SCFE. Винтът трябва да захваща 4-5 mm от епифизарната кост без да пробие ставната повърхност, вътреставната пенетрация е класическият предизвикател на хондролиза.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Агресивната репозиция на нестабилна SCFE (принудителна вътрешна ротация, аддукция, екстензия) рязко повишава риска от АВН, разкъсвайки кръвоснабдяването от arteria circumflexa femoris medialis. Приемете каквато и нежна позиционна репозиция да осигурява фрактурната маса и фиксирайте в тази позиция; преследването на допълнителна корекция е това, което създава аваскуларната глава.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Гипсирането с тазово-крачолен гипс вече не е приемливо лечение на SCFE, то не предотвратява по-нататъшно хлъзване и исторически предизвикваше хондролиза в до 30% от случаите. В съчетание с вътреставна пенетрация на винта, имобилизацията беше двигател на хондролизата; съвременното in situ фиксиране с единичен винт без гипс е свалило честотата до 1-7%.</p>
</aside>
...
Sliped capital femoral epiphysis е описан от Müller (1888) и Sprengel (1889) в немската литература; *Lehrbuch* на Хофа (1905) интегрира единицата в ортопедичния курикулум, разпознавайки юношеския пик и хронично-острия спектър, който модерната класификация на Loder (1993) ще кодифицира по-късно.

- **Хофа** (1905): *Lehrbuch der orthopädischen Chirurgie* — Coxa adolescentium. · [Факсимиле](https://archive.org/details/lehrbuchderortho00hoff)
- **Langenbeck-Archiv** — оригиналните статии на Müller и Sprengel. · [Факсимиле (серия)](https://archive.org/details/archivfrklinisc11unkngoog)
