...
<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/ortho-2/osteoid-osteoma.png" data-figure-alt="Остеоид-остеом, рентгенография и МРТ на nidus" aria-label="Увеличи">
    <img src="/img/ortho-2/osteoid-osteoma.png" alt="Остеоид-остеом, рентгенография и МРТ на nidus" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Остеохондромът е в непрекъснатост с медуларната кухина на родителската кост — рентгенологичният белег, който го отличава от всяка повърхностна неоплазма. Продължаващ растеж след затваряне на физиса или нова болка при възрастен трябва да породят съмнение за вторичен хондросарком, с цитиран риск около 1% при солитарната форма и до 10% при HME (по-висок при EXT1).</p>
</aside>
