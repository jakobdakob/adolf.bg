...
<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/ortho-20/fai-schema.svg" data-figure-alt="FAI, cam и pincer" aria-label="Увеличи">
    <img src="/img/ortho-20/fai-schema.svg" alt="FAI, cam и pincer" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pearl">
  ...
  <p>Cam-морфологията се количествено определя чрез ъгъла алфа: над 50-55° на проекция Dunn 45° или радиален МРТ срез е абнормен. Несферичната глава срязва хондролабралното съединение в антеросупериорния ацетабулум, давайки характерна хрущялна деламинация при относително запазен лабрум в ранен стадий, обратното на pincer болестта, при която лабрумът умира първи.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Импинджмънтът тип Pincer е по-типичен при жени на средна възраст, с ацетабуларна ретроверзия (знак на кръстосване, изпъкнала spina ischiadica, дефицитна задна стена), coxa profunda или protrusio acetabuli като морфологичен субстрат. Увреждането удря първо лабрума и произвежда contre-coup хрущялна лезия в постероинфериорния ацетабулум.</p>
</aside>

## Комбиниран (смесен) импинджмънт

Комбинираният импинджмънт (с характеристики и на двата типа) е най-честият модел в клиничната практика, като повечето пациенти демонстрират известна степен едновременно на абнормен офсет на главата и врата и на абнормно ацетабуларно покритие. Лечението трябва да адресира двата компонента.
...
Асоциацията на FAI с тазобедрена остеоартроза е едно от основните клинични открития на последните две десетилетия. Няколко обширни кохортни проучвания са демонстрирали, че морфологичните характеристики на FAI (ъгъл алфа, знак на кръстосване, ацетабуларен индекс) при млади хора са силен предиктор за развитие на симптоматична тазобедрена остеоартроза в средна възраст. Копенхагенското остеоартрозно проучване и други дългосрочни кохорти са установили тази рискова асоциация, макар абсолютният дял на пациентите с морфологичен FAI, при които се развива симптоматична ОА, да е вариабилен, а ролята на превантивната интервенция при асимптоматичен FAI да остава предмет на дискусия.
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>C-знакът (пациентът прегражда засегнатата тазобедрена става с пръсти отпред и палец отзад) и намалената вътрешна ротация при флексия са двете най-резултатни находки при леглото на пациента при FAI. Добавете положителен тест FADIR (флексия, аддукция, вътрешна ротация), възпроизвеждащ ингвиналната болка, и клиничната диагноза до голяма степен е поставена.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>МР-артрографията с вътреставен гадолиний е стандартът за дефинитивна диагноза на FAI, контрастът подчертава лабралните разкъсвания и хрущялната деламинация. Вътреставният анестетик, добавен по времето на артрографията, се удвоява като диагностичен тест: пълното облекчаване на болката потвърждава вътреставен източник и изключва имитатори на ингвинална болка като спортна пубалгия или лумбална радикулопатия.</p>
</aside>

## КТ и 3D образна диагностика

КТ с триизмерна реконструкция осигурява най-точна костна морфологична оценка и се използва все по-широко за хирургично планиране, особено при комплексна Cam-морфология и за оценка на ацетабуларната верзия и бедрената верзия.
...
<aside class="callout callout-pitfall">
  ...
  <p>Бедрената cam-остеопластика има тесни граници: недостатъчната резекция оставя персистиращ импинджмънт и симптоми, прекомерната резекция изтънява врата и рискува фрактура на бедрения врат. Потвърдете адекватността с динамично интраоперативно тестване за импинджмънт и интраоперативна флуороскопия в множество равнини.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Артроза клас 2 или по-висок по Tönnis (или ставно пространство под 2 mm) е най-силният предиктор за неуспех на хирургията за FAI. След като остеоартрозата е установена, артроскопията не отлага нищо и се превръща в лош резултат; насочете към ендопротезиране, а не към импинджмънт хирургия.</p>
</aside>
...
Спортисти: FAI е особено чест при спортисти, занимаващи се с ротационни спортове, като процентът на завръщане към спорта след операция е 80-90% в много серии. Моментът на завръщане е типично 4-6 месеца за безконтактни спортове и 6-9 месеца за контактни спортове.
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Граничната ацетабуларна дисплазия (ъгъл на центъра-периферията 20-25°) е капана. Агресивен лабрален дебридмент или тримиране на ръба превръща маргинално стабилна тазобедрена става в ятрогенна нестабилност с катастрофални последици. Предпочитайте нежна лабрална реинсерция с капсулна пликация и обмисляйте PAO, когато диспластичните характеристики преобладават.</p>
</aside>
...
Феморо-ацетабуларният импиджмент е модерна единица (Ganz 2003), но анатомичният му субстрат — несферичната феморална глава с проминиращ преход глава-шийка — е документиран още в патологията на тазобедрената става от XIX век. *Lehrbuch* на Хофа (1905) разпознава пост-травматичните и развитийните аномалии на контура глава-шийка, а линията на разпознаване минава през Smith-Petersen (1936) до Ganz.

- **Хофа** (1905): *Lehrbuch der orthopädischen Chirurgie* — патология на тазобедрената става. · [Факсимиле](https://archive.org/details/lehrbuchderortho00hoff)
- **Langenbeck-Archiv** — оригинални публикации от ерата на Hueter и Smith-Petersen. · [Факсимиле (серия)](https://archive.org/details/archivfrklinisc11unkngoog)
