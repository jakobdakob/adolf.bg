...
<aside class="callout callout-pearl">
  ...
  <p>Повечето случаи, исторически назовани „първична“ коксартроза, всъщност са вторични: cam-типът FAI е доминиращата предразполагаща морфология при мъжете, ацетабуларната дисплазия — при жените. Във всяка „идиопатична“ коксартроза търсете подлежаща механична причина.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Вътрешната ротация е първото и най-надеждно изгубено движение при коксартрозата. Болка в слабините, ирадииираща към медиалното коляно през nervus obturatorius, е класически и често пропускан модел, който сочи към тазобедрената става, а не към коляното.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Четирите кардинални рентгенографски белега на ОА: стеснение на ставната цепка (горно при идиопатична коксартроза), субхондрална склероза, субхондрални кисти (геоди) и периферни остеофити. Kellgren-Lawrence е универсалното степенуване; Tönnis е тазобедрено-специфичен.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Бастун, държан в ПРОТИВОПОЛОЖНАТА ръка, намалява реактивното натоварване на тазобедрената става с 20-40%, проста и подценявана механична интервенция. Глюкозаминът и хондроитинът нямат последователни доказателства и не се препоръчват от основните ръководства.</p>
</aside>

## Ставнозапазваща хирургия

При подходящи по-млади пациенти с предартрозна или ранна артрозна тазобедрена болест ставнозапазващите хирургични процедури целят корекция на подлежащата механична аномалия и забавяне или предотвратяване на прогресията до крайния стадий на остеоартрозата. Основните опции включват:
...
<aside class="callout callout-pitfall">
  ...
  <p>Артроскопия на тазобедрената става при установена ОА (Tönnis Grade 2 или по-висока) дава лоши резултати и следва да се избягва; тя е инструмент за предартрозната става. PAO е запазена за диспластичната става със запазено ставно пространство и конгруентна артикулация.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Стандартна цел за ацетабуларната чаша: 40° абдукция, 15° антеверзия. Безопасната зона на Lewinnek (30-50° абдукция, 5-25° антеверзия) се усъвършенства от спинопелвикалната мобилност чрез „функционална антеверзия“; ригиден лумбален гръбнак стеснява безопасния прозорец.</p>
</aside>
...
Луксация: Честота 1-3% при съвременна първична ТАС, по-висока при ревизионни операции и при пациенти с нервно-мускулни заболявания. Причините включват неправилна позиция на импланта, дисбаланс на меките тъкани, мускулна слабост и пациент-свързани фактори. Лечението на остра луксация е закрита репозиция; рецидивиращата луксация изисква ревизионна операция, типично с ревизия на позицията на компонентите, използване на по-голяма бедрена глава, чаша с двойна мобилност или ограничаваща вложка.
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>При всяка перипротезна бедрена фрактура решаващият въпрос за Vancouver B е фиксацията на стволеца: B1 (добре фиксиран) — ORIF, B2 (разлюлян) — ревизия на стволеца, B3 (разлюлян с лош костен запас) — ревизия плюс алографт или мегапротеза. Грешна оценка на фиксацията води до ранна ре-ревизия.</p>
</aside>
