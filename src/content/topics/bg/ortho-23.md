...
<aside class="callout callout-pearl">
  ...
  <p>Hallux valgus е триизмерна деформация: латерална девиация на палеца ПЛЮС медиална девиация (варус) на първата метатарзална кост ПЛЮС пронация на палеца ПЛЮС латерална миграция на сезамоидите. Лечението само на медиалния бунион пренебрегва подлежащия варус на първия лъч и подготвя рецидив.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Фамилната обремененост е най-силният единичен рисков фактор за hallux valgus, по-силен от обувките (които не могат да са единствена причина предвид разпространеността при необувани популации). Adductor hallucis се превръща в деформираща сила, щом метатарзалната кост се отклони медиално, поддържайки порочния цикъл.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Прагови стойности на HVA: норма <15°, лека 15-25°, умерена 25-40°, тежка >40°. Интерметатарзален ъгъл 1-2: норма <9°, лек 9-13°, умерен 13-20°, тежък >20°. Дисталните процедури са за леки деформации; проксимална остеотомия или Lapidus адресира умерения до тежък IMA.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Хипермобилност на първата тарзометатарзална става изисква Lapidus (артродеза на ТМТ), а не дистална остеотомия: дисталните процедури не могат да стабилизират проксималната става и рецидивът е правило. Конгруентен hallux valgus (повишен DMAA) се коригира с остеотомия по Akin на проксималната фаланга, без нарушаване на конгруентната МТФ става.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Агресивно латерално освобождаване, комбинирано с проксимална остеотомия, е класическата рецепта за hallux varus (свръхкорекция) и аваскуларна некроза на главата на първата метатарзална кост. Процедурите, скъсяващи първата метатарзална кост, предсказуемо произвеждат трансферна метатарзалгия.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Болката при hallux rigidus се провокира от дейности, изискващи ДОРЗИФЛЕКСИЯ (отблъскване, ходене нагоре, ставане от стол), защото дорзалният остеофит импинджира. Класификацията на Hattrup-Johnson води лечението: Степени 1-2 (хейлектомия), Степен 3 (артродеза).</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Артродезата на първата МТФ става е златен стандарт при напреднал hallux rigidus (Hattrup-Johnson Степен 3) и при hallux valgus с установена артроза, с удовлетворение над 90%. Положение на фузията: ~15° дорзифлексия спрямо пода, 10° валгус, неутрална ротация.</p>
</aside>
...
Литературата за hallux valgus е плътно епонимизирана: Hueter (1871) дава мекотъканното отпускане; Хофа (1905) — резекцията на метатарзалната глава („Hoffa-Operation"); Silver (1923) и McBride (1928) — модерните мекотъканни процедури; Akin (1925) — фалангеалната остеотомия; а остеотомиите chevron и scarf са от средата на XX век. *Die operative Chirurgie* на Dieffenbach (1848) съдържа основополагащите тенотомии и артротомии.

- **Хофа** (1905): *Lehrbuch der orthopädischen Chirurgie* — Hallux valgus, Hoffa-операция. · [Факсимиле](https://archive.org/details/lehrbuchderortho00hoff)
- **Dieffenbach** (1848): *Die operative Chirurgie*, том 2 — ранни операции на стъпалото. · [Факсимиле](https://archive.org/details/dieoperativechir02dief)

## Обобщение и ключови изводи

Статичните деформации на предното стъпало — hallux valgus, hallux rigidus и деформациите на малките пръсти (чукообразен, нокътен, малетен, кросоувър пръст) — са изключително чести причини за болка в стъпалото и функционална инвалидност. Hallux valgus, класифициран по ъгъла на hallux valgus и интерметатарзалния ъгъл, се лекува консервативно при лека болест и чрез стадий-подходящи оперативни процедури при по-тежка — дистална остеотомия за лека деформация, проксимална остеотомия или процедура по Lapidus за умерена до тежка, МТФ артродеза при напреднала болест с артроза. Hallux rigidus (остеоартрозата на първата МТФ става) се лекува с хейлектомия при ранна болест и с артродеза при напреднала, като ставно ендопротезиране е запазено за подбрани пациенти. Деформациите на малките пръсти се лекуват с тендотрансфери при гъвкави и с артродеза или резекционна артропластика при фиксирани деформации, нерядко в комбинация с метатарзални процедури. При всички разстройства на предното стъпало принципите на прецизна клинична и рентгенографска оценка, стъпаловидно консервативно лечение и оперативни процедури, съобразени с конкретните компоненти на деформацията, осигуряват успешни резултати при мнозинството от пациентите.
