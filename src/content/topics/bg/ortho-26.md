...
<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/ortho-26/erb-palsy.jpg" data-figure-alt="Акушерска брахиална парализа (парализа на Erb)" aria-label="Увеличи">
    <img src="/img/ortho-26/erb-palsy.jpg" alt="Акушерска брахиална парализа (парализа на Erb)" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Парализата на Erb (C5-C6 ± C7) представлява ~70% от АПБП и поражда „позиция на сервитьорска бакшиш“ (адукция и вътрешна ротация на рамото, екстензия в лакътя, пронация на предмишницата). Парализата на Klumpke (C8-T1) е рядка в изолиран вид, произвежда нокътна ръка и се сигнализира от синдром на Horner (птоза, миоза, анхидроза), сочещ прегангионна авулзия на корена.</p>
</aside>

## Класификация по патологична тежест

Класификацията на Sunderland за нервни травми се прилага към уврежданията на брахиалния плексус:
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Около 65-75% от случаите на АПБП се възстановяват напълно в рамките на 6-12 месеца. Най-важният решителен момент е бицепсовата функция (флексия на лакътя срещу гравитацията) на 3-6 месеца; липсата на възстановяване дотогава е класическото показание за оперативна ревизия с невролиза, нервен графтинг или нервен трансфер.</p>
</aside>

## Вродена мускулна тортиколис

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/ortho-26/torticollis.jpg" data-figure-alt="Тортиколис" aria-label="Увеличи">
    <img src="/img/ortho-26/torticollis.jpg" alt="Тортиколис" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
Диференциалната диагноза включва: вродени аномалии на цервикалния гръбначен стълб (синдром на Klippel-Feil, хемипрешлени, атлантоаксиална сублуксация); очни причини (зрително нарушение с компенсаторен наклон на главата); причини от централната нервна система (тумор на задната черепна ямка, сирингомиелия); възпалителни или инфекциозни причини (атлантоаксиална ротаторна сублуксация след инфекция на горните дихателни пътища, синдром на Grisel); окуломоторен мускулен дисбаланс (парализа на IV черепномозъчен нерв); и синдром на Sandifer (пароксизмални дистонични движения на главата и врата, свързани с гастроезофагеален рефлукс).
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Позиция на главата при ВМТ: наклон КЪМ засегнатия SCM, ротация на брадичката ВСТРАНИ от него. Пасивно разтягане, обучено на родителите и провеждано многократно дневно, отзвучава 90-95% до 12-18 месеца. Тенотомия на SCM е запазена за случаите без отговор след 12-18 месеца.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Фрактурата на ключицата и АПБП изглеждат еднакво на леглото: и двете пораждат тиха ръка. Намаленото движение при фрактура на ключицата е от БОЛКА при нормална подлежаща нервна функция и отзвучава за 2-3 седмици с зарастването. Потвърдете с рентгенография и палпация на крепитация/калус преди да поставите диагноза на брахиалния плексус.</p>
</aside>
...
Подкожната тенотомия на m. sternocleidomastoideus при вроден torticollis е една от основополагащите операции на ортопедичната хирургия: Stromeyer (1838) и Dieffenbach (1840-те) разработват техниката, която по-късно Хофа консолидира. Erb (1874) и Klumpke (1885) описват родовите наранявания на брахиалния плексус, които все още носят имената им.

- **Dieffenbach** (1845–48): *Die operative Chirurgie*, том 2 — Schiefhals-Tenotomie. · [Факсимиле](https://archive.org/details/dieoperativechir02dief)
- **Хофа** (1905): *Lehrbuch der orthopädischen Chirurgie* — Torticollis, родови наранявания. · [Факсимиле](https://archive.org/details/lehrbuchderortho00hoff)
