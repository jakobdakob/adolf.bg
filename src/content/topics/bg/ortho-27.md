...
<aside class="callout callout-pearl">
  ...
  <p>Патофизиологията на компресията протича предвидимо: венозен застой → вътреневрален оток → исхемия → сегментна демиелинизация → аксонална загуба. Ранното заболяване (парестезии, интермитентни) е напълно обратимо; установената аксонална травма с мускулна атрофия не е, поради което времето на оперативната намеса спрямо симптомите е от значение.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Съдържание на карпалния тунел: 9 флексорни сухожилия (4 FDP, 4 FDS, 1 FPL) плюс n. medianus в тунел с ФИКСИРАН обем. Всичко, което уголемява съдържимото (тендосиновит, задържане на течности при бременност, амилоид при диализни пациенти), повишава налягането. Жените преобладават 3:1.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Тенарната атрофия при СКТ сигнализира установена аксонална травма и ненадежден отговор на операцията; декомпресирайте ПРЕДИ да настъпи атрофията. Нощните парестезии, които се облекчават при разклащане на ръката („знак на разклащане“), са ранен и силно подсказващ белег.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Cubital tunnel: n. ulnaris под лигамента на Osborne между медиалния епикондил и олекранона. Симптомите се влошават при ФЛЕКСИЯ на лакътя (разтягане и компресия). Знакът на Froment демонстрира слаб m. adductor pollicis: интерфалангеалната става на палеца флектира при ключова щипка, докато FPL замества.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Синдромът на radial tunnel е големият имитатор на латералния епикондилит („тенис лакът“). Болезнеността е 3-5 cm ДИСТАЛНО от латералния епикондил (не върху него), а симптомът е БОЛКА без слабост. Неуспешна операция за „тенис лакът“ нерядко означава пропуснат radial tunnel.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Синдромът на предния интеросеозен нерв (Kiloh-Nevin) е ЧИСТО ДВИГАТЕЛЕН: слабост на FPL, FDP към показалеца и m. pronator quadratus, водеща до класическата невъзможност за истински знак „ОК“ (щипка с екстендирана IP на палеца и DIP на показалеца). Сетивността е нормална, това е ключовото отличие от проксималната компресия на n. medianus.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Общият перонеален нерв при шийката на фибулата е класическата „позиционна“ парализа: кръстосани крака, продължителна анестезия, стегнати гипсове. Изявата е с провисване на стъпалото (слабост на дорзифлексията и еверзията) и сетивен дефицит по дорзума на ходилото. Подплъстяването е профилактично; освобождаването е запазено за рефрактерни случаи.</p>
</aside>
...
Синдромите на периферно нервно притискане са разпознавани клинично далеч преди електродиагностичното потвърждение. *Médecine opératoire* на Velpeau (1832) и *Leçons orales* на Дюпюитрен (1832) съдържат ранни описания; синдромът на carpal tunnel е именуван през 1920-те, но субстратът му — притискането на n. medianus при китката — е документиран още в клиничните серии на XIX век.

- **Velpeau** (1832): *Nouveaux éléments de médecine opératoire*, том 2. · [Факсимиле](https://archive.org/details/BIUSante_43901x02)
- **Дюпюитрен** (1832): *Leçons orales de clinique chirurgicale*, том 3 — дистален горен крайник. · [Факсимиле](https://archive.org/details/leonsoralesdec03dupu)
