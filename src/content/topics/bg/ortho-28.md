...
<aside class="callout callout-pearl">
  ...
  <p>„Тендинитът“ е неточен термин при хронично заболяване: хистологията показва ДЕГЕНЕРАЦИЯ (дезорганизиран колаген, мукоидно основно вещество, ангиофибробластна пролиферация), а не възпалителни клетки. Оттам съвременният термин „тендиноза“ и преориентирането от НСПВС/стероиди към ексцентрични упражнения, ударно-вълнова терапия и биологични инжекции.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Класификация на Neer за impingement: стадий 1 — обратим оток на маншона, стадий 2 — фиброза/тендиноза, стадий 3 — разкъсване на маншона. Тип III по Bigliani (закачест акромион) носи най-висок риск за разкъсване. Мастната инфилтрация по Goutallier (0-4) е основният прогностичен фактор при реконструкция на маншона.</p>
</aside>

## Калцифициращ тендинит на ротаторния маншон

Калцифициращият тендинит е самоограничаващо се състояние, при което калциево-хидроксиапатитни отлагания се формират в ротаторния маншон, най-често в сухожилието на m. supraspinatus. Разграничават се три фази: формативна фаза (варовидни калцифициращи отлагания, често безсимптомни); резорбтивна фаза (остра тежка болка при разтварянето на отлаганията и освобождаването на възпалителни цитокини); и посткалцифицираща фаза (резолюция). Болката в острата резорбтивна фаза е сред най-тежките болки в рамото в клиничната практика. Лечението в формативната фаза е консервативно (НСПВС, физиотерапия); резорбтивната фаза се лекува с НСПВС, вътребурсална кортикостероидна инжекция и понякога ехографски насочена игленна аспирация на калцифициращото отлагане (barbotage), като хирургичното отстраняване се запазва за рефрактерни случаи.

<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Болката при калцифициращия тендинит достига връх в РЕЗОРБТИВНАТА фаза, когато се освобождават цитокини при разтварянето на отлаганията, нерядко най-силната болка в рамото, която пациент изпитва. Заболяването е самоограничаващо се; лекувайте острата болка с НСПВС и бурсални стероиди, обмислете barbotage при резистентни случаи.</p>
</aside>
...
Латералният епикондилит е хронична тендинопатия в началото на мускулите, екстензори на китката, предимно m. extensor carpi radialis brevis (ECRB), при латералния хумерусен епикондил. Това е най-честата причина за болка по страничната страна на лакътя при възрастни, засягаща приблизително 1-3% от общото население. Названието „тенис-лакът“ отразява връзката с бекхенд удара в тениса, но голямата част от случаите се срещат при хора, неиграещи тенис — типично при повтарящо се разгъване на китката в рамките на професионална дейност.
...
<aside class="callout callout-pitfall">
  ...
  <p>Болезнеността при латерален епикондилит е ВЪРХУ латералния епикондил (над началото на ECRB); тази при radial tunnel е 3-5 cm ДИСТАЛНО от него. Тестът на Maudsley (болка при съпротивлявано разгъване на средния пръст) подкрепя латералния епикондилит. Стероидните инжекции дават краткосрочна полза, но може да влошат дългосрочния изход, поставете очакванията съответно.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Теносиновит на De Quervain: болка по първото дорзално отделение (APL + EPB); положителен Finkelstein (активна флексия на палеца в дланта с улнарна девиация). Допълнителни снопчета на APL и преградени субкомпартменти са налични при много пациенти; ПРОПУСКАНЕТО на отделна субшива на EPB е чест повод за хирургичен неуспех.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Trigger finger е стенозиращ теносиновит при шивата A1 над главичката на метакарпалната кост. Стероидната инжекция излекува 60-85% при една-две инжекции (ПО-НИСКО при диабетици). Откритото освобождаване на A1 под местна анестезия е >95% успешно при рефрактерни случаи.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>„Болката при първата стъпка“ при плантарен фасциит е най-силна при първоначално натоварване сутрин и се подобрява с продължаване на активността, обратният модел спрямо възпалителния артрит. Избягвайте повторни стероидни инжекции в петата: атрофията на мастната подложка е известно ятрогенно усложнение, което влошава болката и трудно се обръща.</p>
</aside>
...
Периартикуларните мекотъканни състояния са систематично каталогизирани от Хофа (1905) под „Schleimbeutelentzündungen, Periarthritis, Tendinitis". Субстратът на supraspinatus импиджмента е по-късно изяснен от Codman (1934) — макар неговата основна монография все още да е под копирайт, по-ранните му списанийни статии (1909–1929) са в публичен домейн.

- **Хофа** (1905): *Lehrbuch der orthopädischen Chirurgie* — Periarthritis. · [Факсимиле](https://archive.org/details/lehrbuchderortho00hoff)
- **Bier / Braun / Kümmell** (1920): *Chirurgische Operationslehre*, том 2 — рамо и горен крайник. · [Факсимиле](https://archive.org/details/chirurgischeoperationslehre1920v2)
