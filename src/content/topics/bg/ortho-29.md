...
<aside class="callout callout-historical">
  <span class="callout-label">Класически глас — Дюпюитрен 1832</span>
  <blockquote lang="fr">
    <p>« La rétraction des doigts, et surtout de l'annulaire … était, jusqu'à notre époque, à peu près inconnue dans sa cause. … Il était dès lors naturel de conclure que le point de départ de la maladie était dans la tension exagérée de l'aponévrose palmaire, et que cette tension elle-même était due à une contusion de l'aponévrose par suite de l'action trop forte ou trop long-temps prolongée d'un corps dur dans la paume de la main. »</p>
  </blockquote>
  <p><strong>Превод (BG):</strong> „Ретракцията на пръстите, и преди всичко на безименния … до нашата епоха беше почти неизвестна по причина. … Беше следователно естествено да се заключи, че началната точка на заболяването е в прекомерното напрежение на палмарната апоневроза, и че самото това напрежение се дължи на контузия на апоневрозата вследствие на твърде силно или твърде продължително действие на твърдо тяло в дланта."</p>
  <p class="callout-source">— Guillaume Dupuytren, <em>Leçons orales de clinique chirurgicale faites à l'Hôtel-Dieu de Paris</em>, том 1, Article premier: « Rétraction permanente des doigts, par suite d'une affection de l'aponévrose palmaire » (Paris: Baillière, 1832), стр. 1–7. <a href="https://archive.org/details/leonsoralesdec01dupu" target="_blank" rel="noopener noreferrer">Факсимиле в Internet Archive →</a></p>
</aside>
...
<aside class="callout callout-pearl">
  ...
  <p>Диатезата на Dupuytren = агресивен, склонен към рецидив фенотип: положителна фамилна анамнеза, ДВУСТРАННА болест, начало преди 40-годишна възраст и ектопична болест (нодули на Garrod, плантарна фиброматоза на Ledderhose, болест на Peyronie). Тези пациенти заслужават дермофасциектомия или по-ранна ескалация, а не минимални процедури.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>СПИРАЛНОТО ВЪЖЕ обвива и измества невроваскуларния сноп МЕДИАЛНО и ПОВЪРХНОСТНО, поставяйки пръстовия нерв и артерия директно в оперативното поле. Агресивна дисекция по протежение на привидно въже без отчитане на това изместване е класическият механизъм на ятрогенно увреждане на пръстовия нерв при операцията на Dupuytren.</p>
</aside>

## Клинична картина

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/ortho-29/dupuytren.jpg" data-figure-alt="Дюпюитренова контрактура" aria-label="Увеличи">
    <img src="/img/ortho-29/dupuytren.jpg" alt="Дюпюитренова контрактура" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Тестът на Hueston (tabletop) е прагов клиничен критерий: ако пациентът не може да постави дланта плоско на маса, контрактурата изисква намеса. Класическите прагове са фиксирана контрактура на МФС от 30°+ или КАКВАТО И ДА Е фиксирана контрактура на ПИС, ПИС развива необратими контрактури на volar plate и капсулата, така че не отлагайте.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Избор на процедура: игленната апоневротомия е бърза, амбулаторна, лесно повторима, но с 50-80% рецидив до 5 години. Колагеназата постига сходна корекция чрез ензимно разграждане (с малък риск от руптура на сухожилие). Ограничената фасциектомия е стандарт при установена болест; дермофасциектомията е най-добрата опция при диатеза на Dupuytren.</p>
</aside>

## Инжекция с колагеназа (колагеназа на Clostridium histolyticum)

Инжекцията с колагеназа на Clostridium histolyticum (Xiaflex, Xiapex) е ензимно лечение, въведено през 2010 г. Процедурата включва вътревъжена инжекция на бактериалния ензим колагеназа, който селективно разгражда колагена на въжето. След 24-48 часа пациентът се връща за манипулация на въжето под местна анестезия, с чуваемо „пукане“ при разкъсването на въжето и незабавно подобрение на контрактурата.
...
Принципите на хирургичното лечение включват: внимателно предоперативно планиране на разрезите (зигзагообразен разрез по Bruner, множество Z-пластики или надлъжни разрези с Z-пластично затваряне за предотвратяване на линейна белязна контрактура); внимателно интраоперативно идентифициране и защита на невроваскуларните снопове (особено на a. et n. digitalis radialis, които могат да бъдат изместени повърхностно от спиралното въже); идентифициране и ексцизия на цялата макроскопски болна фасция; пълна мобилизация на контрактурираните ПИС при засягането им (понякога изискваща освобождаване на volar plate при установени контрактури); и следоперативно шиниране и интензивна рехабилитация на ръката за поддържане на разгъване.
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Рецидивът след ограничена фасциектомия е приблизително 30-50% на 5-10 години; дермофасциектомията с пълнодебелинна кожна трансплантация го намалява до 10-20%, тъй като се отстранява и болният кожен субстрат. Изберете дермофасциектомия при агресивна или рецидивираща болест.</p>
</aside>

## Спасителни процедури

При тежка рецидивираща или неподлежаща на спасяване болест са описани няколко спасителни процедури: артродеза на ПИС (при фиксирана тежка контрактура на ПИС, неподлежаща на друго лечение); ампутация на засегнатия пръст (рядко необходима, обикновено при тежка контрактура на малкия или безименния пръст с невроваскуларно компрометиране); и различни комбинирани процедури.

<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Тежка болка при пациент с Dupuytren трябва да наложи преразглеждане на диагнозата: класическата болест е безболезнена или с минимална болезненост. Болка, бърз растеж, нетипична локализация или мека маса насочват към алтернатива (ганглий, инфекция, мекотъканен тумор).</p>
</aside>
...
Основният оригинален текст на болестта остава първоначалната лекция на Дюпюитрен, изнесена в Hôtel-Dieu в Париж и публикувана в неговите *Leçons orales*. Дюпюитрен описва дисекционната находка — че субстратът на ретракцията е в самата палмарна апоневроза, а не в флексорните сухожилия, както дотогава са смятали Boyer и съвременниците му — и предлага подкожното разделяне на дигиталните прозлъжения на апоневрозата като пожизнено лечение. Pareé през XVI век е документирал сходни „изтегляния" на пръстите, но без анатомична етиология; Boyer (1815) ги нарича *Crispatura tendinum* без да ги разделя от сухожилните контрактури — погрешка, която Дюпюитрен коригира посредством дисекция на трупа на жертва на болестта. Първоначалните оперативни резултати на самия Дюпюитрен (наблюдение I в Article premier) демонстрират пълно разгъване след подкожното разделяне на палмарната апоневроза. Класическата терминология „болест на викингите" — изразяваща географската концентрация в Северна Европа — е модерна; самият Дюпюитрен я свързва с механична травма от занаятите (винотърговеца, мазача, кочияша).

- **Дюпюитрен** (1832): *Leçons orales de clinique chirurgicale faites à l'Hôtel-Dieu de Paris*, том 1, Article premier. Лекцията от 5 декември 1831 г. — основополагащият описателен текст на заболяването. · [Факсимиле в Internet Archive](https://archive.org/details/leonsoralesdec01dupu)
- **Paré** (Œuvres complètes, изд. Malgaigne 1840): том 2, ранни описания на ретракции на пръстите без етиологична хипотеза. · [Факсимиле](https://archive.org/details/oeuvrescomplte02par)
