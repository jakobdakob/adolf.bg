...
<aside class="callout callout-pitfall">
  ...
  <p>Никога не биопсирайте преди пълно образно изследване: нативни рентгенографии в две проекции, МРТ на костта, КТ на гръден кош и костна сцинтиграфия или ПЕТ-КТ. Гефрирът служи само за потвърждаване на адекватна тъкан, а не за дефинитивна диагноза, а каналът трябва да лежи по линията на бъдещия дефинитивен разрез, за да може да се ексцизира en bloc.</p>
</aside>
...
<aside class="callout callout-pearl">
  ...
  <p>Остеосаркомът има бимодална възрастова крива: пубертетен растежен пик около метафизите на коляното и рамото, и по-малък възрастов пик в кост на Paget, облъчена кост или фиброзна дисплазия. Повишена ЛДХ преди лечението е неблагоприятен прогностичен фактор.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Съвременното лечение е неоадювантна MAP (високодозов метотрексат, доксорубицин, цисплатин), широка резекция с 1-2 cm здрава кост и адювантна MAP. Некроза по Huvos >90% дефинира добър отговорител и корелира с преживяемостта; <90% налага смяна на схемата следоперативно.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Саркомът на Ewing е дребно-кръгло-синьоклетъчен тумор с t(11;22)(q24;q12) и слят ген EWS-FLI1 при ~85% от случаите, с характерно мембранно оцветяване за CD99. Диафизарна пермеативна лиза с „лучна“ периостална реакция и мекотъканна маса, несъразмерна с костното отклонение, е рентгенологичният подпис, а температурата с повишена СУЕ може да имитира остеомиелит.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Конвенционалният хондросарком е химио- и радиорезистентен: единственият адювант е скалпелът на хирурга, затова широката en-bloc резекция с негативни граници е куративна при нискостепенните и междиннодиференцираните тумори. Дедиференцираният и мезенхимният вариант са изключения и се лекуват с неоадювантна химиотерапия като високостепенни саркоми.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Хордомът произхожда от нотохордални остатъци по средната линия на аксиалния скелет (сакрококцигеален 50%, сфено-окципитален 35%, подвижен гръбначен стълб 15%) и показва физалифорни клетки с позитивност за brachyury (T). Сакректомията трябва да запази поне един S2 корен, за да се поддържат функциите на червата и пикочния мехур; резекция над S3 неизбежно компрометира континенцията.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Множественият миелом се дефинира с критериите CRAB (хиперкалциемия, бъбречна недостатъчност, анемия, костни лезии) и дава чисто литични, „пробити“ лезии без околна склероза. Костната сцинтиграфия е прословуто фалшиво негативна, тъй като лезиите нямат остеобластен отговор, затова нискодозовата цялотелесна КТ, цялотелесната МРТ или ПЕТ-КТ замениха рентгеновото скелетно изследване.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Сбор по Mirels >=9 при метастаза в дълга кост предсказва висок риск от фрактура в рамките на месеци и подкрепя профилактична фиксация; <=7 подкрепя самостоятелна лъчетерапия; 8 е зоната на обсъждане. Четирите оси са локализация, характер на болката, тип на лезията (литичната — най-лоша) и размер спрямо диаметъра на костта (>2/3 — най-лош).</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Метастатичните фрактури на бедрената шийка се лекуват с протезиране (хемиартропластика или тотална ендопротеза), а не с вътрешна фиксация: псевдоартрозата през болна кост и аваскуларната некроза на компрометираната глава са предсказуеми. Бъбречноклетъчните, щитовидните и другите силно васкуларизирани метастази изискват предоперативна селективна емболизация преди всяка операция.</p>
</aside>

## Източници и класическа литература

Билрот (1882) класифицира малигнените костни тумори като „bösartige Knochengeschwülste" — синтез на Виенската школа, който дълго предшества модерните системи Enneking и AJCC. Малгень (1847) още по-рано разграничава патологичните фрактури през тумор като отделна клинична единица, изискваща различно лечение от травматичните фрактури.

- **Билрот** (1882): *Allgemeine chirurgische Pathologie und Therapie* — туморна класификация. · [Факсимиле](https://archive.org/details/dieallgemeinechi1882bill)
- **Лексер** (1904): *Lehrbuch der allgemeinen Chirurgie*, том 2. · [Факсимиле](https://archive.org/details/lehrbuchderallg01lexegoog)
- **Малгень** (1847): *Traité des fractures et des luxations*, том 1 — патологични фрактури. · [Факсимиле](https://archive.org/details/BIUSante_32985x01)
