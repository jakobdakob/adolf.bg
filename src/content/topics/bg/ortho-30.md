...
<aside class="callout callout-pearl">
  ...
  <p>Съвременни носещи повърхности: силно омреженият полиетилен (XLPE), произведен чрез гама-облъчване на UHMWPE с последващо претопяване/отгряване за елиминиране на свободните радикали, преобрази артропластиката чрез намаляване на износването и почти пълно елиминиране на остеолизата. XLPE, стабилизиран с витамин Е, допълнително притъпява оксидативната деградация. PMMA циментът осигурява незабавна фиксация; нециментираната разчита на биологично врастване или нарастване.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Носещите повърхности метал-метал (особено дизайните с голяма глава) са до голяма степен изоставени поради отделянето на кобалт-хромови йони, неблагоприятни локални тъканни реакции, образуване на псевдотумори и системен кобалтизъм. Дори при метал-полиетиленови конструкции е възможно развитие на трунионоза при модулната граница глава-стебло, модулярността не е без биологична цена.</p>
</aside>

## Методи на фиксация

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/ortho-30/hip-replacement.jpg" data-figure-alt="Безциментирана тазобедрена протеза" aria-label="Увеличи">
    <img src="/img/ortho-30/hip-replacement.jpg" alt="Безциментирана тазобедрена протеза" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Изберете циментирана фиксация при по-възрастни пациенти с лошо качество на костта и при хемиартропластика за фрактура на тазобедрената става; изберете нециментирана при по-млади пациенти с добро качество на костта (повечето съвременни първични ТАС/ТАК в много центрове). Хибридна = нециментирана чашка + циментирано стебло е чест компромис.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Ограничението на импланта е баланс: по-голямо ограничение = повече стабилност, но по-голямо пренасяне на натоварването към границите кост-имплант и по-ранно разхлабване. Изборът на степен на ограничение е едно от основните решения при ревизионната артропластика, балансиран спрямо мекотъканната обвивка и изискванията на пациента.</p>
</aside>
...
<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/ortho-30/tha-xray.jpg" data-figure-alt="Тотална артропластика на тазобедрената става" aria-label="Увеличи">
    <img src="/img/ortho-30/tha-xray.jpg" alt="Тотална артропластика на тазобедрената става" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Стандартни цели за ориентация на ацетабуларната чаша: 40° абдукция, 15-20° антеверзия. Размерът на феморалната глава е компромис: малките глави имат по-ниско износване, но по-висок риск от луксация; големите глави обратно (особено при метал-полиетилен).</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Анатомичната тотална артропластика на рамото изисква интактен ротаторен маншон. Реверзната ТА на рамото инвертира геометрията (топка на гленоида, гнездо на хумеруса), премества центъра на ротация медиално и дистално и привлича M. DELTOIDEUS като елеватор, процедурата на избор при артропатия от разкъсване на маншона и при масивни неподлежащи на реконструкция разкъсвания с псевдопарализа.</p>
</aside>
...
Оперативният достъп до ставата се избира за осигуряване на адекватна експозиция за поставяне на имплантата при минимизиране на увреждането на важни мекотъканни структури. Основните достъпи са разгледани в специфичните глави; общите принципи включват: използването на мускулно-щадящи достъпи при възможност (медиален парапателарен достъп при колянната става, директен преден достъп при тазобедрената става); внимателна защита на нервите и съдовете; прецизно капсулно и мекотъканно управление за следоперативна стабилност; и използването на разширяеми достъпи (способни да се разширят при комплексни или ревизионни случаи) при трудни ситуации.
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Основни стълбове на съвременния ERAS: регионална анестезия (спинална/епидурална) намалява тромбоемболичния риск и кръвозагубата; транексамова киселина (венозно, локално или и двете) е стандарт; цефазолин в рамките на 60 минути от разреза (ванкомицин при MRSA-носители), профилактиката завършва в деня на операцията; мобилизирайте пациента в деня на операцията.</p>
</aside>
...
инфекция, разхлабване, нестабилност, перипротезна фрактура или усложнения, свързани с износването. Техническите изисквания са значително по-високи от тези при първичната артропластика, с управление на костни дефекти (класификация Paprosky при тазобедрената става, класификация AORI при колянната), използване на ревизионни компоненти с добавки и стебла, избор на носещи повърхности, подходящи за ревизионното условие, и управление на инфекцията при наличие. Обемът на ревизионната артропластика нараства в световен мащаб с нарастването на честотата на първичната артропластика и увеличаването на продължителността на живот на пациентите с първични имплантати до степен, изискваща ревизия.
...
Артропластиката на ставите преди Charnley (1961) е била опитвана чрез резекционна артропластика (Whitman, Girdlestone), интерпозиционна артропластика (Murphy 1905, Putti 1921) и mould артропластика (Smith-Petersen 1939). *Lehrbuch* на Хофа (1905) каталогизира състоянието на изкуството в края на XIX век, когато артродезата остава доминиращата операция при разрушената става.

- **Хофа** (1905): *Lehrbuch der orthopädischen Chirurgie* — резекции на стави, артропластика. · [Факсимиле](https://archive.org/details/lehrbuchderortho00hoff)
- **Langenbeck-Archiv** — оригинални статии за артропластика (Hueter, Helferich, Murphy). · [Факсимиле (серия)](https://archive.org/details/archivfrklinisc11unkngoog)
- **Билрот** (1882): *Allgemeine chirurgische Pathologie und Therapie* — хирургична патология на ставата. · [Факсимиле](https://archive.org/details/dieallgemeinechi1882bill)
