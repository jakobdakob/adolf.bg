...
<aside class="callout callout-pitfall">
  ...
  <p>Хроничният остеомиелит не може да бъде излекуван само с антибиотици, тъй като секвестърът е аваскуларен и недостъпен за системните средства. Дебридмирайте до кървяща кост (симптомът „Paprika“ е хирургичната крайна точка), овладейте мъртвото пространство, възстановете стабилността и продължете с насочена към микроорганизма терапия.</p>
</aside>
...
<aside class="callout callout-pearl">
  ...
  <p>Острият хематогенен остеомиелит в детската възраст е Staphylococcus aureus в 70-90% от случаите (все по-често MRSA), Kingella kingae на възраст 6 месеца до 4 години и Salmonella плюс S. aureus при сърповидноклетъчна анемия. Емпиричните схеми трябва да отразяват този триаж.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Нативните рентгенографии остават нормални през първите 7-10 дни на острия остеомиелит. МРТ показва оток на костния мозък в рамките на 1-3 дни и е образното изследване на избор; CRP е най-добрият единичен маркер за проследяване на отговора, тъй като пикът му е на 1-2-ия ден и спада най-бързо при ефективна терапия.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Хирургичният дренаж е задължителен при субпериостален абсцес, съпътстващ септичен артрит, недостатъчен клиничен отговор към подходящи антибиотици в рамките на 48-72 часа и установен хроничен остеомиелит със секвестър или инволукрум. Тазобедрената става при новороденото е специален случай: интраартикуларната метафиза позволява хематогенният остеомиелит да пробие директно в ставата.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Cierny-Mader има две оси: анатомичен тип (1 медуларен, 2 повърхностен, 3 локализиран пълнодебелинен със стабилна кост, 4 дифузен с нестабилност) и клас гостоприемник (A нормален, B компрометиран системно или локално, C лечението е по-увреждащо от болестта). Комбинираният етикет определя избора между ограничен дебридман, етапна реконструкция и ампутация.</p>
</aside>
...
Туберкулозата на колянната става съставлява около 10% от остеоартикуларната туберкулоза и се изявява с прогресираща моноартикуларна болка, оток, ограничено движение и често позиционен флексионен деформитет.

<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Триадата на Phemister при туберкулозен артрит е юкстаартикуларна остеопения, периферни костни ерозии и постепенно стесняване на ставната цепка. Стандартната противотуберкулозна терапия е 2 месеца RIPE (рифампицин, изониазид, пиразинамид, етамбутол) плюс 7-10 месеца рифампицин и изониазид, общо 9-12 месеца, по-дълго при мултирезистентно заболяване.</p>
</aside> Рентгенографиите показват класическата триада на Phemister — юкстаартикуларна остеопения, периферни костни ерозии и постепенно стесняване на ставната цепка. Лечението съчетава противотуберкулозна химиотерапия и синовектомия при активно заболяване; артродезата или ендопротезирането адресират крайностадийната ставна деструкция.
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Болка, непропорционална на видимите кожни находки, с бърза системна токсичност, е некротизиращ фасциит до доказване на противното. Скорът LRINEC подкрепя подозрението, но не отлага операцията; незабавният агресивен дебридман плюс клиндамицин (подтискане на токсина) с широко покритие (пеницилин, средство срещу MRSA, Грам-отрицателно покритие) е единствената интервенция, която надеждно повлиява смъртността.</p>
</aside>

## Източници и класическа литература

Модерното лечение на костната инфекция почива на антисептичния принцип на Листър (1867, *BMJ*), въведен в костната хирургия чрез Lucas-Championnière във Франция (1876) и Есмарх в Германия (1877). Билрот (1882) предоставя хистопатологичната рамка за хроничния остеомиелит. Преди антисептичната ера ампутацията е била стандарт за установения остеомиелит; след нея секвестректомията и saucerization (Orr, Trueta) стават осъществими.

- **Листър** (1867): *On the Antiseptic Principle in the Practice of Surgery*, BMJ — основополагащата доктрина. · [Факсимиле (BMJ архив)](https://archive.org/details/b22282890)
- **Lucas-Championnière** (1876): *Chirurgie antiseptique* — френското възприемане на Листър. · [Факсимиле](https://archive.org/details/chirurgieantisep00luca)
- **Есмарх** (1877): *Handbuch der kriegschirurgischen Technik* — антисептично лечение на раните във военна обстановка. · [Факсимиле](https://archive.org/details/b28065906)
