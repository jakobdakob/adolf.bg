...
<aside class="callout callout-pearl">
  ...
  <p>Два анатомични капана при неонаталната тазобедрена става: проксималната бедрена метафиза е интракапсуларна, така че метафизарният остеомиелит пробива директно в ставата, а главата се храни от вътрехрущялни съдове, преминаващи през неосифицираната епифиза. Септичното вътреставно налягане тромбозира тези съдове и води до аваскуларна некроза в рамките на дни.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Покритието при неонатален ставен сепсис трябва да включва стрептокок от група B и Грам-отрицателни ентерални микроорганизми освен Staphylococcus aureus; при недоносени на широкоспектърни антибиотици или с централни катетри се добавя Candida. Вертикално предадена Neisseria gonorrhoeae с двустранен артрит на коленете или китките и кожни пустули е сентинелен признак на неразпозната майчина инфекция.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Неонаталният септичен артрит се крие зад неспецифичен сепсис (температура, раздразнителност, лошо хранене, летаргия, жълтеница). Псевдопарализата (кърмачето държи крайника неподвижен и оказва съпротива при пасивно движение, но не плаче при директна палпация на диафизата) е критичният локален признак и налага незабавна оценка на ставата.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Ехографията е образното изследване на избор за неонаталната тазобедрена става: портативна, без облъчване и надеждно показва излива. Нативните рентгенографии могат да разкрият високостоящ латерално разместен проксимален фемур (признакът на Tom Smith за капсулна дистензия).</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Самостоятелната аспирация е недостатъчна за дълбоките неонатални тазобедрена и раменна стави: дебелата прилепнала синовия не позволява пълно евакуиране. Стандарт е откритата артротомия (преден достъп по Smith-Petersen за тазобедрената става) или артроскопският дренаж, с парентерално широко покритие, стеснено според посявката и продължено общо 3-4 седмици.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Артритът на Tom Smith е късната последица от неразпознатия неонатален сепсис на тазобедрената става: аваскуларна некроза с колапс, хронична луксация или резорбция на главата, преждевременно затваряне на растежната зона, coxa magna/breva/vara и скъсяване на крайника. Изходът се определя почти изцяло от скоростта на първоначалното разпознаване и дренаж.</p>
</aside>
...
Kocher остават най-широко цитираният инструмент за клинично решение. Добавянето на CRP над 2 mg/dL е предложено като пети критерий в някои уточнения и е особено полезен единичен предиктор — стойност на CRP под 1 mg/dL е показала висока негативна предсказателна стойност за септичен артрит.

<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Критерии на Kocher за тазобедрената става: отказ от натоварване, температура >38,5 °C, СУЕ >40 mm/h, левкоцити >12 000/mm³, с вероятности за истински сепсис около 3%, 40%, 93% и 99% при един до четири критерия. CRP <1 mg/dL има висока негативна предсказателна стойност, а CRP >2 mg/dL е валидираният пети предиктор.</p>
</aside> Модификацията на Caird добавя повишен CRP, а няколко други групи предложиха алтернативни алгоритми, включващи ехографски находки.
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Синовиалната течност решава сивата зона: септичният артрит е типично >50 000 левкоцити/mm³ (често >100 000) с >75% полиморфонуклеари и понижена глюкоза; транзиторният синовит е <25 000/mm³ със смесен модел и стерилна посявка. Аспирирайте при изпълнени два или три критерия на Kocher.</p>
</aside> Аспирацията се извършва под ехографски контрол при подходяща аналгезия или седация.
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Транзиторният синовит отзвучава за 7-10 дни с покой, НСПВС и наблюдение. Неподобрение след една седмица или рецидив налага преоценка за септичен артрит, Perthes, ЮИА, левкемия или друга патология — никога не преетикетирайте просто като персистиращ синовит.</p>
</aside>
...
*Lehrbuch der orthopädischen Chirurgie* на Хофа (1905) обобщава европейския опит от края на XIX век относно ювенилната патология на тазобедрената става, включително разграничаването на септичния артрит от coxitis tuberculosa и от това, което по-късно стана известно като преходен синовит. Разграничението преди критериите на Kocher почива на клиничните описания на Хофа.

- **Хофа** (1905): *Lehrbuch der orthopädischen Chirurgie*. · [Факсимиле](https://archive.org/details/lehrbuchderortho00hoff)
- **Билрот** (1882): *Allgemeine chirurgische Pathologie und Therapie* — ставни инфекции. · [Факсимиле](https://archive.org/details/dieallgemeinechi1882bill)
