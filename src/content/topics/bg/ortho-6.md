...
<aside class="callout callout-pearl">
  ...
  <p>PFFD съществува едновременно с фибуларна хемимелия в 60-80% от случаите, плюс контралатерална дисплазия на тазобедрената става или coxa vara и отсъстващи или скъсени кръстни връзки. Винаги оценявайте целия крайник, а не само фемура.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Класове A и B по Aitken запазват бедрената глава в ацетабулум (B няма костна връзка с диафизата) и са кандидати за реконструкция на тазобедрената става; клас C има отсъстваща/рудиментарна глава с диспластичен ацетабулум, а клас D — отсъстващи и глава, и ацетабулум. C и D не могат да бъдат реконструирани в стабилна тазобедрена става и зависят от протезата за стабилност.</p>
</aside>
...
Артродеза на коляното и ротационна пластика по Van Nes. При дефицити от клас C и D, при които удължаването на крайника не е възможно, ротационната пластика по Van Nes предлага функционална алтернатива: крайникът се скъсява, коляното се артродезира, ходилото се ротира на 180° по надлъжната ос на тибията, така че глезенната става да служи като функционално коляно, и пациентът се снабдява с подколянна протеза, която се съчленява с ротираното ходило. Процедурата запазва активна става (глезена/сега-коляно) с проприоцепция и активен контрол от собствените мускули на пациента, а функционалните резултати са значително по-добри от тези на ампутация на еквивалентно ниво.

<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Ротационната пластика по Van Nes при Aitken C/D артродезира коляното и ротира ходилото на 180°, така че глезенът да стане функционално коляно, запазвайки активен проприоцептивен контрол чрез собствените мускули на пациента. Козметичният вид първоначално е стряскащ, затова предоперативното консултиране на семейството е задължително.</p>
</aside> Козметичният вид (ходило, сочещо назад на нивото на контралатералното коляно) е първоначално стряскащ за семействата и внимателното предоперативно консултиране е задължително.
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Фибуларната хемимелия е най-честият дефицит на дълга кост. Принципът на Birch поставя функцията на ходилото пред външния му вид: три или повече лъча по правило подкрепят съхранение с удължаване и реконструкция; по-малко от три лъча подкрепят ранна ампутация по Syme (или Boyd) с протеза.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Тибиалната хемимелия е рядка и често фамилна (автозомно-доминантна). Тип I по Jones няма функционално коляно и се лекува с дезартикулация на коляното; фибуларната централизация на Brown при типове II/III има разочароващи дългосрочни резултати, тъй като централизираната фибула не понася тегло, затова често се предпочита подколянна ампутация.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Антеролатералната извивка на тибията в кърмаческа възраст е предшественик на вродената псевдоартроза (CPT), а около половината от случаите на CPT носят NF1. Ортезирайте извитата, но нефрактурирана тибия за предотвратяване на първоначалната фрактура и търсете петна café-au-lait, аксиларни или ингвинални лунички, неврофиброми и нодули на Lisch.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Не бъркайте антеролатералната с постеромедиалната извивка. Постеромедиалната извивка е доброкачествена, отзвучава спонтанно, няма връзка с NF1 и оставя само предвидима разлика в дължината на крайниците. Антеролатералната извивка е префрактурният стадий на CPT и налага ортезиране и NF1 обработка.</p>
</aside>
...
Хофа (1905) дава първия ортопедично-класически синтез на вродените дефицити на долния крайник. Модерната класификация на Aitken (1969) и тази на Paley (1998) за проксималния феморален фокален дефицит стоят върху описателната традиция, която Хофа обобщава.

- **Хофа** (1905): *Lehrbuch der orthopädischen Chirurgie*. · [Факсимиле](https://archive.org/details/lehrbuchderortho00hoff)
- **Лоренц** (1895): *Pathologie und Therapie der angeborenen Hüftverrenkung* — патологична анатомия на проксималния фемур. · [Факсимиле](https://archive.org/details/b21290441)
