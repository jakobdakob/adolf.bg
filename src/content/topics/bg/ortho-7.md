...
<aside class="callout callout-pearl">
  ...
  <p>Стак от рискови фактори за ВДТС: женски пол, седалищно предлежание (най-силният средови фактор, особено чисто седалищно предлежание късно в бременността), положителна фамилна анамнеза, първородено, олигохидрамниос и други „опаковъчни“ нарушения (тортиколис, metatarsus adductus). Лявата тазобедрена става е засегната в около 60% от случаите.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Запомнете петте класически пречки пред закритата репозиция при ВДТС: инвертиран лабрум, хипертрофиран pulvinar, контрахирано сухожилие на iliopsoas с „пясъчникова“ деформация на капсулата, контрахиран напречен ацетабуларен лигамент и контрактура на капсулата. Откритата репозиция трябва да освободи всяка от тях.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Ortolani репозиционира луксирана става (абдукция + повдигане); Barlow луксира редуцируема става (аддукция + натиск). Тупването е диагностичният признак; щракванията са чести и безобидни. И двата признака се негативират след около 3 месеца с настъпване на вторични промени, когато на преден план излизат ограничена абдукция (асиметрия), скъсяване по Galeazzi и положителен тест на Klisic.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Класификацията на Graf се основава на алфа-ъгъла (костен покрив): тип I >=60° е зрял; тип II е 43-59° с подтипове (IIa физиологично незрял <3 месеца, IIb забавено съзряване >3 месеца, IIc критична зона, IId децентриран); тип III е луксиран с евертиран, но недеформиран лабрум; тип IV е луксиран с инвертиран, деформиран лабрум. Лечение започва от IIa-минус или IIc.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Граници при шината на Pavlik, които трябва да се запомнят: флексия 90-110° (>120° крие риск от пареза на феморалния нерв), абдукция не над 60° (крайна абдукция притиска медиалната феморална циркумфлексна артерия и води до АВН). Ако шината не е репозиционирала ставата в рамките на 3-4 седмици, се отказва; продължаването води до „болест на шината на Pavlik“ (АВН, задна луксация, пареза на феморалния нерв).</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>След закрита репозиция потвърдете концентричност с артрография: медиален контрастен басейн <5 mm е допустим, >5 mm налага открита репозиция. Безопасната зона на Ramsey е дъгата на абдукция, в която ставата остава редуцирана; под 25° от пълна абдукция е неадекватна и предсказва релуксация.</p>
</aside>
...
<aside class="callout callout-historical">
  <span class="callout-label">Класически глас — Хофа 1905, „кървавата репозиция"</span>
  <blockquote lang="de">
  ...
  <p><strong>Превод (BG):</strong> „Този постигнат резултат преследва безкръвната репозиция на луксираното тазобедрено стави. Френските ортопеди бяха първите, които наистина се опитаха да върнат бедрената глава в напусната ямка. … Остава да отбележа, че методът на кървавата репозиция на вродената луксация на тазобедрената става беше успешно практикуван не само от Лоренц и мен, но и от много други хирурзи."</p>
  <p class="callout-source">— Albert Hoffa, <em>Lehrbuch der orthopädischen Chirurgie</em>, 4. Aufl. (Stuttgart: Enke, 1905), стр. 565 и 595 (главата „Die operative Behandlung der angeborenen Hüftverrenkung"). <a href="https://archive.org/details/lehrbuchderortho00hoff" target="_blank" rel="noopener noreferrer">Факсимиле в Internet Archive →</a></p>
</aside>
...
<aside class="callout callout-historical">
  ...
  <p><strong>Превод (BG):</strong> „С първата си публикация за оперативната терапия на вродената луксация на тазобедрената става (Centralbl. f. Chir. 1892, 31) уви се поддадох на широко разпространения порок да правя предварително съобщение въз основа на малък брой и недостатъчно проследени случаи. … Поех си задължението да не обобщавам опита си, преди методът ми да е изпробван поне сто пъти. По-бързо, отколкото смеех да се надявам, това се сбъдна — изпълних метода почти сто и петдесет пъти."</p>
  <p class="callout-source">— Adolf Lorenz, <em>Pathologie und Therapie der angeborenen Hüftverrenkung</em> (Wien: Hölder, 1895), Vorwort, стр. V. Безкръвната репозиция („repositio cruenta") е била публикувана от Лоренц в окончателен вид през 1900 г.; настоящата монография от 1895 г. полага анатомо-патологичните основи. <a href="https://archive.org/details/b21290441" target="_blank" rel="noopener noreferrer">Факсимиле в Internet Archive →</a></p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Изборът на тазова остеотомия зависи от трирадиарния хрущял и морфологията на дисплазията: Salter (един разрез, пренасочваща) при 18 месеца до 6 години; Pemberton (непълна, около трирадиарния хрущял) за по-стръмно покритие; Dega при заден дефицит в нервно-мускулни тазобедрени стави; тройна (Steel/Tönnis) или периацетабуларна Ganz (ПАО) след затваряне на трирадиарния хрущял. ПАО е съвременният стандарт при юноши и възрастни с концентрична, конгруентна дисплатична става.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Ятрогенната АВН на бедрената глава е основното усложнение при лечението на ВДТС, класифицирано I-IV по Kalamchi-MacEwen (преходни промени, латерално физарно увреждане с валгус, централно физарно спиране с кратка шийка и трохантерен превес, пълно физарно спиране). Избягвайте „жаблата“ позиция и всяка крайна абдукция при гипс или шина.</p>
</aside>
...
Оперативната ера на ВДТС започва в края на ХIХ век с две германоезични школи, чиято дискусия — кървава срещу безкръвна репозиция — оформя ортопедичното лечение на тазобедрената става за следващото столетие. Алберт Хофа (Würzburg, по-късно Берлин) описва **кървавата репозиция** през 1890 г.: открит достъп до луксираната глава, отстраняване на пречките пред репозицията и реконструкция на покрива; неговият *Lehrbuch der orthopädischen Chirurgie* (4. изд. 1905 г.) систематизира техниката и нейните петте класически пречки, които и днес определят откритата процедура. Адолф Лоренц (Виена), по поток ученик на Алберт, противопоставя на Хофа **безкръвната репозиция** („repositio cruenta", окончателна публикация 1900): затворена редукция под анестезия с дълга гипсова имобилизация. Монографията на Лоренц от 1895 г. полага анатомо-патологичните основи; шинирането и физиоложкото развитие на тазобедрената става в първите месеци (по-късното откритие на Pavlik 1944) е концептуално трета фаза, която обединява двата подхода на Хофа и Лоренц чрез ранна корекция преди формирането на вторичните промени. Карл Лудлоф (1908, Zentralbl. f. Chir.) описва медиалния достъп, който остава техниката на избор при по-малкото кърмаче.

- **Хофа** (1905): *Lehrbuch der orthopädischen Chirurgie*, 4. изд. (Stuttgart: Enke). Глава за вродената луксация — кървавата репозиция и петте класически пречки. · [Факсимиле](https://archive.org/details/lehrbuchderortho00hoff)
- **Лоренц** (1895): *Pathologie und Therapie der angeborenen Hüftverrenkung* (Wien: Hölder). Анатомо-патологичната основа на безкръвната репозиция. · [Факсимиле](https://archive.org/details/b21290441)
- **Langenbeck-Archiv** (от 1860): първоописанията на Хютер за анатомичния преден достъп и на много други еспоними от XIX век. · [Поредица в Internet Archive](https://archive.org/details/archivfrklinisc11unkngoog)
