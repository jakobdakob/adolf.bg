...
<aside class="callout callout-pearl">
  ...
  <p>Четирите класически остеопоротични фрактури са дисталният радиус, проксималният хумерус, тялото на прешлена и тазобедрената става. Тазобедрената фрактура при възрастни носи едногодишна смъртност 20-30%, отразяваща както костното увреждане, така и общата отпадналост на пациента.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Костта е анизотропна (около два пъти по-якостна в компресия, отколкото при разтегляне) и вискоеластична (по-крехка при висока скорост на деформация). Модулът на Young на кортикалната кост е около 15-20 GPa, между металите и сухожилията. Високоенергийните травми пораждат по-разтрошени, енергийно богати модели.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Кинетичната енергия следва E = (1/2)mv², така че скоростта доминира. Високоскоростна огнестрелна рана нанася значително повече енергия от тази на пистолет и поражда меко-тъканно увреждане далеч извън видимата ранева пътека; лекувайте кавитацията, а не входния отвор.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Две меко-тъканни класификации направляват травматологичните решения: Gustilo-Anderson степенува откритите фрактури I, II, IIIA, IIIB (нуждаещи се от клап), IIIC (със съдово увреждане) и предвижда инфекция. Tscherne степенува меките тъкани при закрити наранявания 0-III и насочва момента на дефинитивна фиксация, като степен III често налага стадийно лечение.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Единична рентгенова проекция може да скрие съществена деформация в перпендикулярната равнина. Винаги правете две ортогонални проекции и включвайте ставите над и под фрактурата, иначе еквивалент на Monteggia или Galeazzi (радио-улнарна луксация при фрактура на диафизата) лесно се пропуска.</p>
</aside>
...
Третичното обследване (комплексен системен преглед на пациента с травма 24-72 часа след постъпването) е критична концепция в грижата за травмирания. Принципът е, че наранявания могат да бъдат пропуснати в хаоса на началната травматологична реанимация, а умишленото системно преразглеждане след стабилизиране на пациента идентифицира тези пропуснати наранявания. Третичното обследване включва преглед от глава до пети, преглед на цялата образна документация и обсъждане на нови симптоми. Пропуснатите ортопедични наранявания (фрактури на ребрата, ръката, ходилото, прешлените) са особено чести находки при третичното обследване.

<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Третичното обследване 24-72 часа след постъпването е създадено да хваща пропуснати в хаоса на реанимацията наранявания. Класически пропуснати са ребрените, ръчните, ходилните и прешленните фрактури, така че прегледайте отново пациента от глава до пети, след като се стабилизира.</p>
</aside>
...
Първият цялостен опит за рационална класификация на фрактурите е *Traité des fractures et des luxations* на Малгань (Hôtel-Dieu, Париж, 1847). Малгань предлага класификацията да се основава едновременно на локализация, посока на счупването и механичната причина — родово предшестваща AO-системата (Müller 1958, 1969) с повече от век. Дюпюитрен (1832) предхожда Малгань с първата голяма клинична серия от фрактури от Hôtel-Dieu, систематизирана по локализация. Lexer (1904), Bier–Braun–Kümmell (1920) и Esmarch (1877) представят немско-австрийската оперативна школа на прехода към XX век.

- **Малгань** (1847): *Traité des fractures et des luxations*, том 1 (Paris: Baillière). Първата систематична фрактурна класификация. · [Факсимиле (BIU Santé)](https://archive.org/details/BIUSante_32985x01)
- **Дюпюитрен** (1832): *Leçons orales de clinique chirurgicale*, том 1 (Paris: Baillière). Голяма клинична серия от Hôtel-Dieu. · [Факсимиле](https://archive.org/details/leonsoralesdec01dupu)
- **Бир / Браун / Кюммел** (1920): *Chirurgische Operationslehre*, том 1 — общата хирургия на фрактурите. · [Факсимиле](https://archive.org/details/chirurgischeoperationslehre1920v1)
