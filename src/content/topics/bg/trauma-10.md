...
<aside class="callout callout-pearl">
  ...
  <p>Изключвайте шийния гръбнак клинично само при буден, прегледаем, асимптоматичен пациент по NEXUS или Canadian C-Spine Rule; по канадското правило активна ротация на шията на 45° в двете посоки позволява сваляне на яката. КТ заменя обзорните рентгенографии при възрастни, неминаващи клиничното изключване, а МРТ е запазена за неврологичен дефицит, съмнение за дискосвързочно увреждане или персистиращо съмнение при пациент с потиснато съзнание.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Тип III по Anderson-Montesano на occipital condyle е авулзия от lig. alare при ротационно-дистракционен механизъм и е нестабилният вариант, изискващ окципитоцервикална артродеза. Тип I (раздробяване при аксиално натоварване) и повечето тип II (продължение на основочерепна фрактура) са стабилни в твърда яка за 6-12 седмици.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Атланто-окципиталната дисоциация почти винаги се пропуска без измервания. Индексът на Powers над 1,0 е суспектен за предна дисоциация, но е нечувствителен; basion-dens interval и basion-axial interval (норма под 12 mm на КТ) са по-надеждни. МРТ потвърждава руптурата на membrana tectoria и lig. alare. Лечението е окципитоцервикална артродеза в halo до дефинитивната стабилизация.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Стабилността на фрактурата на Jefferson зависи от lig. transversum atlantis. Правилото на Spence: сумарно странично изместване на латералните маси на C1 над 7 mm на открито-устна рентгенография означава руптура на LTA и нестабилна травма. Dickman тип I (интралигаментарен) налага артродеза; Dickman тип II (костна авулзия) може да зарасне в твърда яка.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Фрактурите тип II по Anderson-D'Alonzo на зъба имат 30-50% псевдоартроза при консервативно лечение поради лошото кръвоснабдяване на основата на зъба. Рисковите фактори са възраст над 50 г., изместване над 5 mm, ъглова деформация над 10° и задно изместване. Hangman тип IIA се лекува в halo без тракция, тъй като тракцията влошава деформацията.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Хиперекстензионната травма B3 при анкилозиращ спондилит или DISH изглежда дискретна на рентгенографията, но е дълбоко нестабилна. Такива пациенти често се диагностицират погрешно и се влошават при мобилизация, така че всяка болка или падане при привидно сраснал гръбнак налага КТ и висок индекс на подозрение за предна руптура на напрегнатата зона.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>TLICS оценява морфология (1 компресия, 2 burst, 3 транслация/ротация, 4 дистракция), неврология (0 интактна до 3 непълно увреждане/cauda equina) и заден лигаментарен комплекс (0 интактен, 2 неопределен, 3 разрушен). Общ резултат до 3 е консервативно лечение, от 5 нагоре — оперативно, а 4 е сива зона. Интегритетът на ЗЛК, най-добре оценен на МРТ, е решаващият фактор при burst-фрактурата.</p>
</aside>
...
*Chirurgische Behandlung von Hirnkrankheiten* на Бергман (1889) дава основополагащата доктрина на кранио-спиналната травматична хирургия, включително главите за вертебрални фрактури без увреда на гръбначния мозък. *Œuvres* на Paré (изд. Malgaigne 1840) запазва Ренесансовите описания; Chauliac (1363) средновековните. Модерната AO Spine класификация (Magerl 1994, AOSpine 2013) е потомка.

- **Бергман** (1889): *Die chirurgische Behandlung von Hirnkrankheiten*. · [Факсимиле](https://archive.org/details/diechirurgische00berggoog)
- **Paré** (изд. Malgaigne 1840): *Œuvres complètes*, том 3 — гръбначен стълб и торс. · [Факсимиле](https://archive.org/details/oeuvrescomplte03par)
- **Chauliac** (1363): *Chirurgia magna* — средновековна спинална хирургия. · [Факсимиле](https://archive.org/details/chirurgiamagnagu00guyd)
