...
<aside class="callout callout-historical">
  ...
  <p><strong>Превод (BG):</strong> „След като начинът на репозиция беше намерен, оставаше да се изведе превръзка, която да осигурява контакта на фрагментите. Дезо смяташе, че в една и съща процедура може да се обединят двете стъпки на лечението — едновременно да се намести и да се поддържа фрактурата наместена. Тук изкуството му дължи напредък, осмелявам се да кажа, близък до съвършенството."</p>
  <p class="callout-source">— Pierre-Joseph Desault, <em>Œuvres chirurgicales</em>, том 1 (Paris: an VI / 1798), стр. 68 от главата за фрактурите на ключицата. Принципът на превръзката на Дезо — възглавничка в подмишничната ямка, лента, която придърпва лакътя назад, и втора, която фиксира ръката към тялото — задава трите едновременни вектора, които и днес определят нехирургичното лечение и до голяма степен дизайна на съвременните рамо-имобилизатори. <a href="https://archive.org/details/BIUSante_30626x01" target="_blank" rel="noopener noreferrer">Факсимиле в Internet Archive →</a></p>
</aside>

## Диафизарни фрактури

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/trauma-11/clavicle-plate.jpg" data-figure-alt="Постоперативна рентгенография след плакова остеосинтеза на ключицата" aria-label="Увеличи">
    <img src="/img/trauma-11/clavicle-plate.jpg" alt="Постоперативна рентгенография след плакова остеосинтеза на ключицата" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Проучването COTS 2007 преобърна десетилетия на ортодоксия, показвайки 15% псевдоартроза при напълно изместени диафизарни фрактури на консервативно лечение срещу 2% при ОРВФ. Рискови фактори за псевдоартроза: изместване над 100% (без кортикален контакт), раздробеност (Z-образна), скъсяване над 1,5-2 cm, женски пол, тютюнопушене, напреднала възраст.</p>
</aside>

## Фрактури на латералния край

Фрактурите на латералния край поставят специфични предизвикателства. Типовете IIA, IIB и V по Neer, свързани с КК-връзките, имат висока честота на псевдоартроза при консервативно лечение (достигаща 30%), тъй като медиалният фрагмент е лишен от лигаментарна опора и се измества супериорно под действието на трапециуса. Оперативните варианти включват кукообразна плака (куката се позиционира под акромиона, ефективна, но с известен профил на усложнения, включително субакромиален импинджмънт и стрес-фрактура на акромиона), анатомични ключалъчни плаки със или без реконструкция на КК-връзките и артроскопски асистирана реконструкция на КК-връзките с устройства от типа TightRope при избрани случаи. Типове I, III и IV по Neer обикновено се лекуват консервативно.
...
<aside class="callout callout-pitfall">
  ...
  <p>Не бъркайте физарна лезия на медиалната ключица със стерноклавикуларна дислокация при млад възрастен. Физата на медиалната ключица е последната в тялото, която зараства (около 23-25 г.), затова привидните СК-дислокации в тази възрастова група обикновено са Salter-Harris-подобни физарни сепарации, които заздравяват надеждно без операция.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>АК-травмите по Rockwood в едно изречение: I-II — консервативни, III — в сивата зона (предпочита се консервативен опит), IV (задно през трапециуса), V (>100-300% с руптура на делто-трапециалната фасция) и VI (под клювовидния израстък) — оперативни. Тип IV се определя от посоката на изместване (задна), а не от степента на супериорна транслация.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Задната стерноклавикуларна дислокация е хирургичен спешен случай, а не задача за затворена репозиция в спешното. Компресията на големите съдове, трахеята или хранопровода налага КТ-ангиография предварително и репозиция в операционна зала с кардиоторакален резерв, защото същите ретростернални съдове могат да бъдат увредени по време на самата репозиция.</p>
</aside>
...
Фрактурите на лопатката представляват под 1% от всички фрактури и около 3-5% от травмите на раменния пояс. Относителната защита на лопатката от заобикалящата я мускулатура и гръдния кош означава, че лопаточната фрактура сама по себе си е маркер на високоенергийна травма — съпътстващи увреждания (фрактури на ребра, белодробна контузия, черепно-мозъчна травма, гръбначна травма) са налице при 80-95% от пациентите с лопаточна фрактура, и ортопедичният хирург трябва да ги търси активно.

<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Лопаточната фрактура сама по себе си е маркер на високоенергийна травма — 80-95% от пациентите имат съпътстващи увреждания (ребрени фрактури, белодробна контузия, ЧМТ, гръбначна травма). Намерете лопаточната фрактура и след това търсете още по-целенасочено какво е ударило с достатъчна сила, за да я счупи.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Оперативни прагове при лопаточните фрактури: гленополарен ъгъл <20-22° (норма 30-45°), медиолатерално изместване >20 mm, ъглова деформация >40°, интраартикуларно стъпало на glenoid >5 mm и плаващото рамо (концепция на Goss за ГСКР — прекъсване в две точки от суспензорния пръстен). Иначе — превръзка и ранно движение.</p>
</aside>
...
Превръзката на Дезо (десоова превръзка) остава част от българската лекарска лексика през два века — еспоним, въведен от Дезо в Hôtel-Dieu в края на XVIII век, систематизиран в посмъртните *Œuvres chirurgicales* и докуменирано подобрен от Малгань в средата на XIX век. Велпо допринася с алтернатива в *Médecine opératoire* (1832) — превръзка „ръка на противоположното рамо", използвана и до днес при някои варианти на луксация на рамото. Малгань (1847) посвещава цяла глава на фрактурите на ключицата с критическа оценка на Дезоовата техника и въвеждане на коригиращи модификации.

- **Дезо** (1798): *Œuvres chirurgicales*, том 1 (Paris). Оригиналното описание на превръзката на Дезо за фрактура на ключицата. · [Факсимиле (BIU Santé)](https://archive.org/details/BIUSante_30626x01)
- **Велпо** (1832): *Nouveaux éléments de médecine opératoire*, том 1 (Paris). Алтернативни превръзки на раменния пояс. · [Факсимиле](https://archive.org/details/BIUSante_43901x01)
- **Малгань** (1847): *Traité des fractures et des luxations*, том 1, глава за ключицата — критика и модификация на превръзката на Дезо. · [Факсимиле](https://archive.org/details/BIUSante_32985x01)

## Обобщение и ключови изводи

Фрактурите на ключицата, лопатката и травмите на гръдната стена представляват колективно срещата на раменния пояс с високоенергийната травма. Ключицата най-често се фрактурира в диафизата, където класификацията на Robinson структурира лечението около изместването: напълно изместените, скъсените или раздробени фрактури при активни пациенти имат значителна честота на псевдоартроза при консервативно лечение и се ползват от фиксация с анатомична ключалъчна плака, докато неизместените или минимално изместените фрактури се лекуват в превръзка. Фрактурите на латералния край се подразделят по класификацията на Neer, като оперативна фиксация е показана за типовете IIA, IIB и V без КК-лигаментарна опора. АК-ставните увреждания се степенуват по класификацията на Rockwood, като типове I и II са консервативни, типове IV-VI — оперативни, а тип III е в сивата зона, където съвременната практика предпочита консервативен опит с оперативна фиксация, запазена за пациенти с високи функционални изисквания. СК-дислокациите са редки; задният вариант е опасен и изисква репозиция в операционна зала с кардиоторакален резерв поради близостта на медиастинума. Лопаточните фрактури, макар до голяма степен консервативни, изискват внимателна оценка за съпътстващи гръдни и черепномозъчни травми, като оперативните индикации са ограничени до специфични тежко изместени гленоидни, шийни или плаващо-раменни варианти. Травмите на гръдната стена изискват ортопедично внимание към стабилизация на ребрените фрактури при флейл гръдния кош при избрани пациенти.
