...
Класическият механизъм на предна луксация е принудително отвеждане и външна ротация, водещи до провал на долния гленохумерален лигаментарен комплекс с авулзия на антероинфериорния labrum от glenoid, лезия на Bankart, описана от A.S. Blundell Bankart в 1923 и 1938 г. Съпътстващите увреждания включват лезия на Hill-Sachs — импресионна фрактура на постеролатералната хумерална глава, получена при дислокацията на главата върху предния гленоиден ръб, описана от Hill и Sachs в 1940 г. — и костно ангажиране на предния гленоиден ръб (костна лезия на Bankart или, при значима костна загуба, водеща до форма на „обърната круша“ на glenoid, антероинфериорен дефект на гленоидния ръб).

<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Механизмът на предната луксация (принудително отвеждане + външна ротация) проваля долния гленохумерален лигаментарен комплекс — основният ограничител в това положение. Сигнатурната двойка: Bankart (антероинфериорна лабрална авулзия, Bankart 1923/1938) плюс Hill-Sachs (постеролатерална хумерална импресия, Hill и Sachs 1940).</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Двигателното тестиране на n. axillaris при остро дислоцирано рамо е ненадеждно поради болка — тествайте сетивността над латералния делтоид и документирайте състоянието преди и след репозицията. Пропуснатата невроваскуларна оценка преди манипулация е медико-правен капан.</p>
</aside>
...
<aside class="callout callout-historical">
  <span class="callout-label">Класически глас — Велпо 1832, превръзката на рамото</span>
  <p>Велпо описва в *Médecine opératoire* (1832) превръзката, която носи неговото име — ръката на засегнатата страна се поставя върху противоположното рамо, лакътят сочи напред-надолу, и серия от обиколки фиксира цялата конструкция към гръдния кош. Принципът — пълна имобилизация на ръката към тялото в позиция на максимална вътрешна ротация — е концептуално противоположен на по-късния Itoi-brace (външна ротация, 2007 г.) и още се използва при селективни луксации с напрегната задно-инфериорна капсула, при някои хумерални фрактури с нестабилен близък край и в педиатрията. Българската лекарска лексика е запазила формата „превръзка на Велпо".</p>
  <p>Аксиалната проекция за съмнение за луксация при пациент, неиздържащ стандартното отвеждане, се нарича <strong>проекция по Велпо</strong> — описана от него за същата конструкция на превръзката, при която ръката е фиксирана към гръдната стена.</p>
  <p class="callout-source">— Alfred Velpeau, <em>Nouveaux éléments de médecine opératoire</em>, том 1 (Paris: J.-B. Baillière, 1832). Превръзката е описана в главата за луксациите на горния крайник. <a href="https://archive.org/details/BIUSante_43901x01" target="_blank" rel="noopener noreferrer">Факсимиле в Internet Archive (BIU Santé) →</a></p>
</aside>

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/trauma-12/bankart-hillsachs.jpg" data-figure-alt="Лезия на Bankart и Hill-Sachs след предна луксация" aria-label="Увеличи">
    <img src="/img/trauma-12/bankart-hillsachs.jpg" alt="Лезия на Bankart и Hill-Sachs след предна луксация" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Рецидивът след първа предна луксация се определя от възрастта: под 20 г. — над 60% (80-90% при контактни спортисти и военнослужещи), над 40 г. — под 20%. Продължителността на имобилизацията има малко доказано влияние. Kirkley (2005) и Robinson (2006) показват, че ранната артроскопска реконструкция по Bankart при млади атлети намалява рецидива до 10-15% срещу 60-80% при консервативно лечение.</p>
</aside>

## Задна луксация

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/trauma-12/shoulder-dislocation.jpg" data-figure-alt="Луксация на рамото, AP проекция" aria-label="Увеличи">
    <img src="/img/trauma-12/shoulder-dislocation.jpg" alt="Луксация на рамото, AP проекция" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Задната луксация се пропуска при до половината от представянията. Класическите тригери са епилептичен припадък, електрошок и задно насочена сила; ръката е заключена в привеждане и вътрешна ротация с изразено ограничена външна ротация. AP-проекцията изглежда почти нормална — поискайте аксиларна проекция (или КТ) преди да повярвате на рентгеновите снимки.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Luxatio erecta е неизменно разпознаваема: ръката е фиксирана в 110-160° отвеждане с предмишница над главата. Невроваскуларните усложнения са далеч по-чести, отколкото при предна луксация (увреждане на n. axillaris ~60%, на a. axillaris ~3%), а повечето пациенти имат и съпътстваща руптура на ротаторния маншон.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Прагове за гленоидна костна загуба на en-face 3D КТ: под 13-15% — артроскопска Bankart самостоятелно; над 20-25% („критична костна загуба“ на Burkhart и De Beer, 2000) — костно допълване (Latarjet); 15-20% е „субкритичната“ зона на Shaha, в която костните процедури все по-често превъзхождат мекотъканните.</p>
</aside>
...
Навичната задна луксация — рядкото заболяване, при което пациентът доброволно дислоцира рамото задно чрез селективна мускулна контракция — изисква внимателна психологична оценка и обикновено се лекува с физиотерапия и поведенчески подходи. Историческата операция на Boyd-Sisk (трансфер на сухожилието на m. biceps brachii при навична задна нестабилност) в момента се извършва рядко.

<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Хирургията при доброволна или навична луксация при пациент с психогенни особености неизменно се проваля — стабилизацията в тази група има практически универсален неуспех. Лекувайте с физиотерапия, укрепване на ротаторния маншон и перискапуларната мускулатура (протокол на Rockwood) и психологична оценка; запазете оперативното лечение само за истинска структурна мултидирекционна нестабилност, неотговорила на поне 6 месеца целенасочена рехабилитация.</p>
</aside>

## Източници и класическа литература

Систематичната репозиция на раменната луксация се проследява назад до Гиподе Шольяк (XIV в.) и римските хирурзи; превръзката на Велпо (1832) остава еспонимно име и до днес — както в българската лекарска лексика, така и за съответната рентгенова проекция при пациент, неиздържащ отвеждане. Дюпюитрен в *Leçons orales* посвещава отделна лекция на луксациите на главата на хумеруса, а Малгань в *Traité des fractures et des luxations* (1847) събира тогавашната литература за раменните луксации с класическата критика на Кохеровия маньовър (още преди да получи името „Кохер" в 1870 г.).

- **Велпо** (1832): *Nouveaux éléments de médecine opératoire*, том 1 (Paris: Baillière). Превръзката на Велпо за раменна луксация. · [Факсимиле (BIU Santé)](https://archive.org/details/BIUSante_43901x01)
- **Дюпюитрен** (1832): *Leçons orales de clinique chirurgicale*, том 2 (Paris: Baillière), лекции за луксациите на горния крайник. · [Факсимиле](https://archive.org/details/leonsoralesdec02dupu)
- **Малгань** (1847): *Traité des fractures et des luxations*, том 2 (Paris: Baillière), главата за луксациите на рамото. · [Факсимиле](https://archive.org/details/BIUSante_32985x01)
