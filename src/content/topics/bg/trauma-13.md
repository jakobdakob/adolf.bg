...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Знайте кой мускул накъде влачи кой фрагмент: m. supraspinatus тегли голямото туберкулозно нагоре и назад, m. subscapularis дърпа малкото туберкулозно медиално, а неовладяният m. pectoralis major измества диафизата медиално след фрактура на хирургичната шийка. Тези деформиращи сили са целта на репозицията.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Класификацията на Neer (1970) се изгражда върху четирите фрагмента на Codman (глава, голямо туберкулозно, малко туберкулозно, диафиза); фрагментът е „сегмент“ само ако е разместен над 1 cm или ъглово отклонен над 45°. Inter-observer надеждността е слаба на обзорни рентгенографии (каппа 0,3-0,5), но се подобрява значително при систематично 3D КТ.</p>
</aside>
...
морфологията на фрактурата и изместването на туберкулозите. Фрактурите тип A са извънставни унифокални (засягащи едно от туберкулозите или самостоятелно хирургичната шийка); тип B са извънставни бифокални (двете туберкулозни или едно туберкулозно плюс хирургична шийка); тип C са ставни, включващи фрактури на анатомичната шийка и фрактури с разцепване на главата. Всеки тип е подразделен по изместване и сложност. Системата на AO/OTA е по-изчерпателна от тази на Neer, но се използва по-рядко в ежедневната практика; тя остава предпочитана система за научни цели.
...
<aside class="callout callout-pitfall">
  ...
  <p>N. axillaris обикаля около хирургичната шийка и е увреден при 10-30% от фрактурите на проксималния хумерус — винаги документирайте функцията му преди и след каквато и да е репозиция или операция. Увреждането на a. axillaris е рядко (<1%), но трябва активно да се обмисли при модели на фрактура-луксация.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Проучването PROFHER (Rangan 2015, 250 пациенти) не намира функционална разлика на две години между оперативно и консервативно лечение на разместени фрактури на проксималния хумерус при възрастните — единственият резултат, който най-значимо е пренасочил практиката към консервативно лечение. Дори варусна консолидация до 30° обикновено се понася функционално добре.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Съвременният праг за изместване на голямото туберкулозно е 5 mm (3 mm при спортисти с надглавно натоварване и тежки работници), а не историческите 1 cm на Neer. Супериорното изместване предизвиква субакромиален импинджмънт; задното стеснява аутлета на m. supraspinatus — и двете компрометират функцията при активния пациент.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Реконструкцията на медиалния calcar (често с наклонен calcar-винт) е единичният най-важен детерминант на стабилността на конструкцията с ключалъчна плака. Варусната малрепозиция и липсващата инферомедиална calcar-подпора са рецепта за изпадане на винтове и вторичен варусен колапс, особено при остеопоротична кост.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Реверзивната тотална раменна артропластика (дизайн на Grammont) възстановява активната флексия чрез лостовото действие на m. deltoideus, заобикаляйки нуждата от функциониращ ротаторен маншон и от срастване на туберкулозите — точно режима на провал на хемиартропластиката при възрастния с четирифрагментна фрактура. Типична следоперативна флексия 110-130°; външната ротация остава слабото място при несрасли туберкулози.</p>
</aside>
...
*Œuvres chirurgicales* на Pierre-Joseph Desault (1798) дава основополагащото описание на превръзката за фрактури на ключицата и проксималния хумерус, която и днес носи неговото име. Velpeau (1832) рафинира техниката в Velpeau-превръзката за имобилизация след репозиция на рамото. Малгень (1847) предоставя систематичния клиничен синтез на фрактурите на проксималния хумерус от серията на Hôtel-Dieu.

- **Desault** (1798): *Œuvres chirurgicales*, том 1 — Desault-превръзка. · [Факсимиле](https://archive.org/details/BIUSante_30626x01)
- **Velpeau** (1832): *Nouveaux éléments de médecine opératoire*, том 1. · [Факсимиле](https://archive.org/details/BIUSante_43901x01)
- **Малгень** (1847): *Traité des fractures et des luxations*, том 1 — проксимален хумерус. · [Факсимиле](https://archive.org/details/BIUSante_32985x01)
