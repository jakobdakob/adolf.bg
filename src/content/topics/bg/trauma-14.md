...
<aside class="callout callout-pearl">
  ...
  <p>Деформиращи сили по ниво на фрактурата: над m. pectoralis major — ротаторният маншон абдуцира и екстерно ротира проксималния фрагмент; между m. pectoralis и m. deltoideus — m. pectoralis аддуцира и медиализира проксималния фрагмент; под m. deltoideus — m. deltoideus абдуцира и проксимализира проксималния фрагмент. Стратегията на репозиция следва вектора на мускулните сили.</p>
</aside>

## Класификация

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/trauma-14/humerus-spiral.png" data-figure-alt="Спирална фрактура на хумерусния диафиз" aria-label="Увеличи">
    <img src="/img/trauma-14/humerus-spiral.png" alt="Спирална фрактура на хумерусния диафиз" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Фрактурата на Holstein-Lewis (1963) — спирално-коса на дисталната третина на хумерусния диафиз — е епонимният капан за n. radialis. Нервът преминава през septum intermusculare laterale и е фиксиран спрямо изместващия се дистален фрагмент, поставяйки го в особен риск.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Тествайте n. radialis специфично и документирайте функцията преди всяка манипулация: екстензия на китката и пръстите, абдукция на палеца (m. extensor pollicis longus) и сетивност в първото дорзално интерметакарпално пространство. Пареза, „забелязана“ едва след наслагване на шина, е медико-правно неразличима от такава, причинена от манипулацията.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Първичната пареза на n. radialis при затворена диафизарна хумерусна фрактура е предимно неврапраксия — 75-90% се възстановяват спонтанно, с първи признаци (моторни единици в m. brachioradialis, най-проксималния радиален мускул) към 3-4-та седмица. Наблюдавайте 4-6 месеца преди изследване. ВТОРИЧНАТА пареза след манипулация е изключение — изследвайте я бързо, защото нервът може да е захванат между фрагментите.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Допустимата позиция при Sarmiento-ортеза на хумеруса е забележително либерална: антериорно ъглово отклонение до 20°, варус до 30°, ротация 15-20°, скъсяване 2-3 cm. Ненатоварващата роля и мекотъканното маскиране обясняват толеранса. Класически степени на срастване 85-95%; съвременните проучвания (HUSTLE, FISH) сочат 15-25% псевдоартроза — проксимална третина, напречен модел и затлъстяване са основните рискови фактори.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Ятрогенното увреждане на n. radialis при задните плакови достъпи се съобщава при 5-15% — единичното най-опасявано усложнение. Нервът трябва изрично да бъде идентифициран в sulcus nervi radialis и защитен по цялото протежение на процедурата. „Извън погледа, извън съзнанието“ е рецепта за прерязване или тракционно увреждане.</p>
</aside>

## Интрамедуларно пироноване

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/trauma-14/esin-humerus.jpg" data-figure-alt="ESIN на хумерусна фрактура" aria-label="Увеличи">
    <img src="/img/trauma-14/esin-humerus.jpg" alt="ESIN на хумерусна фрактура" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Слабост на антеградното пироноване — рамото (увреждане на ротаторния маншон, субакромиален импинджмънт, n. axillaris при проксимално заключване); слабост на ретроградното — лакътят (скованост). Най-силното настоящо показание за пироноване е патологичната или застрашаваща патологична фрактура, при която пиронът защитава цялата дължина на костта.</p>
</aside>
...
Малгень (1847) събира ранно-XIX-вечния клиничен опит за фрактурите на диафизата на хумеруса, включително разпознаването на n. radialis като основното усложнение при мидшафтните фрактури. *Leçons orales* на Дюпюитрен (1832) съдържа основополагащите клинични наблюдения от Hôtel-Dieu. Функционалният брейс на Sarmiento (1977) затваря модерната консервативна глава.

- **Малгень** (1847): *Traité des fractures et des luxations*, том 1 — диафиза на хумеруса. · [Факсимиле](https://archive.org/details/BIUSante_32985x01)
- **Дюпюитрен** (1832): *Leçons orales de clinique chirurgicale*, том 2 — горен крайник. · [Факсимиле](https://archive.org/details/leonsoralesdec02dupu)

## Обобщение и ключови изводи

Диафизарните фрактури на хумеруса се характеризират с уникално благоприятна биология на заздравяване, като функционалната ортеза на Sarmiento остава крайъгълен камък на консервативното лечение в продължение на половин век. Историческите степени на срастване от 85 до 95% бяха оспорени от по-скорошни данни, предполагащи малко по-високи съвременни честоти на псевдоартроза, вероятно отразяващи промяната в пациентските популации и методологическата строгост в съвременните изпитания. Допустимата позиция е либерална — 20 градуса антериорно ъглово отклонение, 30 градуса варус, 15 до 20 градуса ротация, 2 до 3 cm скъсяване, и отразява ненатоварващата роля на костта.
