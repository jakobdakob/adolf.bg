...
<aside class="callout callout-pearl">
  ...
  <p>Lig. collaterale ulnare laterale (LCUL — O'Driscoll, Bell, Morrey 1991) е основният устой срещу постеролатерална ротационна нестабилност на лакъта. Признаването му трансформира лечението на комплексните наранявания; пропускането му е класическата причина лакътят да остане нестабилен след луксация.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Първичната тотална артропластика на лакъта при фрактура на дисталния хумерус е изборът при възрастния пациент с ниска функционална активност (над 65-70 г.) с тежко раздробен ставен модел (AO C2/C3) или предшестващ възпалителен артрит. Компромисът е доживотното ограничение за единичен товар 5 kg / 10 lb — което тази група обикновено приема лесно.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Двойна плакова остеосинтеза по O'Driscoll — всяка колона получава своя плака. Паралелната ориентация (двете колони сагитално) е биомеханично предпочитана в някои проучвания; перпендикулярната (постеролатерална + медиална под 90°) е алтернатива. Остеотомията на olecranon осигурява най-добра ставна видимост, но трябва да се избягва, ако е възможно превключване към ТАЛ.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Tension-band wiring по Weber работи само при напречни нераздробени фрактури на olecranon: два успоредни K-пирона плюс осмица-образна жица превръщат тензионната тяга на m. triceps в компресия при ставната повърхност по време на флексия. Използвайте предконтурирана ключалъчна плака при раздробени, фрактура-луксация или проксимално разпростиращи се модели — tension band ще се провали под срязващо натоварване.</p>
</aside>
...
Артропластиката на главата на радиуса използва модулни монолитни метални протези (титанови или от хром-кобалт) с различни дизайни.

<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Надмерното удължаване на протезата на главата на радиуса е най-честата техническа грешка: твърде висока глава поражда износване на capitellum, латерална болка и нарушено проследяване. Размер според медиалната повърхност на processus coronoideus (латералният ръб на coronoid е ориентир за височината), а не според резецираната глава, която нерядко е раздробена и ненадеждна.</p>
</aside> Критичните технически съображения включват избягването на надмерно удължаване (протеза на главата, твърде дълга, предизвиква износване на capitellum, латерална болка и проблеми с проследяването, хирургът преценява подходящия размер спрямо медиалната повърхност на processus coronoideus и латералното ниво на coronoid) и подходящото оразмеряване съответно на диаметъра на оригиналната глава.
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Никога не ексцидирайте главата на радиуса, когато тя е единственият останал стабилизатор — Essex-Lopresti (фрактура на главата на радиуса + руптура на membrana interossea + нарушение на DRUJ), terrible triad или MCL-некомпетентен лакът — всички изискват задържане или замяна. Ексцизията в тези ситуации поражда проксимална миграция на радиуса, улнар-позитивна дисперсия с болка в китката и valgus-нестабилност.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Антеромедиалната фрактура на processus coronoideus по O'Driscoll е тихият дестабилизатор — носи предния сноп на MCL и е ключовият устой срещу varus posteromedial rotatory instability. Дори 2-5 mm фрагменти може да се нуждаят от фиксация. Не се успокоявайте от „малък“ на рентгенографията; КТ и оценката на нестабилността са решаващи.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Terrible triad (Hotchkiss 1996) = луксация на лакъта + фрактура на главата на радиуса + фрактура на processus coronoideus. Съвременното лечение е систематична реконструкция от латерален достъп на всичките три компонента: глава на радиуса (репарация или замяна, никога ексцизия), processus coronoideus (винтове, шевен лассо или котви) и репарация на LCL. MCL се репарира само ако след латералната реконструкция персистира нестабилност.</p>
</aside>
...
<aside class="callout callout-historical">
  <span class="callout-label">Класически глас — Малгень 1847, фрактури на olecranon</span>
  <blockquote lang="fr">
  ...
  <p><strong>Превод (BG):</strong> „Най-честата причина е падане върху лакътя; от нашите 35 случая тази причина се установява в 27. … За да се случат, тези фрактури изискват определена степен на флексия на предмишницата, като последната е тласкана от външна сила, която се стреми да я флектира още повече, и на която се противопоставя трицепсът. По същия начин възникват и фрактурите на olecranon при някои репозиции, непредпазливо опитвани при стари луксации на лакъта. … Desault първи разграничи две разновидности — на върха и на основата; към които Boyer добави трета — на средната част на апофизата."</p>
  <p class="callout-source">— Joseph-François Malgaigne, <em>Traité des fractures et des luxations</em>, том 1 (Paris: Baillière, 1847), глава „Des fractures de l'olécrane", стр. 563 и следв. Механиката трицепс-съпротивление / форсирана флексия, която Малгень описва, е точно модерната tension-band физика зад Weber-овото wiring (1963): трицепсът превръща дислокацията на фрактурната линия в опъване, което K-телта плюс осмицата превръщат обратно в компресия. Триделната топография Desault/Boyer (връх, основа, среда) е прародителят на днешната Mayo-класификация по местоположение и стабилност. <a href="https://archive.org/details/BIUSante_32985x01" target="_blank" rel="noopener noreferrer">Факсимиле в Internet Archive →</a></p>
</aside>

## Източници и класическа литература

Класическите ортопедични описания на фрактурите на лакътя предхождат модерните Mason- и Mayo-класификации с повече от век. Серията на Малгень от 35 случая на olecranon-фрактури в Hôtel-Dieu (1847) вече артикулира механиката на трицепс-съпротивление, която информира принципа на tension-band фиксацията, и синтезира топографските схеми на Desault и Boyer, които по-късно ще бъдат преорганизирани от Morrey в Mayo-класификацията. Клиничните лекции на Дюпюитрен (1832) дават първата систематична серия на фрактури на дистален хумерус и processus coronoideus, а наблюденията му върху посттравматичния скован лакът остават клинично актуални. *A Treatise on Dislocations and Fractures of the Joints* на Astley Cooper (1822) предлага стандартното англоезично описание на луксацията на лакъта и фрактурата на главата на радиуса преди Mason.

- **Малгень** (1847): *Traité des fractures et des luxations*, том 1, „Des fractures de l'olécrane". · [Факсимиле](https://archive.org/details/BIUSante_32985x01)
- **Дюпюитрен** (1832): *Leçons orales de clinique chirurgicale*, том 1 — лекции за лакътната област. · [Факсимиле](https://archive.org/details/leonsoralesdec01dupu)
