...
<aside class="callout callout-pearl">
  ...
  <p>Schemitsch и Richards (1992): възстановяването на radial bow в рамките на 5% от контралатералната страна (по амплитуда И локализация) е единичният най-важен фактор за добрия функционален изход след фиксация на фрактура на диафизата на предмишницата. Фрактурата на предмишницата при възрастния трябва да се третира така, сякаш е вътреставна.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Стандартна фиксация при фрактура на двете кости на предмишницата при възрастен: 3,5-mm DCP или LCP през достъп по Henry (волар) за radius и директен подкожен достъп за ulna. Поне 6-8 кортекса (3-4 бикортикални винта) от всяка страна на всяка фрактура. Честотите на срастване надвишават 95%, когато дължина, ротация и radial bow са възстановени.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Критерии на Sarmiento за консервативно лечение на изолирана улнарна (nightstick) фрактура: ъглово изместване под 10°, дислокация под 50% от диаметъра на костта, фрактура дистално от залавното място на m. pronator teres и липса на нестабилност на PRUJ/DRUJ. Извън тези граници — плака.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>„Истинската“ изолирана фрактура на диафизата на radius е рядка — приемете окултно Galeazzi, докато не се докаже обратното. Прегледайте специфично DRUJ на профилната рентгенография на китката, измерете улнарната вариация и потърсете фрактура на основата на улнарния стилоид преди да я обявите за изолирана.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Monteggia по Bado според посоката на луксация на главичката на radius: I — предна (60-70% при възрастни), II — задна/задно-латерална (нерядко с фрактура на главичката на radius, по-чест при възрастни), III — латерална (почти изключително педиатрична), IV — фрактура и на двете кости с предна луксация на главичката на radius. Анатомичната фиксация на ulna обикновено редуцира главичката — ако не, търсете интерпониран lig. anulare или фрагмент.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Galeazzi е „фрактурата на необходимостта“ — консервативното лечение не работи при възрастния. След ОРВФ на radius тествайте стабилността на DRUJ в пронация, неутрална позиция и супинация. При нестабилност: реконструкция на TFCC, фиксация на основата на улнарния стилоид или трансверзален K-тел през DRUJ; имобилизация в позицията на максимална стабилност (типично пълна супинация) за 4-6 седмици.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Рефрактурата след отстраняване на плаката от предмишницата е 5-25% в по-ранните серии. Отложете отстраняването до поне 18-24 месеца след операцията (и само при категоричен повод), предпочитайте LCP-плаки, минимизиращи контакта с кортекса, и консултирайте пациента за постепенно завръщане към натоварване.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Radioulnar синостозата е страховитото усложнение при фрактура на двете кости на едно ниво, ЧМТ, високоенергиен механизъм или оперативен достъп близо до интеросеалната мембрана. Профилактиката е целта: отделни достъпи за radius и ulna, внимателно мекотъканно отношение и обмисляне на лъчева или индометацинова профилактика при високорискови пациенти.</p>
</aside>

## Източници и класическа литература

Епонимите за фрактури на предмишницата са плътно групирани: Monteggia (1814) и Galeazzi (1934) за радио-улнарните дисоциации; Essex-Lopresti (1951) за надлъжната дисоциация на предмишницата. *Traité* на Малгень (1847) каталогизира пред-епонимната клинична литература и потвърждава описанието на Monteggia. *Leçons orales* на Дюпюитрен (1832) дава серията Hôtel-Dieu от „fractures de l'avant-bras".

- **Малгень** (1847): *Traité des fractures et des luxations*, том 1 — фрактури на предмишницата, Monteggia. · [Факсимиле](https://archive.org/details/BIUSante_32985x01)
