...
<aside class="callout callout-pearl">
  ...
  <p>Нормалните параметри на дисталния radius за възстановяване: радиална инклинация ~22°, радиална височина ~12 mm (от върха на стилоида до латералната улнарна ставна повърхност), волар тилт ~11°, ставна конгруентност. Загубата на волар тилт поражда компенсаторна екстензия на китката, средно-карпална нестабилност и по-слаб захват; загубата на радиална дължина — улнокарпален импакт; ставното стъпало — посттравматична артроза.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Бърз справочник на епонимите: Colles (дорзално разместена извънставна, „вилица за вечеря“), Smith (воларно разместена, „обратна Colles“, по-нестабилна), Barton (вътреставна срязваща фрактура-луксация, волар или дорзална — изисква подпираща плака), шофьорска/Hutchinson (стилоид на radius, аксиален скафоиден импакт, внимавайте за scapholunate увреждане), die-punch (депресирана lunate-фасета, нерядко изисква открита репозиция).</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Критерии на Lafontaine за вторично изместване след закрита репозиция: дорзална ъглова деформация >20°, дорзална разтрошеност, вътреставна ангажираност, фрактура на стилоида на ulna и възраст над 60 г. Три или повече означава, че консервативното лечение вероятно ще се провали — обмислете оперативна интервенция предварително, вместо да гоните изгубена репозиция.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Острият карпален тунелен синдром след фрактура на дисталния radius е хирургична спешност, а не диагноза за наблюдение. Прогресиращите симптоми на n. medianus въпреки репозицията и елевацията налагат спешно освобождаване на карпалния тунел, съчетано с лечение на фрактурата — наблюдението кани постоянна дисфункция на n. medianus.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Приемливи параметри след репозиция: дорзална ъглова деформация не повече от 0-10°, радиална инклинация поне 15°, радиално скъсяване не повече от 3-5 mm, ставно стъпало не повече от 2 mm. Възрастният пациент с ниски функционални изисквания понася по-голяма деформация; младият активен пациент изисква анатомична репозиция.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Скъсването на FPL е най-страшното усложнение на воларната плакова фиксация — причинено от плака, поставена твърде дистално от watershed line. Останете проксимално от watershed и съкратете всички изпъкващи винтове. Дорзалната перфорация на кортекса поражда симетричното усложнение: екстензорно сухожилно раздразнение и скъсване на EPL при туберкула на Lister.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Две практико-изместващи проучвания: WRIST (Chung 2020) показа сравними 1-годишни функционални резултати между оперативно и консервативно лечение при пациенти над 60-65 г. с разместени нестабилни фрактури, въпреки по-добрите рентгенографии в оперативната група. DRAFFT (Costa 2014/2020) показа, че фиксацията с K-тели се равнява на воларната заключваща плака при извънставни фрактури над 50 г. — на значително по-ниска цена.</p>
</aside>
...
- **Малгань** (1847): *Traité des fractures et des luxations*, том 1 (Paris: Baillière). Подробно изложение и критика на Pouteau-Colles и Смит. · [Факсимиле (BIU Santé)](https://archive.org/details/BIUSante_32985x01)
- **Дюпюитрен** (1832): *Leçons orales*, том 4, лекция за фрактурата на долния край на лъчевата кост — съвременник на Колес, със собствена клинична серия. · [Факсимиле](https://archive.org/details/leonsoralesdec04dupu)
