...
<aside class="callout callout-pearl">
  ...
  <p>Кръвоснабдяването на scaphoid е ретроградно — дорзалните гребенни съдове от радиалната артерия снабдяват 70-80% от костта от дистално към проксимално. Колкото по-проксимална е фрактурата, толкова по-лоша е прогнозата: дисталният полюс зараства 90-95% в гипс, талията — на междинни честоти, проксималният полюс — 60-80% и висок риск от АВН.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Негативната начална рентгенография не изключва фрактура на scaphoid — началните снимки пропускат 20-40%. Класическата клинична триада (болка в табатиерката, на туберкула на scaphoid, при аксиална компресия на палеца) е почти 100% чувствителна, но само 20% специфична. Или шинирайте и реизследвайте на 10-14-ия ден, или преминете директно към МРТ; пропускането й води до псевдоартроза и SNAC-китка.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Стадии на Mayfield на перилунатно увреждане, от радиално към улнарно: I — scapholunate нарушение, II — capitolunate нарушение (перилунатна луксация), III — lunotriquetral нарушение, IV — lunatum луксира воларно в карпалния тунел („преобърнатата чашка“). На профилната рентгенография на китката radius-lunatum-capitatum трябва да са колинеарни; отклонението указва стадия.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Перилунатните луксации се пропускат при до 25% от началните представяния, защото AP-рентгенографията може да изглежда „почти нормална“ — винаги преглеждайте профилната и потвърждавайте колинеарността radius-lunatum-capitatum. „Навяхване“ на китка, което не се подобрява за две седмици, заслужава повторна образна диагностика или МРТ за изключване на окултна перилунатна или scaphoid лезия.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Допустимо ъглово изместване на шийките на метакарпалните кости по лъч (намаляващо радиално поради подвижността на CMC ставите): V — 40°, IV — 30°, III — 20°, II — 10°. Ротацията не е приемлива при нито една метакарпална кост — дори няколко градуса предизвикват припокриване на пръстите (scissoring) при флексия и е абсолютно оперативно показание.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Фрактура-луксация на Bennett (1882) — вътреставна фрактура-луксация на основата на първата метакарпална кост. Малък волар-улнарен фрагмент е задържан от предния наклонен (дълбок клюн) лигамент; диафизата луксира проксимално и радиално под abductor pollicis longus. Винаги нестабилна, почти винаги оперативна — закрита репозиция с два перкутанни K-тела (един напречно на CMC, един към втора метакарпална). Rolando е разтрошеният Y/T-вариант с по-лоша прогноза.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Ротационната деформация при фалангите трябва да се коригира — дори няколко градуса предизвикват scissoring на пръстите при флексия, което е функционално инвалидизиращо. Винаги оценявайте ротацията с пръстите при флексия (всички трябва да сочат към туберкула на scaphoid), а не само при екстензия; ротацията е единственият най-важен и най-често пропускан параметър.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Лезия на Stener при „пазача на дивеч“ / ски-увреждане на палеца: авулзираният улнарен колатерален лигамент е изместен над adductor aponeurosis и не може да зарасне обратно към костта без операция. Подозирайте, когато слабостта на MCP UCL надвишава 30° спрямо контралатералния палец (или абсолютна >35°); потвърдете с МРТ. Шиниране на лезия на Stener означава лечение на незарастващ проблем с грешен метод.</p>
</aside>
...
Групата епоними за карпус и метакарпус (Bennett 1882, Rolando 1910, Galeazzi 1934, Mayfield 1980) следва плътна клинична литература за травмата на ръката от XIX век. Малгень (1847) и Дюпюитрен (1832, том 4) описват пред-епонимните клинични фенотипи; Velpeau (1832) и Desault (1798) — техниката на имобилизация.

- **Малгень** (1847): *Traité des fractures et des luxations*, том 1. · [Факсимиле](https://archive.org/details/BIUSante_32985x01)
- **Дюпюитрен** (1832): *Leçons orales de clinique chirurgicale*, том 4 — ръка. · [Факсимиле](https://archive.org/details/leonsoralesdec04dupu)
- **Velpeau** (1832): *Nouveaux éléments de médecine opératoire*, том 2 — превръзки на китка и ръка. · [Факсимиле](https://archive.org/details/BIUSante_43901x02)
