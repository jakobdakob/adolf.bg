...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Стабилността се определя от целостта на медиалния кортекс (малкия трохантер и calcar femorale). Реконструируем медиален опор позволява динамична компресия по импланта; медиалната разтрошеност прехвърля натоварването върху импланта и изисква конструкция, устояваща на колапс.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Tip-apex distance (Baumgaertner, 1995) е най-важният технически параметър: сборът от разстоянията връх-апекс на AP и страничната рентгенография трябва да е под 25 mm. TAD над 25 mm е доминиращият предиктор за cut-out независимо дали конструкцията е DHS или цефаломедуларен пирон.</p>
</aside>

## Резултати и начини на неуспех

DHS осигурява надеждно срастване при стабилни пертрохантерни фрактури с правилно позициониран имплант. Основните начини на неуспех включват:
...
Изборът между кратък пирон (обикновено 240 mm или по-малко, завършващ в проксималния фемур над диафизарния истмус) и дълъг (обикновено 340 mm или повече, достигащ до дисталната метафиза) е практически въпрос. Краткият пирон е по-лесен за въвеждане и е свързан с по-малко технически усложнения; дългият осигурява по-пълна защита на бедрото от последваща фрактура и е предпочитан при пациенти с риск за атипична бедрена фрактура или с разпростиране на линията на фрактурата в субтрохантерния регион. Перипротезната фрактура на нивото на върха на кратък пирон (призната усложнение) доведе до застъпничество за дълги пирони при избрани пациенти, въпреки че рутинното им прилагане носи собствени рискове (по-дълго оперативно време, по-голямо лъчево натоварване).

<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Атипичните бедрени фрактури при продължителна терапия с бисфосфонати или деносумаб показват задебеляване на латералния кортекс, напречна линия и медиален „шип“ и нерядко са предшествани от продромална болка в бедрото. Непълна рентгенографска находка изисква спешна КТ или МРТ и профилактично пироноване, заедно с „медикаментна ваканция“ или преминаване към терипаратид.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>DHS при обратно-коси фрактури (AO 31-A3) е биомеханично недостатъчен, защото линията на фрактурата е по същество успоредна на винта и срезовата сила не може да бъде неутрализирана от плъзгащия механизъм. А3 типовете и субтрохантерните разпростирания са територия на цефаломедуларния пирон.</p>
</aside>
...
Пертрохантерните фрактури са вече разделени от феморално-шийковите от Малгень (1847) на базата на тяхното екстракапсулно разположение и съответно по-надеждното им заздравяване. Военният опит на Лярей (1812) дава ранния клиничен материал. Модерните dynamic hip screw (DHS) и intramedullary nail (PFNA, Gamma) произлизат от ранните екстрамедуларни плакови и винтови устройства от 1950-те.

- **Малгень** (1847): *Traité des fractures et des luxations*, том 2 — пертрохантерна област. · [Факсимиле](https://archive.org/details/BIUSante_32985x02)
