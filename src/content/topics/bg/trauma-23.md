...
Ретроградното пироноване през intercondylar notch на дисталния фемур се е утвърдило като важна алтернатива. Входната точка е непосредствено пред залавното място на PCL в
...
Хетеротопната осификация на проксималната входна точка може да настъпи, по-често при пирформен вход; прецизното отстраняване на стружките при разширяване и обмислянето
