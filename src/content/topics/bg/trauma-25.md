...
<aside class="callout callout-pearl">
  ...
  <p>Две вътреставни фрактури на коляното с обща тематика: пателарната фрактура се ръководи от целостта на екстензорния механизъм (може ли пациентът да екстендира срещу гравитацията?), а фрактурата на plateau tibiae, от ставната конгруентност и механичната ос. Непълната репозиция и в двете води до посттравматична артроза.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Ретинакулумите са страничните разширения на екстензорния механизъм. При интактни ретинакулуми пациент с фрактура на патела може да изпълни straight-leg raise; при разкъсани ретинакулуми или широко разместени фрагменти активната екстензия е загубена. Поради това straight-leg raise тестът е леглото за оперативното решение.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Не обявявайте двуделната патела за фрактура. Гладки кортикализирани ръбове, суперолатерална локализация и честа двустранност (около 60%) я отличават от острата фрактура; педиатричната sleeve фрактура от своя страна авулзира неосифициран хрущял и лесно се пропуска на рентгенография.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Тензионно-бандажната остеосинтеза на патела е свързана с много висока честота на симптоми от материала (до 30-50% налагат отстраняване поради миграция на К-телчета). Пластинната фиксация с минифрагментни или мрежести пластини намалява тази честота при мултифрагментни варианти, при които тензионно-бандажната техника е биомеханично недостатъчна.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Схема на Schatzker: I split на латералния plateau, II split-депресия на латералния (най-чест), III чиста депресия на латералния, IV медиален (по-висока енергия с риск от съдово, перонеално и менискусно нараняване), V бикондиларен, VI бикондиларен с метафизарно-диафизарна дисоциация. Около 50% от платовите фрактури имат съпътстващо лигаментарно нараняване.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>При бикондиларните типове Schatzker V/VI не използвайте единичен преден срединен разрез: проксималната медиална тибия е watershed зона и кожната некроза е често усложнение. Прилагайте отделни медиален и латерален разрези, а при компрометирани меки тъкани, най-напред обхватна (spanning) външна фиксация през коляното.</p>
</aside>

## Източници и класическа литература

*Traité* на Малгень (1847) дава основополагащото клинично описание на фрактурите на пателата, разделяйки напречните (отказ на tension-band) от раздробените (отказ при директен удар) — същата механична дихотомия, която управлява модерните избори за фиксация. Дюпюитрен (1832) по-рано описва серията на фрактурите на пателата; tension-band wiring на Weber (1963) е модерният потомък на механичното разсъждение на Малгень.

- **Малгень** (1847): *Traité des fractures et des luxations*, том 2 — пателa, проксимален тибиален. · [Факсимиле](https://archive.org/details/BIUSante_32985x02)
- **Дюпюитрен** (1832): *Leçons orales de clinique chirurgicale*, том 3 — коленна област. · [Факсимиле](https://archive.org/details/leonsoralesdec03dupu)
