...
<aside class="callout callout-pearl">
  ...
  <p>Тибията е най-често счупваната дълга кост и има най-високия дял на открити фрактури сред дългите кости (около 25%). Подкожната антеромедиална кортикала практически без покривка от меки тъкани обуславя и високия дял на открити форми, и бавното заздравяване на рани и разрези в тази зона.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Коридорът за гипсово лечение: скъсяване под 5 mm, varus/valgus под 5°, сагитална ангулация под 10°, ротация под 10°. Тибията понася малюнион лошо, защото изравняването се проектира директно върху механиката на глезена; излизате ли от коридора, оперирайте.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Интрамедуларното пироноване е стандарт при разместени фрактури на тибиалната диафиза, включително до Gustilo IIIA. Пироноването с разстъргване е подкрепено от SPRINT с намалена честота на реоперации в сравнение с без разстъргване. Полер-винтовете и супрапателарният подход помагат при фрактури в проксималната третина, при които деформацията е трудна за контролиране.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Компартмент синдромът на подбедрицата е най-честият в тялото, а фрактурата на тибиалната диафиза е най-честият причинител. Болка, несъответстваща на нараняването, и болка при пасивно разтягане са по-ранни и по-надеждни от късните „5 П“; перфузионно налягане (диастолно минус компартментно) под 30 mmHg или абсолютно налягане над 30 mmHg налага четирикомпартментна фасциотомия.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Не предприемайте незабавна дефинитивна ОРВФ на високоенергийна pilon-фрактура: мехурите и кожният компромис в първите 24-48 часа водят до катастрофален провал на раната. Двуетапният подход (обхватна външна фиксация и фибулна пластина първо, дефинитивна ОРВФ 7-21 дни по-късно чрез антеролатерален или медиален достъп) е вече стандарт.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Стрес-фрактурата на предната тибиална кортикала („dreaded black line“) е на опъната страна поради естественото задно извиване и е с висок риск от прогресия до пълна фрактура и псевдоартроза. При конкурентни спортисти интрамедуларно пироноване или ексцизия с костна пластика се предпочита пред продълженото лечение без натоварване.</p>
</aside>
...
*Mémoires* на Лярей (1812) е основополагащият текст за тибиалните огнестрелни и краш увреди; неговата бойнополева доктрина за ранна ампутация управлява лечението на отворената тибиална диафиза за повече от век. Малгень (1847) консолидира цивилния клиничен материал. Pilon-фрактурата като отделна единица е от XX век (Destot 1911, Bonin 1950).

- **Лярей** (1812): *Mémoires de chirurgie militaire et campagnes*, том 2. · [Факсимиле](https://archive.org/details/mmoiresdechiru02larr)
- **Малгень** (1847): *Traité des fractures et des luxations*, том 2 — тибиална диафиза. · [Факсимиле](https://archive.org/details/BIUSante_32985x02)
