...
<aside class="callout callout-pearl">
  ...
  <p>Тялото на talus се кръвоснабдява предимно отдолу чрез артерията на тарзалния канал (клон на a. tibialis posterior). Избягвайте обширна задна дисекция при операция и помнете, че 60% от повърхността на talus е ставен хрущял без мускулни или сухожилни захвания, които да донесат алтернативно кръвоснабдяване.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Hawkins при фрактури на шийката на talus: I недислоцирана (AVN около 0-13%), II със субталарна луксация (20-50%), III със субталарна и глезенна луксация (80-100%), IV с добавена таларонавикуларна луксация (около 100%). Всяка степен на луксация отстранява поредния васкуларен източник, затова спешната репозиция при дислоцирани форми е централният принцип.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Признакът на Hawkins е ивица субхондрална прозрачност в купола на talus на 6-8 седмици, образувана от дизузна остеопения във васкуларизирано тяло. Наличието му предсказва запазена васкуларност и нисък риск от AVN; отсъствието му при натоварващ пациент е тревожно, но не диагностично.</p>
</aside>
...
Извънставните фрактури на calcaneus (около 25%) включват фрактурата на предния израстък (авулзия от bifurcate ligament, нерядко пропускана на рентгенографиите), авулзионната фрактура на туберкулата (авулзия от tendo Achillis), фрактурата на медиалния израстък (авулзия от abductor hallucis), фрактурата на sustentaculum tali (с потенциално ангажиране на flexor hallucis longus и субталарната става) и фрактурата на тялото без ставен ангажимент.
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Два ъгъла за оценка на профилната рентгенография на calcaneus: Böhler 25-40° (изравнява се под 20° при депресия на задния фасет) и ъгълът на Gissane 130-145° (увеличава се при депресия). И двата маркират калканеалната компресия, която КТ-класификацията на Sanders след това характеризира за оперативно планиране.</p>
</aside>
...
Клиничните признаци включват болка в средата на стъпалото, оток и екхимоза; признакът на плантарна екхимоза (Ross, 1996) (натъртване по плантарната повърхност на средата на стъпалото) е специфичен индикатор за нараняване на Lisfranc. Неспособността за натоварване е честа. Образната диагностика включва АП, профилна и наклонена проекция на стъпалото, като проекциите с натоварване са от критично значение за диагнозата (проекциите без натоварване могат да изглеждат нормално, с дислокация, видима само при натоварване).

<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Не изключвайте нараняване на Lisfranc само въз основа на рентгенографии без натоварване: дислокацията може да се изяви само под натоварване. Проекциите с натоварване, признакът на плантарна екхимоза (Ross), „признакът на люспа“ (Myerson) и КТ или МРТ при дискретни лигаментарни форми са необходими, за да не се пропусне диагноза, водеща до доживотен артрит на средата на стъпалото.</p>
</aside> Ключовите рентгенографски находки включват:
...
Открита репозиция и вътрешна фиксация с трансартикуларни винтове напречно на ставите на Lisfranc (историческият стандарт). Винтовете обикновено са 3,5 или 4,0 mm кортикални, преминаващи от медиалното cuneiforme в основата на втория metatarsus, от медиалното в средното cuneiforme и другите стави по необходимост. Отстраняването на металните импланти обикновено се извършва след 3-6 месеца за разрешаване на нормалната ставна подвижност. Техниката дава добри резултати при добре репонирани наранявания.
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Разграничавайте трите морфологии на основата на петия metatarsus: авулзия на туберозитас („танцовата фрактура“, зараства консервативно), фрактура на Jones на метафизарно-диафизарното съединение (25-30% псевдоартроза, нерядко перкутанна винтова фиксация при спортисти) и проксимална диафизарна стрес-фрактура (управлявана като Jones). Зоната на Jones е watershed и понася консервативно лечение зле.</p>
</aside>

## Източници и класическа литература

Фрактурите на талуса и калканеуса са систематично каталогизирани от Малгень (1847), с разпознаването, че фрактурата на шийката на талуса има критично влияние върху предаването на телесното тегло. Класификацията на Hawkins (1970) и тази на Sanders (1993) се изграждат върху тази основа. Средновековните и Ренесансови описания се появяват при Chauliac (1363) и Paré.

- **Малгень** (1847): *Traité des fractures et des luxations*, том 2 — фрактури на стъпалото. · [Факсимиле](https://archive.org/details/BIUSante_32985x02)
