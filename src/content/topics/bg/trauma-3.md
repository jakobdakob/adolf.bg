...
<aside class="callout callout-pearl">
  ...
  <p>Четирите параметъра на репозицията са дължина, ос (ъглово изместване), ротация и транслация. Ротацията не се ремоделира и трябва да се коригира по време на лечението; вътреставните фрактури по принцип изискват анатомична репозиция (цепки/стъпала над 1-2 mm обикновено налагат операция), а диафизарните понасят по-несъвършено наредяване.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Изостряйте, преди да репозирате. Класическата маневра, особено при фрактури на дисталния радиус, е първо изостряне на деформацията за разединяване на заклещените фрагменти и едва после обратна корекция; в съчетание с тракция-контратракция това е основата на повечето закрити репозиции.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Гипсът (калциев сулфат хемихидрат) се втвърдява чрез екзотермична реакция (рядък риск от термично нараняване при гореща вода или дебели слоеве); фибростъклото е по-леко, по-яко и водоустойчиво, но с по-слаба пластичност при оформяне и по-скъпо.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Триточковата фиксация е механичната основа на всяка гипсова превръзка: натиск при проксималния фрагмент, при дисталния фрагмент и на върха на деформацията. Гипсът трябва да обездвижи ставите над и под фрактурата, а при остра фрактура се разцепва или бивалвира, за да позволи оток.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Болка под гипс, несъразмерна с нараняването, е компартмент синдром, докато не се докаже обратното. Първата реакция е спешно разцепване (или пълно отстраняване) на гипса, последвано от фасциотомия, ако налягането и прегледът останат непроменени. Разцепването само на подложката не е достатъчно.</p>
</aside>
...
Кожната тракция прилага тракция чрез лепяща лента или специализирани ботуши, прикрепени към кожата. Количеството тракция е ограничено (обикновено под 5 kg при възрастни) и следователно е подходящо основно за временна стабилизация, при педиатрични приложения и за избрано дефинитивно лечение при определени ситуации. Тракцията на Russell и различните педиатрични тракционни системи са примери.

<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Кожната тракция е ограничена до около 5 kg при възрастни и затова е временна или педиатрична мярка; скелетната тракция през транскостен щифт позволява до 10-15% от телесното тегло. Стандартни щифтови места са дисталният фемур, проксималната тибия и калканеусът.</p>
</aside>

## Скелетна тракция

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/trauma-3/traction.jpg" data-figure-alt="Скелетна тракция" aria-label="Увеличи">
    <img src="/img/trauma-3/traction.jpg" alt="Скелетна тракция" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Функционалното шиниране на Sarmiento използва хидравлична компресия на меките тъкани, за да поддържа фрактурата, докато ставите наоколо се движат. Класически индикации са диафизарните фрактури на хумеруса и тибията, макар че интрамедуларният пирон вече е изтласкал шината при повечето дислоцирани тибиални диафизарни фрактури.</p>
</aside>

## Закрита репозиция под анестезия

При дислоцирани фрактури, които не могат адекватно да бъдат репозирани при обикновена аналгезия, се извършва закрита репозиция под анестезия. Процедурата обикновено се провежда под обща или регионална анестезия, с контрол на образния усилвател, в операционна зала или в процедурна зала с подходящи условия. Техниката включва: прилагане на анестезия; позициониране на пациента съобразно фрактурата; репозиционни маневри с директна манипулация, тракция и триточкова фиксация; проверка на репозицията чрез флуороскопия; поставяне на дефинитивен гипс или лонгета; и крайни рентгенографии за документиране на репозицията.
...
Пред-Böhler традицията на консервативното лечение на фрактурите е дадена в *Traité* на Малгень (1847), който каталогизира съвременната апаратура (екстензия, контра-екстензия, гипс, шини) и дава рационалния случай за всяка. Средновековната *Chirurgia magna* на Guy de Chauliac (1363) запазва Хипократовата и Галеновата традиция на шиниране, върху която европейската практика още почива до XIX век. Китайската имперска традиция (*Yizong Jinjian*, 1742) развива независима и силно изтънчена техника на ръчно репозиране под принципа „опипвай с ръката, разбирай със сърцето".

- **Chauliac** (1363): *Chirurgia magna* — средновековно шиниране и репозиция. · [Факсимиле](https://archive.org/details/chirurgiamagnagu00guyd)
- **Малгень** (1847): *Traité des fractures et des luxations*, том 1 — апаратура и екстензия. · [Факсимиле](https://archive.org/details/BIUSante_32985x01)
- **Velpeau** (1832): *Nouveaux éléments de médecine opératoire*, том 1 — превръзки на рамото. · [Факсимиле](https://archive.org/details/BIUSante_43901x01)

## Обобщение и ключови изводи

Консервативното лечение на фрактурите остава подходящото лечение за огромното мнозинство от фрактурите, с техники, включващи закрита репозиция, обездвижване с гипс и лонгета, тракция и функционално шиниране. Кардиналните принципи на консервативното лечение, възстановяване на дължината, оста, ротацията и транслацията; подходящо обездвижване с внимание към триточковата фиксация; правилна гипсова техника, включително подложка, оформяне и бивалвиране при остър оток; и прогресивна рехабилитация, дават успешни резултати в огромното мнозинство от случаите. Усложненията на гипсовото лечение (компартмент синдром, декубитус, увреждане на периферен нерв, ставна скованост, атрофия от обездвижване) са до голяма степен предотвратими при правилна техника и проследяване. Тракцията се прилага основно като временна мярка преди дефинитивна операция в съвременната практика, като дефинитивното лечение само с тракция вече е рядко. Функционалното шиниране позволява ставно движение по времето на зарастването и има специфични приложения при диафизарните фрактури на хумеруса и тибията. Изборът между консервативно и оперативно лечение е обусловен от фрактурно-специфичните, пациент-специфичните и контекстуалните фактори, като правилният избор на лечение дава най-добрите резултати.
