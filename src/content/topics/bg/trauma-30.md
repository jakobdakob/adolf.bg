...
<aside class="callout callout-pearl">
  ...
  <p>Мускулно-сухожилната единица се уврежда в най-слабото си звено: миотендинозното съединение при разтяганията, средната третина на сухожилието при дегенеративните руптури и костното захващане при авулзиите. M. biceps femoris е най-често разтягания ишиокрурален мускул; m. rectus femoris доминира в квадрицепсните разтягания, тъй като пресича едновременно тазобедрената и колянната става.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Повечето дегенеративни руптури на tendo Achillis са в watershed зоната 2-6 cm проксимално от захвата за calcaneus. Флуорохинолоните, перитендинозните кортикостероидни инжекции, системните стероиди и хроничната тендинопатия предразполагат; внимавайте за тези анамнестични данни при мъж на средна възраст с внезапна болка в прасеца.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Острата руптура на tendo Achillis днес обикновено се лекува неоперативно по функционален протокол: съвременните честоти на реруптура доближават оперативните (около 5-8%) при съществено по-малко ранови усложнения. Запазете откритата или перкутанна оперативна репарация за елитни спортисти, забавени представяния след 4-6 седмици или противопоказания за функционално лечение.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Руптура на екстензорния механизъм: невъзможност за активно разгъване на коляното срещу гравитацията плюс опипваем дефект, с patella alta (Insall-Salvati над 1,2) при руптура на пателарното сухожилие и patella baja при руптура на сухожилието на m. quadriceps. И двете изискват спешна оперативна репарация с трансосални шевове, докато са в острия период (2-6 седмици).</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Руптура на дисталното сухожилие на m. biceps: екхимоза, разпространяваща се дистално по предмишницата, опипваем дистален дефект и положителен hook тест (Ruland), при който пръстът на изследващия не закача сухожилието при 90° флексия и пълна супинация. Репарацията запазва силата на супинацията, основният функционален дефицит (пронацията се поддържа от m. pronator teres и m. pronator quadratus).</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Третирайте хроничната тендинопатия като неуспешен оздравителен отговор с дегенерация, а не като възпаление. Ексцентричното натоварване (протоколът на Alfredson за tendo Achillis) подобрява около 80% от случаите; избягвайте кортикостероидна инжекция в натоварени сухожилия (tendo Achillis, пателарно сухожилие) поради риска от руптура.</p>
</aside>
...
Подкожната ахилотенотомия Stromeyer-Dieffenbach (1831–48) е основополагащата модерна операция за мускулно-сухожилни увреди. *Leçons orales* на Дюпюитрен (1832, том 4) дава серията на разкъсванията на Ахила; Velpeau (1832) — консервативната традиция. *De methodo medendi* на Galen запазва класическата доктрина, че сухожилие никога не бива да се прерязва — доктрина, която подкожната тенотомия решително преобърна.

- **Dieffenbach** (1848): *Die operative Chirurgie*, том 2 — подкожна тенотомия. · [Факсимиле](https://archive.org/details/dieoperativechir02dief)
- **Дюпюитрен** (1832): *Leçons orales de clinique chirurgicale*, том 4. · [Факсимиле](https://archive.org/details/leonsoralesdec04dupu)
