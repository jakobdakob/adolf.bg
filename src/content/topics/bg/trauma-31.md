...
Неврапраксия (I степен): Най-лекото увреждане, локален блок на проводимостта без аксонална увреда. Нервното влакно е структурно интактно; проводимостта е нарушена от преходна демиелинизация на мястото на увреждането. Възстановяването е типично пълно в рамките на дни до седмици (3-12 седмици за пълно възстановяване в повечето случаи), тъй като миелиновата обвивка се поправя.
...
<aside class="callout callout-pearl">
  ...
  <p>Seddon и Sunderland съпоставени: неврапраксията (Seddon I, Sunderland I) е блок на проводимостта, възстановяващ се за 3-12 седмици; аксонотмезисът (Seddon II, Sunderland II) показва валерова дегенерация, но ендоневралните тубули направляват регенерацията с около 1 mm на ден; невротмезисът (Seddon III, Sunderland III-V) нарушава съединителнотъканната скеля и изисква хирургична репарация.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>При острата изява обикновено не може да се разграничи аксонотмезис (ще се възстанови) от IV-V степен (няма да се възстанови). Серийната клинична и електрофизиологична оценка в продължение на 3-6 месеца е задължителна, а прогресиращият дистално знак на Tinel е най-надеждният клиничен маркер за аксонална регенерация.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Време за електродиагностика: НКС и ЕМГ обикновено се извършват 3-4 седмици след увреждането, когато фибрилационните потенциали на денервацията вече са се появили (2-3 седмици), с последователни изследвания на 3-месечни интервали. Блок на проводимостта при запазен CMAP предполага неврапраксия; липсващ CMAP при липсващ проксимален отговор предполага по-тежко увреждане.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Остра лацерация с пълен дефицит (Sunderland V) и нерепонируема фрактурно-луксационна деформация с нов нервен дефицит са хирургични показания, а не проблеми за наблюдение. Целете изследване на острите лацерации в рамките на 72 часа; отложената първична репарация в рамките на 3 седмици е допустима в подбрани случаи.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Моторните крайни плочки се губят необратимо за 18-24 месеца, това е горната граница на прозореца за успешна реинервация. Изследвайте невъзстановяващи се увреждания на 4-6 месеца, а при закъснели изяви предпочитайте нервни трансфери (които скъсяват регенеративното разстояние) или сухожилни трансфери (които заобикалят денервацията изцяло).</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Неонаталната парализа на брахиалния плексус се възстановява спонтанно при 80-95% от случаите. Решаващата точка е флексията на лакътя срещу гравитация (функция на m. biceps) до 3-6-месечна възраст: липсата й налага микрохирургично изследване с нервно графтиране или трансфер.</p>
</aside>
...
*Idea of a New Anatomy of the Brain* на Sir Charles Bell (1811) и последвалата му *The Nervous System of the Human Body* (1830) дават анатомичната основа на модерното разбиране на периферната нервна увреда. Velpeau (1832) и Дюпюитрен (1832) допринасят клиничните описания; *Gunshot Wounds and Other Injuries of Nerves* на Mitchell-Morehouse-Keen (1864) дава систематичния хирургичен анализ от ерата на Гражданската война.

- **Mitchell, Morehouse, Keen** (1864): *Gunshot Wounds and Other Injuries of Nerves*. · [Факсимиле](https://archive.org/details/41411000R.nlm.nih.gov)
...
Принципите на лечение включват незабавно хирургично изследване при остри лацерационни травми и при необратими фрактурно-луксационни деформации с нов неврологичен дефицит; изчаквателно поведение при закрити увреждания с серийна оценка; хирургично изследване при 4-6 месеца при липса на възстановяване; и избягване на 18-24-месечната граница, след която моторната реинервация дава лоши резултати.
