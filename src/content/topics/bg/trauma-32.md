...
<aside class="callout callout-pitfall">
  ...
  <p>Интималното увреждане със забавена тромбоза е най-коварната съдова лезия: началният преглед може да е подвеждащо нормален, с влошаване в рамките на часове. Поддържайте серийни съдови проверки при всеки високорисков модел (луксация на коляното, надкондиларна фрактура на хумеруса, arteria brachialis при луксация на лакътя) дори при нормална първа находка.</p>
</aside>
...
<aside class="callout callout-pearl">
  ...
  <p>Триаж: твърдите признаци (активно кървене, нарастващ или пулсиращ хематом, липсващи пулсации, дистална исхемия, шум/трептене) отиват директно в операционната; меките признаци или ГБИ/ИУК под 0,9 отиват на КТ ангиография. Конвенционалната ангиография е запазена за неясни случаи или за емболизация/стентиране.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>При комбинирано ортопедично и съдово увреждане прилагайте „шунт-фиксация-репарация“: временен интралуминален шунт възстановява притока в минути, външна фиксация осигурява ортопедичната платформа, след което следва дефинитивна репарация (реверзираният сафенозен вен-графт е стандартът). Добавяйте профилактична фасциотомия при исхемия над 4-6 часа.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Изследването LEAP: на 2 и 7 години запазването и ампутацията дават сходни функционални резултати при тежко увредени крайници, като психологическите и социоикономическите фактори на пациента определят изхода повече от ортопедичния избор. MESS и сродните скорове ориентират, но не диктуват решението; агресивното запазване на граничен крайник може да е по-лошо от добре проведена първична ампутация.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Compartment синдромът може да настъпи при запазени дистални пулсации, тъй като микроциркулацията се срива преди макроциркулацията. Липсата на пулс, парализата и бледостта са късни признаци на установена некроза; разпознавайте болка, несъразмерна с увреждането, болка при пасивно разтягане, напрегнат компартмент и прогресиращи парестезии като диагностична клинична картина.</p>
</aside>
...
•   Фрактури: Фрактурата на диафизата на тибията е най-честата причина (Тема
    Травматология-27); сред другите рискови фрактури са фрактурите на костите на предмишницата (с исхемичната контрактура на Volkmann като класическа крайна фаза
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Прилагайте перфузионно, а не абсолютно налягане: Δp (диастолно минус компартментно) под 30 mmHg е съвременният праг за фасциотомия и отчита кръвното налягане на пациента. Непрекъснатото мониториране с постоянен катетър е задължително при притъпения пациент, който не може да съобщи болка.</p>
</aside>
...
Фасциотомията на предмишницата се извършва чрез достъпа на Henry (криволинеен воларен разрез от медиалния епикондил, през антекубиталната ямка, по воларната повърхност на предмишницата, пресичащ гъвкателната бразда на китката в Z-образна форма) с освобождаване на карпалния тунел. Дорзален разрез се добавя при необходимост от освобождаване на дорзалния компартмент.
...
*Mémoires* на Лярей (1812) дава основополагащата доктрина на бойнополевия артериален контрол — лигиране, компресия и ампутация. Модерната ера на съдовата реконструкция започва с използването от Goyanes през 1906 г. на венозен графт за артериална подмяна (Мадрид, две години преди Carrel) — макар оригиналната испанска статия да не е достъпна като директно archive.org факсимиле, испанската биографична литература възпроизвежда оригиналните диаграми. Описанието на исхемичната контрактура от Volkmann (1881, *Cbl. Chir.*) открива литературата за compartment syndrome.

- **Лярей** (1812): *Mémoires de chirurgie militaire et campagnes*, том 2. · [Факсимиле](https://archive.org/details/mmoiresdechiru02larr)
- **Лексер** (1904): *Lehrbuch der allgemeinen Chirurgie*, том 2 — съдова увреда. · [Факсимиле](https://archive.org/details/lehrbuchderallg01lexegoog)
