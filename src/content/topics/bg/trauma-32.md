...
<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/trauma-32/fasciotomy.jpg" data-figure-alt="Фасциотомия при компартмент синдром" aria-label="Увеличи">
    <img src="/img/trauma-32/fasciotomy.jpg" alt="Фасциотомия при компартмент синдром" loading="lazy" decoding="async" />
  </button>
  <figcaption>
    <span class="md-figure-caption">Фасциотомия при компартмент синдром — спешна декомпресия чрез отваряне на засегнатите фасциални отделения; забавяне над 8 часа води до необратима исхемична некроза.</span>
