...
Концепцията за „споделяне на натоварването“ (load sharing) срещу „носене на натоварването“ (load bearing) е също важна. Имплант, споделящ натоварването, предава част от него през костните фрагменти; имплант, носещ натоварването, предава цялото натоварване през самия имплант. Заключващите плаки и интрамедуларните пирони могат да функционират като импланти, носещи натоварването, когато образецът на фрактурата не позволява репозиция и директен костен контакт; те функционират като импланти, споделящи натоварването, когато костните фрагменти са репонирани и участват в предаването на натоварването.

<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Съобразете механичната среда с фрактурата: абсолютна стабилност (lag screw, компресионна плака, tension band) при прости ставни и избрани диафизарни фрактури дава директно костно зарастване; относителна стабилност (мостовидна плака, интрамедуларен пирон, ВКО) при разтрошени диафизарни модели води до зарастване с callus.</p>
</aside>
...
Безглави компресионни винтове: Самокомпресиращи се винтове без глава, предназначени да останат скрити вътре в костта (Herbert screw, Acutrak и др.). Използват се при фрактури на скафоидната кост, таранната кост, фиксация на остеохондрални фрагменти и при други приложения, при които изпъкнала глава на винта би представлявала проблем.
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Lag screw се определя от техниката, а не от вида на винта: близкият (плъзгащ) отвор трябва да е по-широк от резбата, така че винтът да плъзга през него и да захваща само далечния фрагмент, предизвиквайки интерфрагментарна компресия. Позиционният винт, за разлика, държи два фрагмента на фиксирано разстояние (класически синдесмозата).</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Функциите на плаките се определят от техниката: компресионна (ексцентрично пробиване за интерфрагментарна компресия), неутрализационна (защитава отделен lag screw), подпорна (противостои на метафизарен колапс, класически при медиалното тибиално плато), мостовидна (мост над разтрошена зона, относителна стабилност) и tension band (превръща физиологичното опъване в компресия на срещуположния кортекс).</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Разстърганите заключващи интрамедуларни пирони са стандарт при повечето диафизарни фрактури (по-добро прилягане и фиксация), но разстъргването освобождава мазнина и костен мозък в кръвообращението. При тежки открити фрактури и политравма с гръдно увреждане се предпочитат неразстъргани пирони или стадийна конверсия, за да се ограничи мастно-емболичното увреждане.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Външната фиксация е работният кон при damage control: временна стабилизация при политравма, тежки открити фрактури с компрометирани меки тъкани и тазови наранявания с хемодинамична нестабилност. Инфекцията около щифтовете е основната дългосрочна грижа и изисква прецизен контрол на местата на щифтовете.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Класическите места за tension band са олекранонът и пателата, при които екстензорната тяга на напречна фрактура опъва дорзалната/предната страна и компресира срещуположния кортекс. Тел в осемка от страната на опъване превръща опъването в компресия на фрактурата при активно движение.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Окончателното интрамедуларно пироноване на бедрена диафизарна фрактура при пациент с политравма и значимо гръдно увреждане може да влоши белодробния статус чрез мастно-емболична и възпалителна каскада. Алтернативата на damage control е първоначална външна фиксация, реанимация и конверсия към пирон след стабилизиране на физиологията.</p>
</aside>
