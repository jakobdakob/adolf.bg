...
Класификацията на Gustilo-Anderson, първоначално описана през 1976 г. и прецизирана през 1984 г., е универсалният стандарт за класификация на откритите фрактури:
...
<aside class="callout callout-pearl">
  ...
  <p>Запомнете Gustilo-Anderson по риск от инфекция: I (под 1 cm, чиста) 0-2%; II (1-10 cm, умерено увреждане) 2-7%; III (над 10 cm ИЛИ обширно увреждане ИЛИ високоенергийно ИЛИ контаминация ИЛИ ферма/огнестрелно/сегментарно) 7-25%. IIIA има адекватно покритие, IIIB изисква лоскут, IIIC включва съдово увреждане. Класифицирайте след дебридмана, не преди него.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Антибиотиците в рамките на първия час от постъпването са единствената най-важна интервенция за намаляване на инфекцията при открити фрактури. Цефалоспоринът от първа генерация (цефазолин) покрива тип I-II; при тип III се добавя аминогликозид; при наранявания от ферма или грубо контаминирани рани се добавя пеницилин за анаеробно покритие.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Класическото „6-часово правило“ за дебридмана е омекнало: сроковете на антибиотиците имат по-голямо значение от тези на дебридмана, като 12-24 часа са приемливи в повечето центрове. Проучването FLOW показа, че нисконаляганото напояване с физиологичен разтвор не отстъпва на високоналяганото и е по-добро от сапунен разтвор; оценявайте мускула по четирите „C“ (цвят, консистенция, контрактилност, капацитет за кървене).</p>
</aside>

## Дългосрочни проблеми

Основните дългосрочни грижи след открита фрактура включват: инфекция (остра, хронична, като биофилм-свързаната имплантна инфекция е особено трудна за лечение); псевдоартроза (значително повишена честота в сравнение с закрити фрактури); мекотъканен компромис; и разлика в дължината на крайниците при костна загуба.
...
Огнестрелните фрактури при ниска скорост се лекуват с: локална грижа за раната (напояване, дебридман на некротична тъкан по ръбовете на раната, задържане или отстраняване на куршума според клиничните съображения); интравенозни антибиотици (цефазолин за 24-48 часа при повечето протоколи); тетанусна профилактика; лечение на фрактурата, съобразено с образеца на фрактурата. Самият куршум като цяло се оставя на място, освен ако не е на проблемна локализация (вътреставно, в близост до основен нерв или съд, в подкожна тъкан, предизвикваща симптоми).
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Скоростта, не калибърът, определя лечението. Нискоскоростните (под 600 m/s) пистолетни рани обикновено са Gustilo I-II с локална грижа, венозен цефалоспорин и тетанусна профилактика; високоскоростните пушечни и близкоразстояционните ловно-пушечни рани са наранявания от тип III, налагащи формален дебридман и широкоспектърни антибиотици.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Crush синдромът при реперфузия се проявява с хиперкалиемия (риск от сърдечен арест), миоглобинурия с остра тубуларна некроза (класическата „чаена урина“), метаболитна ацидоза, хипокалциемия и компартмент синдром на засегнатия крайник. Започвайте големообемна кристалоидна реанимация преди извличането, когато е възможно, и целете диуреза 200-300 mL/h.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>MESS оценява скелетното/мекотъканното увреждане (1-4), крайниковата исхемия (1-3, удвоена при над 6 часа), шока (0-2) и възрастта (0-2). Резултат 7 или повече исторически се е считал за предсказателен за ампутация, но съвременната практика гледа на него като на един от факторите, а не като на твърдо правило.</p>
</aside>
