...
<aside class="callout callout-pearl">
  ...
  <p>Триадата на Virchow управлява ортопедичния ВТЕ: венозен застой (залежаване, турникет), увреждане на ендотела (тазобедрена артропластика, термичен ефект на цимента) и хиперкоагулабилност от хирургичния стресов отговор. Тазовите/ацетабуларните фрактури (около 60% без профилактика) и увреждането на гръбначния мозък (около 80% без профилактика) дават най-високите ортопедични нива на ВТЕ.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Скорът на Caprini стратифицира хирургичния риск от ВТЕ и определя интензивността на профилактиката; скорът на Wells насочва диагностичната стратегия при симптомния пациент. D-димерът е практически универсално повишен постоперативно и затова е с ограничена полезност при ортопедичния пациент — използвайте Wells с образна диагностика, а не D-димер за изключване.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Дуплекс ехографията е първа линия за ДВТ — чувствителност над 95% за феморо-поплитеална, но само около 70% за изолирана прасечна ДВТ. КТ-пулмоналната ангиография е заменила V/Q сцинтиграфията за БТЕ (чувствителност и специфичност над 95%), като V/Q остава при бъбречна недостатъчност, алергия към контраст или бременност.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Запомнете продължителността на профилактиката: 28-35 дни след ТТА и фрактура на бедрото, 10-14 дни след ТКА (по-дълго при висок риск), без рутинна удължена профилактика след артроскопия или изолирана хирургия на стъпало/глезен, и до мобилизиране при политравма или гръбначномозъчно увреждане (безсрочно при трайна спинална лезия).</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Стратифицирайте БТЕ по хемодинамика: нискорискова (стабилна, без обременяване на дясната камера) — само антикоагулация; субмасивна (дясно-камерна дисфункция или повишен тропонин при нормотония) — внимателно проследяване и обмисляне на катетър-насочена тромболиза; масивна (трайна хипотония или шок) — индикация за системна алтеплаза 100 mg за 2 часа или емболектомия.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Критерии на Gurd и Wilson за СМЕ: главни — петехиален обрив, дихателна недостатъчност и мозъчно ангажиране; второстепенни — тахикардия над 110, температура над 38,5°C, ретинални промени, бъбречни промени, тромбоцитопения, анемия, повишена СУЕ и мастна макроглобулинемия. Диагнозата изисква един главен плюс четири второстепенни или два главни плюс маст в урината или храчките.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Интрамедуларното разширяване генерира налягане 400-1200 mmHg и предизвиква емболичен поток, видим в реално време при трансезофагеална ехография. При нестабилен пациент с политравма и установено белодробно увреждане предпочитайте damage control външна фиксация с отложено пироноване; когато пиронът е необходим, системата Reamer-Irrigator-Aspirator (RIA) значително намалява емболичния товар.</p>
</aside>
...
Мастната емболия след дълга костна фрактура е първо систематично описана от Zenker (1862, *Beiträge zur normalen und pathologischen Anatomie der Lungen*) и доведена в клиничния фокус от Czerny (1875). Субстратът на венозната тромбоза след имобилизация е артикулиран от триадата на Virchow от 1856 г. Билрот (1882) дава хирургично-патологичния синтез.

- **Билрот** (1882): *Allgemeine chirurgische Pathologie und Therapie* — емболия и тромбоза. · [Факсимиле](https://archive.org/details/dieallgemeinechi1882bill)
- **Лексер** (1904): *Lehrbuch der allgemeinen Chirurgie*, том 1 — пост-травматични усложнения. · [Факсимиле](https://archive.org/details/lehrbuchderallg01lexegoog)
