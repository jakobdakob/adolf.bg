...
<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/trauma-8/nonunion.jpg" data-figure-alt="Псевдоартроза (несрастване)" aria-label="Увеличи">
    <img src="/img/trauma-8/nonunion.jpg" alt="Псевдоартроза (несрастване)" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pearl">
  ...
  <p>Забавено срастване е неуспех да се прогресира в очакваните 12-16 седмици за фрактура на дълга кост при възрастен, с все още протичащо зарастване. Псевдоартрозата по FDA е без прогресия в 3 последователни месеца при минимум 9 месеца от травмата; европейската дефиниция е по-проста — необходима е допълнителна интервенция за срастване.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Класификацията на Weber-Cech насочва лечението: хипертрофична („слонски крак“, „копито на кон“) има запазена биология и изисква механично укрепване; атрофичната има конусовидни остеопоротични краища и изисква биология (автоприсадка, BMP) плюс стабилност; олиготрофичната е междинна. Винаги изключвайте инфекция преди всяка ревизия.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Диамантената концепция (Giannoudis) изброява четири ъгъла на зарастването: остеокондуктивен скафолд, остеоиндуктивни сигнали, остеогенни клетки и стабилна механична среда. Тютюнопушенето приблизително удвоява риска от псевдоартроза при тибиалния диафиз; класически рискови места са средната трета на ключицата, бедреният и тибиалният диафиз, скафоидът, бедрената и таларната шийка и проксималният диафиз на пета метатарзална кост.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Съобразете лечението с типа псевдоартроза. Хипертрофична — конверсия към по-стегната конструкция (нерядко exchange nailing с 1-2 mm по-голям пирон). Атрофична — добавете биология (илиачна автоприсадка, RIA-добив или BMP). Сегментна загуба над 3-4 cm — Masquelet индуцирана мембрана, bone transport по Ilizarov с около 1 mm/ден или съдово-захранена фибула.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Контрактурата на Volkmann е краен стадий на нелекуван компартмент синдром на предмишницата, класически след супракондиларна фрактура при дете с увреждане на брахиалната артерия. Най-тежко са засегнати flexor digitorum profundus и flexor pollicis longus. Профилактиката с декомпресия на острия компартмент синдром е далеч по-ефективна от която и да е реконструкция след установяване на контрактурата.</p>
</aside>

## Комплексен регионален болков синдром

Комплексният регионален болков синдром (КРБС) е хроничен болков синдром, характеризиращ се с диспропорционална, регионална болка със сетивни, моторни, автономни и трофични промени. Състоянието има дълга и объркваща номенклатура — описано е от Silas Weir Mitchell при ветерани от Гражданската война като каузалгия, наречено рефлекторна симпатикова дистрофия от Evans през 1946 г., и известно в германската литература като атрофия на Sudeck след описанието на посттравматичната остеопороза от Paul Sudeck през 1900 г. Съвременната номенклатура, установена от консенсус на IASP през 1994 г. и усъвършенствана в будапещенските критерии от 2007 г., разделя синдрома на КРБС тип I (без идентифицируемо нервно увреждане, по-рано RSD) и КРБС тип II (с идентифицируемо нервно увреждане, по-рано каузалгия).
...
ерготерапия с десенситизация, градирана моторна образност и огледална визуална обратна връзка (протоколът на Moseley) са крайъгълен камък. Фармакологичните агенти включват габапентин и прегабалин за невропатна болка, трициклични антидепресанти в ниска доза (амитриптилин), NMDA-антагонисти (кетамин при избрани случаи) и бисфосфонати (особено интравенозен памидронат или перорален алендронат, с малка доказателствена база при ранен КРБС). Симпатиковите блокади (блокада на звездовидния ганглий за горния крайник, лумбална симпатикова блокада за долния крайник) имат дълга история и осигуряват диагностична и краткосрочна терапевтична стойност, макар дългосрочният им ефект върху естествения ход да е неясен. Стимулацията на гръбначния мозък е запазена за рефрактерни случаи. Профилактичното приложение на висока доза витамин C (500 mg дневно за 50 дни) след фрактура на дисталния радиус е показало скромна ефикасност в едно френско мултицентрово проучване (Zollinger et al., 1999, 2007) и сега е широко препоръчвано.

<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Диагностицирайте КРБС по будапещенските критерии: персистираща диспропорционална болка плюс поне един симптом в три от четири категории (сетивни, вазомоторни, судомоторни/оточни, моторни/трофични) и поне един знак в две категории, без по-добра друга диагноза. След фрактура на дисталния радиус витамин C 500 mg дневно за 50 дни (проучване Zollinger) е проста профилактична мярка с доказана ефикасност.</p>
</aside>
...
При тотална тазобедрена артропластика класификацията на Vancouver (Duncan и Masri, 1995) е универсално използвана и структурира лечебния подход. Класификацията взема предвид три променливи: локализация, стабилност на импланта и костен запас.
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Класификацията на Vancouver при перипротезни тазобедрени фрактури се основава на стабилността на стеблото и костния запас. Тип A е трохантерен; B1 — добре фиксирано стебло (ORIF с дълга заключваща плака и кабели); B2 — разхлабено стебло с адекватна кост (ревизионно стебло); B3 — разхлабено стебло с дефицитна кост (алографтна протезна композиция или мегапротеза); C — дистално от върха и се лекува като нативна фрактура на дисталното бедро.</p>
</aside>
