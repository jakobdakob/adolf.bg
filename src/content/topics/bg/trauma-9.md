...
<aside class="callout callout-pearl">
  ...
  <p>Познавайте микроорганизма според гостоприемника: Staphylococcus aureus при около половината възрастни; стрептококи в още 20%; Neisseria gonorrhoeae при сексуално активни млади хора (с мигриращата триада полиартралгия-тендосиновит-дерматит); Грам-отрицателни при интравенозни наркомани и имунокомпрометирани; Kingella kingae при деца под 2 години.</p>
</aside>

## Клинична картина и изследвания

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/trauma-9/septic-arthritis-hip.jpg" data-figure-alt="Септичен артрит на тазобедрената става" aria-label="Увеличи">
    <img src="/img/trauma-9/septic-arthritis-hip.jpg" alt="Септичен артрит на тазобедрената става" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pitfall">
  ...
  <p>Нативната септична става не може да се очисти само с антибиотици — аваскуларният хрущял е убежище, затова винаги пунктирайте преди антибиотиците и дренирайте спешно. При деца септичната тазобедрена става е истинска спешност, налагаща открита артротомия, тъй като вътреставното налягане застрашава кръвоснабдяването на главата, а необратими хрущялни увреждания започват на 3-7-я ден.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Cierny-Mader класифицира хроничния остеомиелит по две оси. Анатомична: I медуларен, II повърхностен, III локализиран пълнодебелинен, IV дифузен с механична нестабилност. Гостоприемник: A нормален, B компрометиран (Bs системно, Bl локално), C палиация (лечението е по-лошо от болестта).</p>
</aside>

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/trauma-9/osteomyelitis-involucrum.jpg" data-figure-alt="Involucrum при хроничен остеомиелит" aria-label="Увеличи">
    <img src="/img/trauma-9/osteomyelitis-involucrum.jpg" alt="Involucrum при хроничен остеомиелит" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Не разчитайте на намазка от синусов тракт — отглежда колонизатори, а не дълбокия патоген. По време на дебридман изпращайте поне пет дълбоки тъканни проби за аеробна, анаеробна и (при необходимост) гъбична и микобактериална посявка. Сонификацията на експлантирани импланти значително увеличава диагностичната ефективност срещу биофилмово защитените микроорганизми.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Имплант-асоциираният остеомиелит обикновено налага отстраняване на импланта, тъй като биофилмът повишава MIC с порядъци. Стратегията DAIR (дебридман, антибиотици, задържане на имплант) има 30-70% успех и е запазена за ранна инфекция (в първите 3-6 седмици след операцията), чувствителен микроорганизъм и интактни меки тъкани. „Знакът на паприката“ — точково кървене — определя жизнеспособната кост при дебридман.</p>
</aside>
