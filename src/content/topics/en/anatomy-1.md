...
The patient is prone, with the head supported in a Mayfield head holder or horseshoe; pin fixation provides the most stable positioning for complex procedures. The neck is flexed slightly to open the posterior elements (“military tuck” position), with attention to avoiding excessive flexion that could compromise spinal cord perfusion. The shoulders are

pulled caudally with tape to allow fluoroscopic imaging of the lower cervical levels. Reverse Trendelenburg position reduces venous engorgement and bleeding.
