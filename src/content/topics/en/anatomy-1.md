...
<details class="topic-toc-inline">
  ...
  <ol>
    ...
    <li><a href="#surg-anatomy">Surgical Anatomy</a>
      <ol>
        <li><a href="#vertebral-column">Regional Vertebral Anatomy</a></li>
        <li><a href="#vertebral-artery">Vertebral Artery — Segments and Danger Zones</a></li>
        <li><a href="#spinal-cord">Spinal Cord and Roots</a></li>
        <li><a href="#prevertebral">Prevertebral Visceral Structures</a></li>
        <li><a href="#brachial-plexus">Brachial Plexus and Thoracic Outlet</a></li>
        <li><a href="#lumbosacral-plexus">Lumbosacral Plexus within Psoas</a></li>
      </ol>
    </li>
...
The general vertebral pattern includes a body anteriorly, a vertebral arch posteriorly (pedicles, laminae, transverse processes, spinous process, articular processes) and a vertebral foramen transmitting the spinal cord and its coverings. Regional variations along the spine reflect functional adaptation.

**Craniocervical junction.** The foramen magnum is oval, with a mean sagittal diameter of 34.7 mm (range 29.5–43.5) and transverse diameter of 27.9 mm (range 23–32). The occipital condyles (OC), articulating with the C1 superior facets, converge medially at about 30° toward the basion (the anterior midpoint of the foramen magnum); mean dimensions 23.6 × 10.6 × 9.2 mm; in 57% of skulls the OC protrudes into the foramen magnum. The hypoglossal canal runs anterolaterally at 45° to the sagittal plane with a mean length of 12.6 mm, lying on average 9.8 mm (range 7.5–12.2) from the posterior border of the condyle — a distance that defines the maximum safe condylar resection in the transcondylar approach. Exposure via suboccipital craniotomy increases 2.4° for every millimetre of OC removed; complete condylar resection increases visualisation of the clivus only marginally (from 21% to 28%), whereas jugular tubercle resection dramatically increases exposure to as much as 71%.

**Cervical vertebrae (C1–C7).** Small, shallow bodies; bifid spinous processes (except C1); transverse processes contain the foramen transversarium for the vertebral artery (typically C1–C6, entering at C6); uncinate processes on the superior surface of C3–C7 form the uncovertebral (Luschka) joints; C1 (atlas) is a ring without a body, articulating superiorly with the occipital condyles; C2 (axis) bears the dens projecting superiorly to articulate with the anterior arch of C1; C7 has a particularly long spinous process (vertebra prominens).

**Atlas (C1) morphometry.** The C1 lateral mass (the anchor for Goel-Harms lateral-mass screws) is trapezoidal — wider laterally, narrower medially — with a medial height of 8.8 mm, lateral height of 18.0 mm, and sagittal (AP) depth of 19.7 mm. Recommended bicortical screw trajectory: mean depth 19.3 mm in the axial plane and 20.9 mm in the sagittal, with an upward entry angle of 33–37° to avoid the vertebral artery V3 segment above the lateral mass. Recommended medial convergence 10–15°. Anatomic variants of the vertebral artery (hypoplastic, dominant on one side with compensation from the other, posteriorly displaced) occur in about 10% of the population and mandate preoperative CT angiography.

**Axis (C2).** The body and dens develop from six ossification centres with synchondrosis closure by age 3–5 years; failure of closure (os odontoideum vs. persistent ossiculum terminale) presents clinically as atlantoaxial instability. The C2 pars interarticularis is narrow (mean 7–8 mm) and defines the length and trajectory of the isthmic (Magerl) screw; the C2 pedicle screw is more robust but demands caution because of the proximity of the vertebral artery in the foramen transversarium.
...
**Subaxial cervical levels (C3–C7).** Pedicles are narrow and medially angled 30–45° (smaller and more angled than lumbar pedicles). A safe pedicle screw requires preoperative CT planning — pedicle width below 4.5 mm is usually a contraindication for pedicle fixation and an indication for a Magerl/Roy-Camille lateral-mass screw. Safe lateral-mass trajectory: 25° lateral and 30° cranial, 14–16 mm long.
...
<figure class="md-figure">
  ...
  <figcaption>
    <span class="md-figure-caption">Cervical vertebrae (C1–C7), lateral view: small flat bodies, bifid spinous processes (C3–C6), C7 with a particularly long, undivided spinous process (vertebra prominens); uncinate processes on the superior surface of C3–C7 form the uncovertebral (Luschka) joints; the foramina transversaria transmit the vertebral artery from C6 (entry) to C2.</span>
...
**Thoracic vertebrae (T1–T12).** Intermediate-size bodies with costal facets (demifacets on the superior and inferior aspects for the rib heads, and a facet on the transverse process for the rib tubercle); long, inferiorly angled spinous processes (T5–T8 the most caudally angled, projecting roughly one vertebral body below their level); facet joint orientation permits limited rotation but restricts flexion-extension. Thoracic pedicles are narrowest at T4–T6 (4–5 mm width), making thoracic pedicle screw instrumentation technically demanding.

**Lumbar vertebrae (L1–L5).** Large bodies; stout spinous processes projecting posteriorly; mammillary and accessory processes are useful surgical landmarks; facets are oriented sagittally (permitting flexion-extension) but with progressively more coronal orientation toward L5–S1; L5 occupies the most caudal position, with transitional anomalies (lumbarisation, sacralisation) in approximately 5% of the population. Lumbar pedicles are wide (10–18 mm at L4–L5), permitting reliable pedicle screw instrumentation without routine CT navigation.
...
<figure class="md-figure">
  ...
  <figcaption>
    <span class="md-figure-caption">Course of the vertebral artery through its four segments: V1 (pre-transversarial, in the angle between m. longus colli and m. scalenus anterior), V2 (through foramina transversaria from C6 to C2), V3 (the characteristic suboccipital loop over the lateral mass of C1 and posterior arch of the atlas), and V4 (intradural, joining its counterpart to form the basilar artery); the basis for the surgical risk in posterior cervical approaches, occipito-cervical fixation, and the lateral cervical approach.</span>
...
The vertebral artery traverses four anatomically distinct segments. **V1** is the pre-transversarial segment between the subclavian origin and entry into the foramen transversarium of C6, lying in the angle between m. longus colli and m. scalenus anterior. **V2** is the transversarial segment passing through the foramina transversaria from C6 to C2 — the artery runs vertically, surrounded by a dense vertebral venous plexus. **V3** is the suboccipital segment that exits the C2 foramen transversarium and describes a double loop — a first (oblique) loop above the C2 lamina and a second (horizontal) loop over the C1 lateral mass and posterior arch of the atlas — before entering the dural sac through the posterior atlantooccipital membrane. **V4** is the intradural segment that joins its counterpart to form the basilar artery and supplies the posterior circulation.

**Danger zones by segment.** At the V3 loop, the lateral limit of safe subperiosteal dissection along the posterior arch of the atlas is 1.5 cm from the midline — beyond this distance the loop becomes endangered with risk of catastrophic haemorrhage; the artery enters the posterior atlantooccipital membrane at its lateral angle, making it extremely vulnerable during dissection of this membrane. At the V2 segment, C2 screws without preoperative CT angiography risk breach of the foramen transversarium, especially with an anatomic variant ("high-riding" artery close to the medial wall of the foramen). At the V1 segment in the lateral cervical approach, the artery is at risk during dissection in the angle between m. longus colli and m. scalenus anterior, where it runs vertically upward. About 10% of the population have a hypoplastic or variant vertebral artery (dominant on one side with compensation from the other), so unilateral ligation in the setting of a hypoplastic contralateral artery is directly dangerous — preoperative flow assessment is mandatory before any lateral approach or any planned ligation.

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/anatomy-1/atlas-axis-from-above.png" data-figure-alt="Atlas and axis, superior view" aria-label="Enlarge">
    <img src="/img/anatomy-1/atlas-axis-from-above.png" alt="Atlas and axis, superior view" loading="lazy" decoding="async" />
  </button>
  <figcaption>
    <span class="md-figure-caption">Atlas and axis, superior view: the dens of C2 articulates with the anterior arch of C1 and is held dorsally by the transverse ligament of the atlas; head rotation (≈50% of total cervical rotation) occurs at C1–C2; the foramina transversaria of C1 demonstrate the looping course of the vertebral artery before the V3 segment — explaining why C1 lateral mass screws must be placed along a converging, cranially directed trajectory.</span>
...
<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/anatomy-1/spinal-cord-xs.png" data-figure-alt="Cross-section of the spinal cord" aria-label="Enlarge">
    <img src="/img/anatomy-1/spinal-cord-xs.png" alt="Cross-section of the spinal cord" loading="lazy" decoding="async" />
  </button>
  <figcaption>
    <span class="md-figure-caption">Diagrammatic cross-section of the spinal cord and its meninges: dura mater, arachnoid, pia mater, and anterior and posterior roots; essential for approaches to the spinal canal and assessment of spinal trauma.</span>
...
<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/anatomy-1/spinal-cord-segments.png" data-figure-alt="Spinal cord with nerve roots" aria-label="Enlarge">
    <img src="/img/anatomy-1/spinal-cord-segments.png" alt="Spinal cord with nerve roots" loading="lazy" decoding="async" />
  </button>
  <figcaption>
    <span class="md-figure-caption">Spinal cord in its meningeal coverings with paired anterior and posterior roots forming the spinal nerves: cervical (8 pairs), thoracic (12), lumbar (5), sacral (5), and coccygeal; the conus medullaris typically ends at L1–L2, below which the cauda equina continues — the anatomical basis for safe lumbar puncture and for lumbar surgical approaches below the conus.</span>
...
**Superior laryngeal nerve.** Runs with the superior thyroid vessels at the upper cervical border (around C3); its external branch innervates m. cricothyreoideus and must be preserved during upper cervical exposure, because injury produces a chronic loss of high vocal range and early vocal fatigue (a major concern in singers and teachers).

**Carotid (Chassaignac) tubercle of C6.** Enlargement of the anterior tubercle of the C6 transverse process, larger than other vertebral tubercles; a digital landmark in anterior cervical exposure and a reliable marker for the C6 level.

**Cervicothoracic junction.** The thoracic duct drains into the left subclavian vein at T1–T2 — the anatomical basis for preferring a right-sided approach at C7–T1.

**Thoracic region.** Aorta on the left, inferior vena cava on the right (below the diaphragm), v. azygos on the right and v. hemiazygos on the left (within the chest), segmental intercostal vessels and nerves at the inferior border of each rib, and the thoracic duct in the posterior mediastinum.
...
**Zonal model for lateral transpsoas approaches (Moro et al., 2003).** The lateral surface of the disc space is divided into four zones (I–IV) according to position from the anterior to the posterior margin. Zone I (anterior third) — low risk of nerve injury; zone II — acceptable risk; zone III — increased risk (nerve trunks nearby); zone IV (posterior third) — high risk (n. genitofemoralis anteriorly, n. femoralis posteriorly). At the lower lumbar levels (L4–L5) the lumbar plexus and femoral nerve migrate anteriorly, increasing risk during the typical mid-disc transpsoas approach. Neuromonitoring (trigger EMG and continuous EMG) is mandatory during psoas splitting precisely because of this zonal anatomy.
...
<figure class="md-figure">
  ...
  <figcaption>
    <span class="md-figure-caption">Sacral plexus (L4–S4): formed by the anterior rami of L4–L5 (lumbosacral trunk) and S1–S4, lying on m. piriformis in the pelvis and giving off branches including the sciatic nerve (S1–S3), superior gluteal (L4–S1), and pudendal (S2–S4); awareness of this topography is critical in sacral fractures and in anterior and posterolateral approaches to the sacrum.</span>
...
In the subaxial cervical spine, flexion-extension is distributed relatively evenly across C3–C7, each segment contributing 12–17°. Rotation and lateral bending are coupled motions due to facet orientation.

The thoracic spine is relatively rigid because of the rib-sternal cage; T1–T4 has minimal mobility. The thoracolumbar junction (T11–L2) is the zone of maximal stress concentration at the transition between the rigid thoracic and mobile lumbar spine — the typical site of traumatic flexion-distraction fractures.

The lumbar spine has predominantly sagittal facet orientation (flexion-extension), with progressive coronal orientation toward L5–S1. Lumbar lordosis (L1–S1) averages 60° (range 30–80°), with roughly 67% located at the lower two segments L4–S1.
...
For anterior lumbar approaches, the line through the iliac crests passes roughly through the L4–L5 interspace (the "Tuffier line") — a rough guide for which fluoroscopic confirmation is mandatory; individual variation can reach +/− one level (especially in transitional vertebrae). For posterior lumbar approaches, the intercristal line, the S2 tip (PSIS), and palpation of the spinous processes (L4 approximately at the level of the iliac crest) serve as primary landmarks.

Intraoperatively the level is confirmed by lateral fluoroscopy. In multilevel cases preoperative needle marking of a spinous process and a control radiograph are standard procedure. CT navigation and robotic instrumentation (O-arm, Mazor, ExcelsiusGPS) are the modern trend for pedicle screw instrumentation in the lumbar and thoracic spine.

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/anatomy-1/cervical-spine-mri.jpg" data-figure-alt="Cervical spine MRI" aria-label="Enlarge">
    <img src="/img/anatomy-1/cervical-spine-mri.jpg" alt="Cervical spine MRI" loading="lazy" decoding="async" />
  </button>
  <figcaption>
    <span class="md-figure-caption">Sagittal cervical MRI (T2-weighted) — shows vertebral bodies, discs, the spinal cord in its meningeal coverings, and the craniocervical junction; mandatory imaging after severe cervical trauma to detect cord oedema, disc injury, and ligamentous damage (SCIWORA syndrome).</span>
...
<figure class="md-figure">
  ...
  <figcaption>
    <span class="md-figure-caption">Sagittal T2 MRI of the lumbar spine: normal disc heights and signal, physiological lordosis, spinal canal; basis for planning the anterior retroperitoneal approach and assessing disc degeneration.</span>
...
<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/anatomy-1/disc-herniation-mri.svg" data-figure-alt="Lumbar disc herniation schematic MRI" aria-label="Enlarge">
    <img src="/img/anatomy-1/disc-herniation-mri.svg" alt="Lumbar disc herniation schematic MRI" loading="lazy" decoding="async" />
  </button>
  <figcaption>
    <span class="md-figure-caption">Lumbar disc herniation, schematic MRI: an extruded disc fragment compresses the traversing nerve root in the lateral recess and/or neural foramen. Surgical indications for discectomy (from Caspar 1977 microdiscectomy to Yasargil 1968 microsurgery) rest on correlation between clinical radiculopathy and imaging; pure axial lumbar pain without radiculopathy rarely requires discectomy.</span>
...
**By column:** anterior / posterior / posterolateral (costotransversectomy) / lateral.

**By cavity:** transcavitary (transthoracic, transabdominal, transperitoneal), extracavitary (extraperitoneal, extrapleural, retropharyngeal), transoral.

**By invasiveness:** open / minimally invasive (MIS, tubular, endoscopic, percutaneous).

**By aim:** decompression / stabilisation / vertebrotomy for deformity correction / biopsy / drainage.
...
<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/anatomy-1/halo-brace.png" data-figure-alt="Halo brace for cervical immobilisation" aria-label="Enlarge">
    <img src="/img/anatomy-1/halo-brace.png" alt="Halo brace for cervical immobilisation" loading="lazy" decoding="async" />
  </button>
  <figcaption>
    <span class="md-figure-caption">Halo brace for cervical traction and stabilisation: four-point skull fixation (two parietal and two frontal screws) with a ring connected to a thoracic vest by vertical rods; the classical Bulgarian construct of Kaymakchiev, Tanchev, and Stefanov (1982) uses a ring with a smaller superior than inferior diameter, allowing perpendicular screw insertion with more stable purchase.</span>
...
<details>
<summary>Anterior Cervical Approach (Smith-Robinson)</summary>
<div class="ts-body">
...
**Indications.** Discectomy (Cloward 1958, ACDF Smith-Robinson 1958); interbody fusion; removal of uncovertebral or anterior/posterior vertebral body osteophytes; tumour resection with bone grafting; biopsy; abscess drainage; open reduction and internal fixation of fractures; myelopathy decompression.

**Positioning.** Supine with a small roll between the shoulders for neck extension; head slightly turned away from the side of approach. Shoulders depressed by traction tape. Table tilted 30° head-up to reduce venous bleeding. Halter or pin traction as required.

**Landmarks.** Palpable midline references: hard palate (C1), lower mandibular border (C2–C3), hyoid (C3), upper thyroid cartilage (C4–C5), cricoid cartilage (C6), Chassaignac tubercle of C6, sternoclavicular joint (T2). A transverse skin-crease incision from the midline to the posterior border of m. sternocleidomastoideus — excellent cosmetic result.

**Internervous plane.** Superficially — between m. sternocleidomastoideus (n. accessorius, CN XI) and the strap muscles (segmental C1–C3); more deeply — between left and right m. longus colli (segmental C2–C7).

**Surgical anatomy and technique.** The platysma is split along its fibres in the line of the skin incision — its facial-nerve (CN VII) innervation is high up at the mandibular region, so splitting does not denervate it. The fascia along the anterior border of m. sternocleidomastoideus is incised; the muscle is retracted laterally. The carotid sheath (common carotid, internal jugular, vagus) is opened in the avascular plane between the sheath (laterally) and the strap muscles and trachea (medially); the pretracheal fascia is divided on the medial side of the sheath. The superior and inferior thyroid vessels may cross the field in extended exposures — ligation may be necessary in rare cases, with mandatory preservation of the superior laryngeal nerve, which runs with the superior thyroid vessels. The prevertebral fascia is opened and the longi colli muscles are elevated subperiosteally from the body and the lateral surfaces of the vertebral body; the retractors are placed beneath them, protecting the recurrent laryngeal nerve, trachea, and oesophagus.

**Dangers.** Recurrent laryngeal nerve — in the deep layer of the approach; protected by placing retractors deep beneath the medial edge of m. longus colli; the left is more predictable (vertical in the tracheo-oesophageal groove around the aortic arch), the right more variable, and in rare cases (about 0.5%) "non-recurrent". Sympathetic chain and stellate ganglion — on the lateral surface of m. longus colli; protected by subperiosteal dissection from the midline and a prohibition on dissection over the transverse processes; injury causes Horner's syndrome (miosis, ptosis, anhidrosis). Carotid sheath — protected by the anterior border of m. sternocleidomastoideus; self-retaining retractors must not be placed in this zone, only hand-held with rounded ends. Vertebral artery — within the foramen transversarium; should not be visible unless dissection strays well off midline. Inferior thyroid artery — may cross the field in lower cervical approaches; if accidentally divided it retracts behind the carotid sheath where it is hard to retrieve. Oesophagus — a fragile structure easily injured by injudicious retraction.
...
**Positioning.** Prone, head in a Mayfield holder or horseshoe; the neck is slightly flexed ("military tuck"), avoiding excessive flexion. Shoulders depressed caudally with tape. Reverse Trendelenburg reduces venous engorgement.

**Surgical anatomy.** Midline approach through the ligamentum nuchae (avascular); subperiosteal elevation of m. trapezius, splenius capitis, splenius cervicis, semispinalis capitis, semispinalis cervicis and the deeper short muscles from the spinous processes and laminae. The lateral limit of safe dissection is the lateral border of the facet — beyond it lies the vertebral artery in the foramen transversarium and the dorsal branches of the cervical nerves.
...
<figure class="md-figure">
  ...
  <figcaption>
    <span class="md-figure-caption">A typical thoracic vertebra, lateral view: costal facets (demifacets on the superior and inferior margins of the body for the rib heads; a complete facet on the transverse process for the rib tubercle); long, caudally angled spinous processes (T5–T8 projecting ~1 level below their own body) — important for planning the thoracotomy incision, costotransversectomy, and intraoperative level identification.</span>
...
**Structures.** Skin and subcutaneous fat; m. obliquus externus, m. obliquus internus, m. transversus abdominis — divided along their fibres or in a muscle-sparing plane; fascia transversalis; the peritoneum retracted anteromedially; the ureter passing over the common iliac bifurcation; the sympathetic chain along the lateral vertebral body surface (injury produces a warm leg or retrograde ejaculation in men); the common iliac vessels (bifurcation typically at L4–L5, the L5–S1 disc lying below the bifurcation); the anterior longitudinal ligament over the disc space.
...
**Zonal anatomy (Moro and Uribe).** The lateral disc space is divided in the lateral projection into four zones: I (anterior third, neurovascularly safe), II, III, and IV (anterior to posterior). The lumbar plexus migrates from posterior to anterior along the disc space length down the lumbar spine — at L2–L3 the plexus is in zone IV (posterior), at L4–L5 in zone III–IV (more anterior). The safe corridor for the approach is zone II or zone II–III; zone IV (posterior) carries high risk of neurological injury. Neuromonitoring (trigger EMG of dilators) identifies the plexus in real time. The genitofemoral nerve runs on the anterior surface of the psoas and can be injured during anterior splitting.
...
**Positioning.** Prone on a Jackson table or Wilson frame allowing free abdominal hang — reduces epidural venous engorgement and intraoperative bleeding. Arms with shoulders abducted ≤ 90° and elbows flexed. The head in neutral position with no pressure on the eyes (avoiding postoperative blindness from reduced ocular perfusion). The hips slightly flexed for decompression (increasing interlaminar distance); slightly extended for fusion (to restore lordosis).

**Landmarks.** A line through the iliac crests marks approximately the L4–L5 interspinous level; fluoroscopic confirmation is mandatory. PSIS as a landmark for the S1 pedicle.

**Structures.** Skin and subcutaneous fat; fascia thoracolumbalis; paravertebral muscles (erector spinae: iliocostalis, longissimus, spinalis; deeper, the multifidus); spinous processes, laminae, pars interarticularis, facets, transverse processes; the pedicles — reached through entry points at the junction of transverse process, lamina, and superior articular process (Roy-Camille point with Magerl and Weinstein modifications).

**Dangers.** Segmental lumbar vessels — close to the facets between the transverse processes; bleeding during lateral dissection, controlled with bipolar cautery. Dorsal primary rami of the lumbar nerves — run with these vessels; multifidus denervation is segmental, so partial denervation is not critical. Epidural venous plexus — between the nerve and the body; bleeding during blunt dissection, controlled with Gelfoam, thrombin-soaked cotton patties, or bipolar cautery with particular caution because of nerve root proximity. The iliac vessels on the anterior body surface — can be injured if instruments pierce the anterior anulus fibrosus.
...
For the thoracic and upper lumbar spine — transthoracic approach. For large paravertebral abscess without pleural opening — posterior costotransversectomy. For psoas abscess (with distal collection in the thigh) — anterior thigh incision along the medial border of m. sartorius at the level of the inguinal crease; m. sartorius is retracted laterally, m. iliopsoas is identified, and the abscess cavity is opened with a finger or small instrument and drained and curetted to healthy tissue. For lumbar and sacrolumbar tuberculosis without large collection — anterior extraperitoneal approach (Tenev or classical left-sided).
...
<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/anatomy-1/scoliosis-cobb.svg" data-figure-alt="Cobb angle in scoliosis" aria-label="Enlarge">
    <img src="/img/anatomy-1/scoliosis-cobb.svg" alt="Cobb angle in scoliosis" loading="lazy" decoding="async" />
  </button>
  <figcaption>
    <span class="md-figure-caption">Cobb's method (1948) for measuring the scoliotic curve: the upper endplate of the most tilted upper vertebra and the lower endplate of the most tilted lower vertebra define the angle between their perpendiculars. Curves over 50° (skeletally mature) or over 45° (growing skeleton) are indications for operative correction; standard indicators in the Bulgarian school of V. Tanchev and G. Kaymakchiev for instrumented spondylodesis in adolescent idiopathic scoliosis.</span>
...
**Anterior cervical:** recurrent laryngeal nerve injury (1–3%); oesophageal perforation (rare but serious); vascular injury (carotid or vertebral artery); Horner's syndrome (sympathetic chain injury); dysphagia (very common postoperatively, usually transient); adjacent segment degeneration (long-term sequela of post-arthrodesis biomechanics).

**Posterior cervical:** vertebral artery injury (catastrophic; preventable by accurate screw placement); C5 palsy (5–10% after multilevel decompression, usually transient); dural tear with CSF leak; infection (1–3%); post-laminectomy kyphosis (delayed kyphotic deformation after laminectomy without fusion, especially in patients under 25 years).

**Cervicothoracic junction:** thoracic duct injury at left low levels; recurrent nerve injury; bleeding from the internal mammary vessels.

**Thoracotomy:** chest wall pain (reduced by muscle-sparing thoracotomy); pleural effusion; pneumonia and atelectasis; chylothorax with thoracic duct injury at upper levels; persistent intercostal neuralgia.

**Anterior lumbar:** vascular injury (most feared; left common iliac vein at greatest risk at L4–L5); ureteric injury; retrograde ejaculation (1–5% of men at levels below the bifurcation); ileus; incisional hernia; adjacent segment degeneration.

**Lateral transpsoas:** lumbar plexus injury (especially L4 root); psoas weakness; transient radiculopathy; peritoneal perforation.
...
<aside class="callout callout-classical">
  ...
  <ul>
    ...
    <li><strong>Krause, 1900s</strong> — posterior craniocervical approaches, cerebellar tumours.</li>
    <li><strong>Cushing, 1910s</strong> — suboccipital approach with vertebral artery preservation.</li>
    <li><strong>Gallie 1939 → Brooks-Jenkins 1978 → Magerl 1987 → Harms 2001</strong> — the evolution of posterior C1–C2 fixation from cable systems to pedicle and lateral-mass screws.</li>
  </ul>
</aside>

Classical descriptions by approach: Hibbs 1911 (posterior spondylodesis); Smith-Petersen 1945 (vertebrotomy for kyphosis); Smith-Robinson 1958, Cloward 1958, Bailey-Badgley 1960 (anterior cervical); Fang-Hodgson 1962 (transhyoid); Harrington 1962 (three-vector scoliosis instrumentation); Wiltse 1968 (paramedian intermuscular lumbar); Hodgson 1956–1960 (anterior radical operation for tuberculous spondylitis); Valls 1948 (percutaneous vertebral biopsy); Cobb 1948 (scoliotic angle measurement); Moro 2003 (zonal anatomy of the lateral transpsoas approach).
...
3. **Bridwell KH, DeWald RL, eds.** *The Textbook of Spinal Surgery.* 3rd ed. Philadelphia: Lippincott Williams & Wilkins; 2011. — *Extensive operative spinal surgery reference, with detailed chapters on biomechanics, sagittal balance, and modern instrumented constructs; the standard for advanced spinal surgical training.*
