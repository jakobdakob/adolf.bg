...
<aside class="callout callout-pearl">
  ...
  <p>Obesity is the strongest modifiable risk factor for knee OA. Each kilogram of weight loss reduces knee load by approximately 3-4 kg per step, and varus alignment predisposes to medial-compartment disease while valgus predisposes to lateral-compartment disease.</p>
</aside>
...
Presentation is with progressive knee pain typically localized to the affected compartment(s), often described as deep, aching, and exacerbated by weight-bearing and use. Mechanical symptoms (catching, locking, giving way) may indicate meniscal pathology or loose bodies. Stiffness, particularly after periods of rest (“gelling”), is characteristic and improves with gentle motion. Functional limitations include difficulty with stairs (descending is typically worse than ascending), difficulty rising from chairs, reduced walking distance, and limp. Examination findings progress with disease severity: antalgic gait; varus or valgus deformity on weight-bearing (often more pronounced than supine); joint-line tenderness localized to the affected compartment; effusion (typically modest); reduced range of motion with flexion contracture in advanced disease; crepitus on motion; quadriceps wasting; positive McMurray test (less reliable in established OA); and positive grind test for patellofemoral disease.

<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Stair descent is typically harder than ascent in knee OA (eccentric quadriceps loading), and 'gelling' stiffness after rest that improves with motion is highly characteristic. Effusion is typically modest, distinguishing OA from inflammatory or septic processes.</p>
</aside>

## Imaging

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/ortho-22/knee-oa.jpg" data-figure-alt="Varus knee osteoarthritis on plain radiograph" aria-label="Enlarge">
    <img src="/img/ortho-22/knee-oa.jpg" alt="Varus knee osteoarthritis on plain radiograph" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pitfall">
  ...
  <p>Knee OA joint-space narrowing is reliably demonstrated only on WEIGHT-BEARING views. The Rosenberg view (PA, knees 30-45° flexion) is more sensitive than standard AP-extension for posterior compartment disease; a non-weight-bearing X-ray can falsely reassure.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Weight loss of 5-10% delivers meaningful symptomatic improvement in most patients with knee OA, and quadriceps strengthening has the most robust evidence base of any exercise intervention. A cane in the OPPOSITE hand cuts the affected knee's reaction force by 20-40%.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Kozinn and Scott criteria for medial UKA: isolated medial-compartment full-thickness loss, intact ACL, passively correctable varus, flexion contracture <5°, flexion ≥90°. ACL deficiency is a hard contraindication, as is inflammatory arthritis.</p>
</aside>
