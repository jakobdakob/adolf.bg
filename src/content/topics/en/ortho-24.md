...
<aside class="callout callout-pearl">
  ...
  <p>RA serology pearl: rheumatoid factor is IgM against the Fc portion of IgG; anti-CCP antibody (ACPA) targets citrullinated proteins generated by PAD4 and is the more specific marker, with strong association to HLA-DR4. Smoking is the principal modifiable environmental trigger.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>RA spares the DIP joints, attacking the MCPs, PIPs, wrists, and MTPs; symmetric DIP involvement should redirect the diagnosis to osteoarthritis or psoriatic arthritis. Morning stiffness lasting more than an hour is a hallmark of inflammatory disease.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Cervical spine is involved in 30-90% of established RA. Atlas-dens interval >3 mm is abnormal in adults; >9 mm means major instability with cord-compression risk. Order flexion-extension lateral C-spine films before any RA patient is positioned for elective surgery, GA can be catastrophic if missed.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Gout crystals: needle-shaped, NEGATIVELY birefringent (yellow when parallel to the polarizer); first MTP (podagra) is the classic site. Pseudogout crystals: rhomboid, WEAKLY POSITIVELY birefringent; knee is the classic site, with chondrocalcinosis on plain X-ray.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>A normal serum urate during an acute attack does NOT exclude gout, urate has shifted into the joint. Diagnosis requires joint aspiration with polarized microscopy; treat the attack with NSAIDs, colchicine, or steroids and start urate-lowering therapy after the attack has settled (target urate <6 mg/dL, <5 with tophi).</p>
</aside>
