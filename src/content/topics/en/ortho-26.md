...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Erb (C5-C6 ± C7) accounts for ~70% of OBPP and produces the 'waiter's tip' arm (adducted, internally rotated shoulder, extended elbow, pronated forearm). Klumpke (C8-T1) is rare in isolation, produces claw hand, and is flagged by Horner syndrome (ptosis, miosis, anhidrosis) pointing to a pre-ganglionic root avulsion.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>About 65-75% of OBPP cases recover fully within 6-12 months. The single most important decision-point is biceps function (elbow flexion against gravity) at 3-6 months; failure to recover by then is the classical indication for surgical exploration with neurolysis, nerve grafting, or nerve transfer.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>DDH coexists with congenital muscular torticollis in 5-20% of cases. Hip screening (Ortolani/Barlow in newborns, ultrasound in those at risk) is MANDATORY in every infant with CMT, missing it is a recurrent malpractice claim.</p>
</aside>
