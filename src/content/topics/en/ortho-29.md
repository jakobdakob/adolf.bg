...
<aside class="callout callout-pearl">
  ...
  <p>Dupuytren diathesis = aggressive, recurrence-prone phenotype: positive family history, BILATERAL disease, onset before age 40, and ectopic disease (Garrod knuckle pads, Ledderhose plantar fibromatosis, Peyronie). These patients deserve dermofasciectomy or earlier escalation, not minimal procedures.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>The SPIRAL CORD wraps around and displaces the neurovascular bundle MEDIALLY and SUPERFICIALLY, putting the digital nerve and artery directly in the operative field. Aggressive dissection along an apparent cord without anticipating this displacement is the classic mechanism of iatrogenic digital nerve injury in Dupuytren surgery.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Hueston tabletop test is the bedside threshold: if the patient cannot lay the palm flat on a table, the contracture warrants intervention. The classical thresholds are fixed MCP contracture of 30°+ or ANY fixed PIP contracture, the PIP joint develops irreversible volar plate and capsular contracture, so don't wait.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Procedure selection: needle aponeurotomy is fast, office-based, easily repeatable, but has 50-80% recurrence by 5 years. Collagenase achieves similar correction by enzymatic digestion (small tendon-rupture risk). Limited fasciectomy is the standard for established disease; dermofasciectomy is the best option for the Dupuytren diathesis.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Recurrence after limited fasciectomy is roughly 30-50% at 5-10 years; dermofasciectomy with full-thickness skin graft cuts this to 10-20%, because the diseased skin substrate is removed. Choose dermofasciectomy in aggressive or recurrent disease.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Severe pain in a Dupuytren patient should prompt review of the diagnosis: classical disease is painless or only minimally tender. Pain, rapid growth, atypical location, or a soft mass suggest an alternative (ganglion, infection, soft-tissue tumor).</p>
</aside>
