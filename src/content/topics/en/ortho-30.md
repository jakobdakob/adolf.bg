...
<aside class="callout callout-pearl">
  ...
  <p>Modern bearing surfaces: highly cross-linked polyethylene (XLPE), made by gamma-irradiating UHMWPE then remelting/annealing to eliminate free radicals, transformed arthroplasty by reducing wear and largely eliminating osteolysis. Vitamin E-stabilized XLPE further blunts oxidative degradation. PMMA cement provides immediate fixation; uncemented relies on biological ingrowth or ongrowth.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Metal-on-metal bearings (especially large-head designs) have been substantially withdrawn from practice because of cobalt-chromium ion release, adverse local tissue reactions, pseudotumor formation, and systemic cobaltism. Even metal-on-polyethylene constructs can develop trunnionosis at the modular head-stem junction, modularity is not free of biological cost.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Choose cemented fixation in older patients with poor bone quality and in hip-fracture hemiarthroplasty; choose uncemented fixation in younger patients with good bone quality (most modern primary THA/TKA in many centers). Hybrid = uncemented cup + cemented stem is a common compromise.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Implant constraint is a balance: more constraint = more stability but more load transfer to bone-implant interfaces and earlier loosening. The choice of constraint level is one of the principal decisions in revision arthroplasty, balanced against the soft-tissue envelope and patient demands.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Standard hip cup orientation targets: 40° abduction, 15-20° anteversion. Femoral head size is a trade-off: small heads have lower wear but higher dislocation risk; large heads do the opposite (especially in metal-on-polyethylene).</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Modern ERAS pillars: regional anesthesia (spinal/epidural) cuts thromboembolic risk and blood loss; tranexamic acid (IV, topical, or both) is standard practice; cefazolin within 60 minutes of incision (vancomycin in MRSA carriers) ends prophylaxis on the day of surgery; mobilize the patient on the day of operation.</p>
</aside>
