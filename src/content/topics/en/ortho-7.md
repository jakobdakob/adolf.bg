...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Memorize the five classical obstacles to closed reduction of DDH: inverted limbus, hypertrophied pulvinar, contracted iliopsoas tendon producing the capsular hourglass, contracted transverse acetabular ligament, and capsular contracture. Open reduction must release every one.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Ortolani relocates a dislocated hip (abduct + lift); Barlow dislocates a reducible one (adduct + push). A clunk is the diagnostic sign; clicks are common and innocuous. Both signs become negative after about 3 months as secondary changes develop, when limited abduction (asymmetry), Galeazzi shortening, and a positive Klisic test take over.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Graf classification anchors on the alpha angle (bony roof): Type I >=60 degrees is mature; Type II is 43-59 degrees with subtypes (IIa physiologically immature <3 months, IIb delayed maturation >3 months, IIc critical zone, IId decentered); Type III is dislocated with everted but undeformed labrum; Type IV is dislocated with inverted, deformed labrum. Treatment starts at IIa-minus or IIc.</p>
</aside>
