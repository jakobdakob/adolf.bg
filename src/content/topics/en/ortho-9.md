...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Femoral head AVN is bilateral in 50-80% of cases, often asynchronous. Corticosteroid threshold of risk is around 2 g cumulative prednisone equivalent or >30 mg/day for >30 days; femoral neck fracture carries 10-15% AVN risk with anatomic prompt fixation (30%+ with delay), and posterior hip dislocation carries 5-15% if reduced within 6 hours.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>The subchondral crescent sign on the frog-lateral view marks the transition from reversible to irreversible disease and defines Ficat 3. The double-line sign on T2 MRI (low-signal inner line of necrotic bone, high-signal outer line of granulation tissue) is highly specific for AVN, and MRI is the modality of choice while plain films are still normal.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Core decompression is the standard for pre-collapse disease (Ficat I-II), with 60-80% success that drops sharply once collapse occurs. Vascularized fibular grafting adds structural support plus revascularization and reaches 70-90% in pre-collapse disease. Once the head has collapsed, total hip arthroplasty is the answer, with younger patients getting harder bearings (ceramic-on-ceramic or ceramic on highly-cross-linked polyethylene).</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Ahlbäck disease (SONK) is no longer thought to be a primary vascular event: the current model is a subchondral insufficiency fracture in osteoporotic bone with secondary necrosis. Expect it in women over 60 with sudden medial knee pain and no trauma; MRI shows the subchondral fracture line with surrounding marrow edema.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Talar neck fracture AVN risk by Hawkins type: I 0-10%, II 20-50%, III 80-100%, IV near 100%. The Hawkins sign — a subchondral radiolucency in the talar dome on AP at 6-8 weeks — indicates preserved vascularity and is the favorable prognostic signal.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Kienböck disease (lunatomalacia) hits men aged 20-40 in manual work. Ulnar-negative variance shifts axial load onto the lunate and is statistically associated; intraosseous vascular supply may be single-vessel and vulnerable. The combined vascular plus mechanical model best fits the evidence.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Stage-tailored treatment of Kienböck: I conservative; II and IIIA with ulnar-negative variance — joint-leveling by radial shortening osteotomy (ulnar-positive is a contraindication; alternatives are capitate shortening or vascularized graft from the 4+5 ECA pedicle); IIIB/IIIC — proximal row carpectomy if the proximal capitate is intact, otherwise partial wrist arthrodesis; IV — total wrist arthrodesis.</p>
</aside>
...
Robert Kienböck's 1910 paper on lunate "Lunatummalazie" (Fortschritte auf dem Gebiete der Röntgenstrahlen 16: 77–103) established the entity; Köhler (1908) and Freiberg (1914) gave the analogous descriptions for navicular and metatarsal head AVN. Lexer's *Lehrbuch der allgemeinen Chirurgie* (1904) provides the pre-eponymic vocabulary of aseptic bone necrosis.
...
- **Hoffa** (1905): *Lehrbuch der orthopädischen Chirurgie* — chapter on juvenile bone necroses. · [Facsimile](https://archive.org/details/lehrbuchderortho00hoff)
