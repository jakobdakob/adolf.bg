...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Anderson-Montesano type III occipital condyle fracture is an alar-ligament avulsion from rotation-distraction and the unstable pattern that requires occipitocervical fusion. Type I (axial-load comminution) and most type II (basilar skull extension) are stable in a rigid collar for 6-12 weeks.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Atlanto-occipital dissociation is almost always missed without measurement. The Powers ratio over 1.0 suggests anterior dissociation but is insensitive; the basion-dens interval and basion-axial interval (both normally under 12 mm on CT) are more reliable. MRI confirms tectorial membrane and alar ligament disruption. Treatment is occipitocervical fusion, managed in a halo until definitive.</p>
</aside>
...
<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>A B3 hyperextension injury in an ankylosing-spondylitis or DISH spine looks subtle on radiographs but is profoundly unstable. Such patients are frequently misdiagnosed and deteriorate with mobilization, so any neck pain or fall in a fused-appearing spine demands CT and a high index of suspicion for an anterior tension-band injury.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>TLICS scores morphology (1 compression, 2 burst, 3 translation/rotation, 4 distraction), neurology (0 intact to 3 incomplete cord/cauda equina), and posterior ligamentous complex (0 intact, 2 indeterminate, 3 disrupted). Total of 3 or less is non-operative, 5 or more is operative, and 4 is the gray zone. PLC integrity, best read on MRI, is the swing variable in the burst fracture decision.</p>
</aside>
...
Pediatric spine injuries are uncommon but distinct. Several features deserve mention. The fulcrum of cervical injury in young children is higher than in adults — approximately C2- C3 in infants and toddlers, descending toward the adult position of C5-C6 by adolescence — reflecting the relatively larger head and the underdeveloped cervical musculature. The phenomenon of SCIWORA (spinal cord injury without radiographic abnormality, Pang and Wilberger, 1982) is more common in children because of the increased elasticity of the immature spine relative to the cord, with neurological injury possible without bony or radiographic disruption. Children require MRI for any suspected cord injury regardless of plain imaging findings. Atlantoaxial rotatory subluxation (Fielding and Hawkins classification) is a uniquely pediatric entity that may follow minor trauma or upper respiratory infection (Grisel’s syndrome) and is treated with traction and orthosis followed by fusion only in refractory or recurrent cases. Pediatric thoracolumbar trauma is otherwise managed by adult principles, although the lower threshold for non-operative management in the growing skeleton, and the avoidance of fusion across growth plates where possible, are important considerations.

## Postoperative Management and Complications

Postoperative management following spinal stabilization includes early mobilization with appropriate orthotic protection when needed, neurological monitoring, deep vein thrombosis prophylaxis (which should not be omitted despite the historical concern about epidural hematoma, the evidence supports beginning LMWH within 24 to 48 hours of surgery in stable patients, see [Topic Trauma-7](/en/trauma/7/)), and progressive rehabilitation. Complications specific to spinal trauma surgery include adjacent segment degeneration (particularly with longer fusion constructs), pseudarthrosis, hardware failure, dural tear with cerebrospinal fluid leak, and surgical site infection (with rates of approximately 2 to 5 percent in elective spinal surgery rising to 5 to 10 percent in trauma). The infectious complications addressed in [Topic Trauma-9](/en/trauma/9/) apply with particular force to spinal hardware because of the consequences of deep infection in this region.

## Sources and Classical Literature

Bergmann's *Chirurgische Behandlung von Hirnkrankheiten* (1889) gives the founding doctrine of cranio-spinal trauma surgery, including the chapters on vertebral fracture without cord injury. Paré's *Œuvres* (Malgaigne ed. 1840) preserves the Renaissance descriptions; Chauliac (1363) the mediaeval. The modern AO Spine classification (Magerl 1994, AOSpine 2013) is the descendant.
...
- **Paré** (1840 Malgaigne ed.): *Œuvres complètes*, vol. 3 — spine and trunk. · [Facsimile](https://archive.org/details/oeuvrescomplte03par)
- **Chauliac** (1363): *Chirurgia magna* — mediaeval spinal surgery. · [Facsimile](https://archive.org/details/chirurgiamagnagu00guyd)
