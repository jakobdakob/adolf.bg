...
<aside class="callout callout-pearl">
  ...
  <p>Allman by location (I middle ~80%, II lateral ~15%, III medial ~5%) is the historical shorthand; Robinson (1998) is the modern operative system, structured by location and displacement. For the lateral end, Neer IIA, IIB, and V are the unstable patterns because the medial fragment lacks coracoclavicular restraint and is pulled superiorly by the trapezius.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>The COTS 2007 trial overturned decades of orthodoxy by showing 15% nonunion in completely displaced midshaft fractures treated non-operatively versus 2% with ORIF. Operative risk factors for nonunion: displacement >100% (no cortical contact), comminution (Z-shaped pattern), shortening >1.5-2 cm, female sex, smoking, advanced age.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Do not mistake a medial clavicle physeal injury for an SC dislocation in a young adult. The medial clavicular physis is the last in the body to close (around age 23-25), so apparent SC dislocations in this age group are usually Salter-Harris-type physeal separations that heal reliably without surgery.</p>
</aside>
