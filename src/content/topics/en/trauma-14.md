...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>The Holstein-Lewis fracture (1963) — distal-third spiral oblique humeral shaft — is the eponymous radial-nerve trap. The nerve passes through the lateral intermuscular septum and is tethered relative to the displacing distal fragment, putting it at particular risk.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Test the radial nerve specifically and document it before any manipulation: wrist and finger extension, thumb abduction (EPL), and sensation in the first dorsal webspace. A radial palsy 'noticed' only after splinting is medicolegally indistinguishable from one caused by manipulation.</p>
</aside> Plain radiographs in two orthogonal planes (AP and lateral) with the shoulder and elbow joints included are mandatory. CT is rarely needed for diaphyseal fractures unless there is intra-articular extension into the proximal or distal humerus.
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Primary radial nerve palsy in closed humeral shaft fracture is mostly neurapraxia — 75-90% recover spontaneously, with first signs (motor units in brachioradialis, the most proximal radial muscle) by 3-4 weeks. Observe for 4-6 months before exploration. SECONDARY palsy after manipulation is the exception — explore promptly because the nerve may be entrapped between fragments.</p>
</aside>

## Non-Operative Management — The Sarmiento Functional Brace

<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/trauma-14/humerus-callus.jpg" data-figure-alt="Callus healing of humeral shaft fracture" aria-label="Enlarge">
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Antegrade nailing's weakness is the shoulder (rotator cuff injury, subacromial impingement, axillary nerve at proximal locking); retrograde nailing's weakness is the elbow (stiffness). The strongest current indication for nailing is the pathological or impending pathological fracture, where the nail protects the entire bone length.</p>
</aside>


## External Fixation

External fixation has a limited role in humeral shaft fracture, primarily as temporary stabilization in damage-control settings, open fractures with extensive soft-tissue compromise, and severely contaminated open fractures with bone loss. Definitive treatment with external fixation alone is uncommon because of pin-related complications and the long duration of treatment required.
