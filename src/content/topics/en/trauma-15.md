...
<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/trauma-15/olecranon-anatomy.png" data-figure-alt="Olecranon anatomy" aria-label="Enlarge">
    <img src="/img/trauma-15/olecranon-anatomy.png" alt="Olecranon anatomy" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
<aside class="callout callout-pearl">
  ...
  <p>The lateral ulnar collateral ligament (LUCL — O'Driscoll, Bell, Morrey 1991) is the primary restraint to posterolateral rotatory instability of the elbow. Its recognition transformed the management of complex elbow injuries; missing it is the classic reason an elbow stays unstable after dislocation.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Primary total elbow arthroplasty for distal humerus fracture is the choice in the elderly low-demand patient (over 65-70) with severely comminuted articular pattern (AO C2/C3) or pre-existing inflammatory arthritis. The trade-off is the lifelong 5 kg / 10 lb single-event lifting limit — which low-demand patients typically accept.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Weber tension-band wiring works only for transverse non-comminuted olecranon fractures: two parallel K-wires plus a figure-of-eight wire convert triceps tensile pull into compression across the articular surface during flexion. Use a precontoured locking plate for comminuted, fracture-dislocation, or proximally-extending patterns — tension band will fail under shear.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>The O'Driscoll anteromedial facet coronoid fracture is the silent destabilizer — it carries the anterior bundle of the MCL and is the key restraint against varus posteromedial rotatory instability. Even 2-5 mm fragments may need fixation. Don't be reassured by 'small' on radiographs; CT and instability assessment govern.</p>
</aside> Treatment of coronoid fractures depends on the size and location of the fragment and on the associated injuries. Type I (tip) fractures in stable elbows are non-operative; tip fractures associated with terrible triad (see below) require fixation. Anteromedial facet fractures generally require fixation. Larger basal fractures (Regan-Morrey III,
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Terrible triad (Hotchkiss 1996) = elbow dislocation + radial head fracture + coronoid fracture. Modern management is systematic lateral-approach reconstruction of all three: radial head (repair or replace, never excise), coronoid (screws, suture lasso, or anchors), and LCL repair. Repair MCL only if instability persists after lateral reconstruction.</p>
</aside>

## Special Patterns

The Monteggia fracture-dislocation (proximal ulna fracture with radial head dislocation) is addressed in [Topic Trauma-16](/en/trauma/16/) (forearm fractures) but deserves mention here as another elbow-related complex injury. The Essex-Lopresti injury (radial head fracture with rupture of the interosseous membrane and distal radioulnar joint disruption) requires preservation of radial length (radial head retention or arthroplasty rather than excision) and management of the DRUJ disruption. Capitellar fractures (AO/OTA 13-B3) and the related Hahn-Steinthal (capitellum) and Kocher-Lorenz (smaller cortical) patterns are addressed by anterior screw fixation, with the lateral approach providing the necessary exposure. The anteromedial coronoid fracture pattern discussed above produces varus posteromedial rotatory instability requiring focused medial-side reconstruction. The floating elbow (combined humeral and forearm fractures) discussed in [Topic Trauma-14](/en/trauma/14/) again requires operative fixation of at least the humeral component to allow rehabilitation. The pediatric supracondylar humerus fracture is a separate major entity managed by the Gartland classification and is addressed in the pediatric trauma sections; the discussion here pertains to the adult elbow.

<aside class="callout callout-historical">
  <span class="callout-label">Classical voice — Malgaigne 1847, olecranon fractures</span>
  <blockquote lang="fr">
    <p>« La cause la plus commune est une chute sur le coude ; sur nos trente-cinq cas, cette cause est accusée vingt-sept fois. … Pour se produire ces fractures ont besoin d'un certain degré de flexion de l'avant-bras, et que celui-ci soit poussé par une force extérieure qui tend à le fléchir davantage, et à laquelle résiste le triceps. C'est ainsi du reste que se produisent les fractures de l'olécrane dans certaines réductions imprudemment tentées pour des luxations anciennes du coude. … Desault le premier en a distingué deux espèces ; celle du sommet et celle de la base ; à quoi Boyer en a ajouté une troisième, celle de la partie moyenne de l'apophyse. »</p>
  </blockquote>
  <p><strong>Translation:</strong> "The most common cause is a fall on the elbow; in our 35 cases this cause is accused 27 times. … For these fractures to occur, a certain degree of forearm flexion is required, with the forearm pushed by an external force tending to flex it further, against which the triceps resists. This is moreover how olecranon fractures arise during certain reductions imprudently attempted for old elbow dislocations. … Desault first distinguished two species — that of the summit and that of the base; to which Boyer added a third, that of the middle of the apophysis."</p>
  <p class="callout-source">— Joseph-François Malgaigne, <em>Traité des fractures et des luxations</em>, vol. 1 (Paris: Baillière, 1847), Chapter “Des fractures de l'olécrane,” p. 563 ff. The triceps-resistance / forced-flexion mechanism Malgaigne articulates here is exactly the modern tension-band physics behind Weber's wiring (1963): the triceps converts displacement at the fracture line into the tensile force that the K-wires plus figure-of-eight wire convert back into compression. The Desault/Boyer tripartite topography (summit, base, middle) is the ancestor of today's Mayo classification by location and stability. <a href="https://archive.org/details/BIUSante_32985x01" target="_blank" rel="noopener noreferrer">Facsimile on Internet Archive →</a></p>
</aside>

## Sources and Classical Literature

The classical orthopedic descriptions of elbow fracture predate the modern Mason and Mayo classifications by more than a century. Malgaigne's 35-case series of olecranon fractures at the Hôtel-Dieu (1847) already articulated the triceps-resistance mechanism that informs the modern tension-band fixation principle, and synthesized the Desault and Boyer topographic schemes that would later be reorganized by Morrey into the Mayo classification. Dupuytren's clinical lectures (1832) provide the first systematic series of distal humerus and coronoid fractures, and his observations on the post-traumatic stiff elbow remain clinically relevant. Astley Cooper's *Treatise on Dislocations and Fractures of the Joints* (1822) offered the standard English-language description of elbow dislocation and the radial head fracture before Mason.

- **Malgaigne** (1847): *Traité des fractures et des luxations*, vol. 1, "Des fractures de l'olécrane." · [Facsimile](https://archive.org/details/BIUSante_32985x01)
- **Dupuytren** (1832): *Leçons orales de clinique chirurgicale*, vol. 1 — elbow region lectures. · [Facsimile](https://archive.org/details/leonsoralesdec01dupu)
- **Astley Cooper** (1832 ed.): *A Treatise on Dislocations and Fractures of the Joints*. · [Facsimile](https://archive.org/details/treatiseondisloc00coop_0)
