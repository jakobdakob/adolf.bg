...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Eponym quick reference: Colles (dorsally displaced extra-articular, 'dinner fork'), Smith (volarly displaced, 'reverse Colles', more unstable), Barton (intra-articular shear fracture-dislocation, volar or dorsal — needs buttress plating), chauffeur/Hutchinson (radial styloid, axial scaphoid impact, watch for scapholunate injury), die-punch (depressed lunate facet, often needs open reduction).</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Lafontaine criteria for redisplacement after closed reduction: dorsal angulation >20°, dorsal comminution, intra-articular involvement, ulnar styloid fracture, and age over 60. Three or more means closed treatment is likely to fail — consider operative intervention up front rather than chase a lost reduction.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Acute carpal tunnel syndrome after distal radius fracture is a surgical emergency, not a watch-and-wait diagnosis. Worsening median nerve symptoms despite reduction and elevation mandate urgent carpal tunnel release combined with fracture management — observation invites permanent median nerve dysfunction.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Acceptable reduction parameters: dorsal angulation no more than 0-10°, radial inclination at least 15°, radial shortening no more than 3-5 mm, articular step-off no more than 2 mm. The elderly low-demand patient tolerates more deformity; the young active patient demands anatomical reduction.</p>
</aside>
...
<aside class="callout callout-historical">
  <span class="callout-label">Classical voice — Malgaigne 1847, the dorsal displacement explained</span>
  <blockquote lang="fr">
    <p>« Le déplacement en question tient essentiellement, selon moi, au renversement en arrière et en haut du fragment inférieur, avec pénétration profonde du fragment supérieur en arrière, les deux fragments demeurant en contact en avant. … La saillie du fragment supérieur en avant est beaucoup moins forte que celle du fragment inférieur en arrière ; … il faut que le déjettement en arrière du fragment inférieur soit bien considérable pour qu'on sente la petite tête du cubitus proéminer en avant, espèce de luxation légère sur laquelle je reviendrai en temps et lieu. »</p>
  </blockquote>
  <p><strong>Translation:</strong> "The displacement in question is essentially due, in my view, to the reversal upward and backward of the lower fragment, with deep impaction of the upper fragment posteriorly, the two fragments remaining in contact anteriorly. … The anterior prominence of the upper fragment is much weaker than the posterior prominence of the lower fragment; … the backward displacement of the lower fragment must be very considerable before one feels the head of the ulna jutting forward — a sort of mild dislocation to which I shall return in due course."</p>
  <p class="callout-source">— Joseph-François Malgaigne, <em>Traité des fractures et des luxations</em>, vol. 1 (Paris: Baillière, 1847), § IV "Fractures de l'extrémité inférieure du radius," p. 605–607. Malgaigne's analysis of the impaction-and-dorsal-tilt mechanism — including his observation that the prominent distal ulnar head is a secondary phenomenon of the radial collapse — is the structural reasoning behind the modern radiographic parameters (radial inclination, volar tilt, ulnar variance) that govern reduction targets. His protest against Pouteau's claim that the pronator quadratus pulls the distal fragment medially anticipates twentieth-century kinematic re-analyses of the FOOSH mechanism. <a href="https://archive.org/details/BIUSante_32985x01" target="_blank" rel="noopener noreferrer">Facsimile on Internet Archive →</a></p>
</aside>
