...
<aside class="callout callout-pearl">
  ...
  <p>Two mechanisms, two mechanical environments. Absolute stability (compression plate, lag screw) gives direct healing without callus through cutting cones; relative stability (cast, nail, bridging plate, ex-fix) gives callus healing through endochondral ossification. Gaps over about 800 μm cannot heal by direct mechanism even with rigid fixation.</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Know the molecular drivers and their drugs. BMP-2 and BMP-7 promote osteoblast differentiation; VEGF drives angiogenesis; the RANK/RANKL/OPG axis governs osteoclasts (denosumab blocks RANKL); Wnt signaling drives formation (romosozumab blocks sclerostin, the osteocyte-derived Wnt inhibitor).</p>
</aside>
...
<aside class="callout callout-pearl">
  <span class="callout-label">Pearl</span>
  <p>Mechanical environment is the single most important local factor in healing. Absolute stability with a gap under 800 μm gives direct healing, controlled interfragmentary motion gives callus, excessive motion gives nonunion, and absolute rigidity across a large gap also fails to heal.</p>
</aside>
...
<aside class="callout callout-pitfall">
  ...
  <p>Smoking increases nonunion roughly 2-3 fold and should be addressed at every fracture; even perioperative cessation lowers complications. Chronic NSAIDs, corticosteroids, and uncontrolled diabetes all impair healing and must be counted alongside the obvious surgical factors.</p>
</aside>
