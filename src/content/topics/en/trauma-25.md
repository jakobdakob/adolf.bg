...
<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/trauma-25/patella-fracture.jpg" data-figure-alt="Transverse patella fracture" aria-label="Enlarge">
    <img src="/img/trauma-25/patella-fracture.jpg" alt="Transverse patella fracture" loading="lazy" decoding="async" />
  </button>
  <figcaption>
...
Malgaigne's *Traité* (1847) gives the founding clinical description of patella fractures, separating transverse (tension-band failure) from comminuted (direct-impact failure) — the same mechanical dichotomy that drives modern fixation choices. Dupuytren (1832) had earlier described the patella fracture series; the tension-band wiring of Weber (1963) is the modern descendant of Malgaigne's mechanical reasoning.

- **Malgaigne** (1847): *Traité des fractures et des luxations*, vol. 2 — patella, proximal tibia. · [Facsimile](https://archive.org/details/BIUSante_32985x02)
- **Dupuytren** (1832): *Leçons orales de clinique chirurgicale*, vol. 3 — knee region. · [Facsimile](https://archive.org/details/leonsoralesdec03dupu)
