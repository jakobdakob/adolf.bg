...
<aside class="callout callout-pearl">
  ...
  <p>The tibia is the most commonly fractured long bone and has the highest open fracture rate of any long bone (around 25%). The subcutaneous anteromedial cortex with virtually no soft-tissue coverage drives both the open-fracture rate and the slow healing of incisions and wounds in this region.</p>
</aside>
...
Single-stage definitive fixation is reserved for low-energy pilon fractures with minimal soft-tissue injury, where definitive ORIF can be performed acutely without significant skin compromise.

<aside class="callout callout-pitfall">
  <span class="callout-label">Pitfall</span>
  <p>Do not attempt immediate definitive ORIF of a high-energy pilon fracture: blistering and skin compromise within 24-48 hours produce catastrophic wound failure. The two-stage approach (spanning external fixation plus fibular plating first, definitive ORIF 7-21 days later through anterolateral or medial approaches) is now standard.</p>
</aside>
