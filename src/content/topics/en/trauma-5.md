...
<figure class="md-figure">
  <button class="md-figure-zoom" type="button" data-figure-src="/img/trauma-5/external-fixator.jpg" data-figure-alt="External fixator" aria-label="Enlarge">
    <img src="/img/trauma-5/external-fixator.jpg" alt="External fixator" loading="lazy" decoding="async" />
  </button>
  <figcaption>
